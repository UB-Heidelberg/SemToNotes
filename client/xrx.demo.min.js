...
xrx.drawing.Drawing.prototype.handleResize=function(){goog.dom.getWindow().clearTimeout(this.timeoutResize_);this.timeoutResize_=goog.dom.getWindow().setTimeout(function(){this.calculateSize_();this.canvas_.setHeight(this.height_);this.canvas_.setWidth(this.width_);this.shield_.setHeight(this.height_);this.shield_.setWidth(this.width_)});this.draw()};
