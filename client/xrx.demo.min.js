...
xrx.shape.ShapeGroupCreatable=function(a){xrx.shape.Creatable.call(this,a,new xrx.shape.ShapeGroup(a.getDrawing()));this.current_=0;var b=this;this.target_.getDrawing().eventShapeCreated=function(a){b.preview_.addChildren(a);b.current_<b.target_.getChildren().length-1?b.current_++:(a=new xrx.shape.ShapeGroup(b.target_.getDrawing()),a.addChildren(b.preview_.getChildren()),a.setStyle(b.target_),b.target_.getDrawing().getLayerShape().addShapes(a),b.target_.getDrawing().getLayerShapeCreate().removeShapes(),
b.target_.getDrawing().draw(),b.current_=0,b.preview_.removeChildren())}};goog.inherits(xrx.shape.ShapeGroupCreatable,xrx.shape.Creatable);xrx.shape.ShapeGroupCreatable.prototype.handleDown=function(a,b){this.target_.getChild(this.current_).getCreatable().handleDown(a,b)};xrx.shape.ShapeGroupCreatable.prototype.handleMove=function(a,b){this.target_.getChild(this.current_).getCreatable().handleMove(a,b)};
xrx.shape.ShapeGroupCreatable.prototype.handleUp=function(a,b){this.target_.getChild(this.current_).getCreatable().handleUp(a,b)};xrx.shape.Canvas=function(a){xrx.shape.Container.call(this,a);this.engineElement_=this.drawing_.getEngine().getCanvas();goog.dom.append(this.drawing_.getElement(),this.engineElement_.getElement())};goog.inherits(xrx.shape.Canvas,xrx.shape.Container);xrx.shape.Canvas.prototype.getElement=function(){return this.drawing_.getElement()};xrx.shape.Canvas.prototype.getEngine=function(){return this.drawing_.getEngine()};xrx.shape.Canvas.prototype.getHeight=function(){return this.engineElement_.getHeight()};
...
xrx.viewbox.ViewboxGeometry.prototype.getFixPoints_=function(){var a=this.getWidth(),b=this.getHeight();this.FixPoints_.C=[a/2,b/2];this.FixPoints_.NE=[a,0];this.FixPoints_.SE=[a,b];this.FixPoints_.SW=[0,b];this.FixPoints_.NW=[0,0];return this.FixPoints_};xrx.viewbox.ViewboxGeometry.prototype.getFixPoint_=function(a,b,c){var d=this.getFixPoints_();a=c?d[this.getVisibleOrientation_(a)]:d[a];return!0===b?(b=Array(2),this.ctm_.transform(a,0,b,0,1),b):a};
