...
e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(a){a.call(goog.global)};COMPILED||(goog.global.COMPILED=COMPILED);goog.dom={};goog.dom.NodeType={ELEMENT:1,ATTRIBUTE:2,TEXT:3,CDATA_SECTION:4,ENTITY_REFERENCE:5,ENTITY:6,PROCESSING_INSTRUCTION:7,COMMENT:8,DOCUMENT:9,DOCUMENT_TYPE:10,DOCUMENT_FRAGMENT:11,NOTATION:12};goog.debug={};goog.debug.Error=function(a){if(Error.captureStackTrace)Error.captureStackTrace(this,goog.debug.Error);else{var b=Error().stack;b&&(this.stack=b)}a&&(this.message=String(a))};goog.inherits(goog.debug.Error,Error);goog.debug.Error.prototype.name="CustomError";goog.string={};goog.string.DETECT_DOUBLE_ESCAPING=!1;goog.string.Unicode={NBSP:"\u00a0"};goog.string.startsWith=function(a,b){return 0==a.lastIndexOf(b,0)};goog.string.endsWith=function(a,b){var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c};goog.string.caseInsensitiveStartsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(0,b.length))};goog.string.caseInsensitiveEndsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(a.length-b.length,b.length))};
...
goog.History.PollingType={NORMAL:150,LONG:1E4};goog.History.EventType=goog.history.EventType;goog.History.Event=goog.history.Event;var xrx={drawing:function(){}};xrx.drawing.State={DRAG:1,NONE:2};xrx.drawing.Mode={VIEW:1,MODIFY:2,DELETE:3,CREATE:4,DISABLED:5,SELECT:6,HOVER:7,HOVERMULTIPLE:8};xrx.drawing.Orientation={C:"C",NE:"NE",SE:"SE",SW:"SW",NW:"NW"};xrx.drawing.EventType={VIEWBOX_CHANGE:"eventViewboxChange",SHAPE_MODIFY:"eventShapeModify",SHAPE_HOVER_IN:"eventShapeHoverIn",SHAPE_HOVER_MOVE:"eventShapeHoverMove",SHAPE_HOVER_OUT:"eventShapeHoverOut",SHAPE_BEFORE_DRAW:"eventShapeBeforeDraw"};xrx.shape=function(){};xrx.shape.EventType={SHAPE_BEFORE_DRAW:"eventShapeBeforeDraw"};xrx.shape.Style=function(){goog.Disposable.call(this);this.fill_={color:"",opacity:0};this.stroke_={color:"black",width:1}};goog.inherits(xrx.shape.Style,goog.Disposable);xrx.shape.Style.prototype.setStyle=function(a){this.stroke_.color=a.getStrokeColor();this.stroke_.width=a.getStrokeWidth();this.fill_.color=a.getFillColor();this.fill_.opacity=a.getFillOpacity()};xrx.shape.Style.prototype.getStrokeWidth=function(){return this.stroke_.width};
...
xrx.shape.Style.prototype.getFillOpacity=function(){return this.fill_.opacity};xrx.shape.Style.prototype.setFillOpacity=function(a){void 0!==a&&(this.fill_.opacity=a)};xrx.shape.Style.prototype.disposeInternal=function(){this.stroke_=this.fill_=null;xrx.shape.Style.superClass_.disposeInternal.call(this)};xrx.shape.RenderStylable=function(){xrx.shape.Style.call(this);this.zoomFactor_=1};goog.inherits(xrx.shape.RenderStylable,xrx.shape.Style);xrx.shape.RenderStylable.prototype.getShapeGroup=function(){return this.shapeGroup_};xrx.shape.RenderStylable.prototype.setShapeGroup=function(a){this.shapeGroup_=a};xrx.shape.RenderStylable.prototype.getEngineElement=function(){return this.engineElement_};xrx.shape.RenderStylable.prototype.setZoomFactor=function(a){this.zoomFactor_=a};
xrx.shape.RenderStylable.prototype.getRenderingFillColor=function(){return this.shapeGroup_?this.shapeGroup_.getFillColor():this.fill_.color};xrx.shape.RenderStylable.prototype.getRenderingFillOpacity=function(){return this.shapeGroup_?this.shapeGroup_.getFillOpacity():this.fill_.opacity};xrx.shape.RenderStylable.prototype.getRenderingStrokeColor=function(){return this.shapeGroup_?this.shapeGroup_.getStrokeColor():this.stroke_.color};
xrx.shape.RenderStylable.prototype.getRenderingStrokeWidth=function(){return this.shapeGroup_?this.shapeGroup_.getStrokeWidth()/this.zoomFactor_:this.stroke_.width/this.zoomFactor_};xrx.shape.RenderStylable.prototype.startDrawing_=function(){this.drawing_.eventBeforeRendering(this);this.engineElement_.applyTransform(this.ctm_);this.engineElement_.startDrawing()};xrx.shape.RenderStylable.prototype.finishDrawing_=function(){this.engineElement_.finishDrawing()};
xrx.shape.RenderStylable.prototype.disposeInternal=function(){this.engineElement_.dispose();this.engineElement_=null;goog.dispose(this.shapeGroup_);this.shapeGroup_=null;xrx.shape.RenderStylable.superClass_.disposeInternal.call(this)};xrx.vml=function(){};xrx.vml.browserEnabled=!1;xrx.vml.initVmlRendering=function(){xrx.vml.browserEnabled||(goog.style.installStyles(".xrx-vml{behavior:url(#default#VML);display:inline-block}"),xrx.vml.browserEnabled=!0)};
...
xrx.drawing.Cursor.prototype.calculate=function(a){this.calculatePoint_(a);this.calculatePointTransformed_(a);this.calculateShape_(a);this.calculateShapes_(a)};xrx.event.Handler={CLICK:"handleClick",DBLCLICK:"handleDblClick",DOWN:"handleDown",IN:"handleIn",INPUT:"handleInput",MOVE:"handleMove",OUT:"handleOut",UP:"handleUp",WHEEL:"handleWheel"};xrx.geometry.Rect=function(){xrx.geometry.Geometry.call(this);this.height=this.width=this.y=this.x=0};goog.inherits(xrx.geometry.Rect,xrx.geometry.Geometry);xrx.geometry.Rect.prototype.getBox=function(){return new goog.math.Box(this.y,this.x+this.width,this.y+this.height,this.x)};xrx.geometry.Rect.prototype.containsPoint=function(a){return a[0]>=this.x&&a[1]>=this.y&&a[0]<=this.x+this.width&&a[1]<=this.y+this.height};xrx.geometry.Rect.prototype.disposeInternal=function(){xrx.geometry.Rect.superClass_.disposeInternal.call(this)};xrx.shape.Image=function(a){xrx.shape.Geometry.call(this,a,new xrx.geometry.Rect);this.engineElement_=this.drawing_.getEngine().createImage()};goog.inherits(xrx.shape.Image,xrx.shape.Geometry);xrx.shape.Image.prototype.getImage=function(){return this.image_};xrx.shape.Image.prototype.setImage=function(a){this.image_=a;this.geometry_.width=a.naturalWidth;this.geometry_.height=a.naturalHeight};xrx.shape.Image.prototype.getHeight=function(){return this.geometry_.height};
...
xrx.shape.PolylineCreatable.prototype.handleDown=function(a,b){var c=b.getShape(),d=b.getPointTransformed();0===this.count_?(this.preview_.setCoords([d,goog.array.clone(d)]),this.count_+=1,this.target_.getDrawing().eventShapeCreate([this.preview_])):this.close_&&c===this.close_&&1===this.count_||this.preview_.setLastCoord(d)};
...
(this.drawing_.getLayerShapeModify().removeShapes(),this.shape_.getModifiable().selectOff(),this.resetState_())):(this.drawing_.getViewbox().handleDown(a,b),this.propageted_=!0,this.drawing_.getLayerShapeModify().removeShapes(),this.shape_.getModifiable().selectOff(),this.resetState_())};xrx.drawing.Modifiable.prototype.handleHover_=function(a,b){};
...
xrx.drawing.Drawing.prototype.getShapes=function(){return this.layer_[1].getShapes()||[]};xrx.drawing.Drawing.prototype.removeShape=function(a){this.layer_[1].removeShape(a);this.draw()};xrx.drawing.Drawing.prototype.getSelectedShape=function(){return this.selectable_.getShape()};xrx.drawing.Drawing.prototype.draw=function(){var a=this.getViewbox();this.eventBeforeRendering=function(b){b===a.getGroup()?b.setCTM(a.getCTM()):b instanceof xrx.shape.Style&&b.setZoomFactor(a.getZoomValue())};this.canvas_.draw()};
...
goog.uri.utils.makeUnique=function(a){return goog.uri.utils.setParam(a,goog.uri.utils.StandardQueryParam.RANDOM,goog.string.getRandomString())};goog.structs={};goog.structs.getCount=function(a){return"function"==typeof a.getCount?a.getCount():goog.isArrayLike(a)||goog.isString(a)?a.length:goog.object.getCount(a)};goog.structs.getValues=function(a){if("function"==typeof a.getValues)return a.getValues();if(goog.isString(a))return a.split("");if(goog.isArrayLike(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return goog.object.getValues(a)};
...
}return this.ieProgId_};goog.net.XmlHttp.setGlobalFactory(new goog.net.DefaultXmlHttpFactory);goog.structs.Collection=function(){};goog.iter={};goog.iter.StopIteration="StopIteration"in goog.global?goog.global.StopIteration:Error("StopIteration");goog.iter.Iterator=function(){};goog.iter.Iterator.prototype.next=function(){throw goog.iter.StopIteration;};goog.iter.Iterator.prototype.__iterator__=function(a){return this};
...
goog.net.XhrIo.prototype.formatMsg_=function(a){return a+" ["+this.lastMethod_+" "+this.lastUri_+" "+this.getStatus()+"]"};goog.debug.entryPointRegistry.register(function(a){goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_=a(goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_)});xrx.demo=function(){};xrx.demo.Demo=function(){this.activeNavbarLink_;this.handler_=new goog.events.EventHandler(this);this.history_=new goog.History;this.example_;this.status_=!0;this.init_()};xrx.demo.Demo.prototype.getExampleId=function(){return goog.dom.getWindow().location.hash.split("!")[1]};xrx.demo.Demo.prototype.reset_=function(){this.handler_.removeAll()};
xrx.demo.Demo.prototype.loadPage_=function(a,b,c,d){this.reset_();var e=this,f=goog.dom.getElement("content"),g=goog.dom.getElementsByTagNameAndClass("title")[0],h=goog.dom.htmlToDocumentFragment('<div id="content" class="container alert alert-danger"></div>');goog.dom.setTextContent(g,a);goog.net.XhrIo.send(b,function(a){var b=a.target.getResponseText(),b=goog.dom.htmlToDocumentFragment(b);200===a.target.getStatus()?(goog.dom.replaceNode(b,f),e.status_=!0):(goog.dom.setTextContent(h,a.target.getStatusText()),
goog.dom.replaceNode(h,f),e.status_=!1);e.activeNavbarLink_&&goog.dom.classes.remove(e.activeNavbarLink_,"active");c&&goog.dom.classes.add(c,"active");c&&(e.activeNavbarLink_=c);void 0!==d&&d(e)},"GET",void 0,{"cache-control":"no-cache"})};xrx.demo.Demo.prototype.loadPage_home_=function(){this.loadPage_("SemToNotes","client/demo/home.html",goog.dom.getElement("homeLink"))};
xrx.demo.Demo.prototype.loadPage_documentation_=function(){this.loadPage_("Examples | SemToNotes","client/demo/examples.html",goog.dom.getElement("apiLink"),function(a){goog.dom.getElement("content");a=0;for(var b=goog.dom.getElementsByTagNameAndClass("a").length;a<b;a++);})};
xrx.demo.Demo.prototype.installExampleBacklink_=function(a){var b=goog.dom.getElement("content");a=goog.dom.htmlToDocumentFragment('<a class="glyphicon glyphicon-arrow-left" href="#documentation!'+a+'"><strong> back</strong></a>');goog.dom.insertChildAt(b,a,0)};
xrx.demo.Demo.prototype.installExampleSource_=function(a,b,c){var d=goog.dom.getElement("content"),e=goog.dom.createElement("div"),f="js"===c?goog.dom.htmlToDocumentFragment("<h3>Source</h3>"):goog.dom.htmlToDocumentFragment("<h3>Example</h3>"),g=goog.dom.createElement("pre");b=goog.dom.htmlToDocumentFragment('<a href="'+("js"===c?"client/demo/example/"+b+".js":"client/demo/example/"+b+".htm.html")+'">'+("js"===c?"View Source &raquo;":"Try it yourself &raquo;")+"</a>");goog.dom.append(e,[f,b,g]);
goog.dom.append(d,e);goog.dom.setTextContent(g,a);goog.dom.classes.add(g,"lang-"+c);goog.dom.classes.add(g,"prettyprint");PR.prettyPrint()};xrx.demo.Demo.prototype.installExample_=function(a,b,c){this.installExampleBacklink_(b);c&&this.installExampleSource_(a,b,c);"js"===c&&(this.example_=eval(a))};
xrx.demo.Demo.prototype.loadPage_example_=function(){var a=(goog.dom.getWindow().location.hash.split("#")[1]||"home").split("!")[1];this.loadPage_("Example | SemToNotes","client/demo/example/"+a+".html",void 0,function(b){var c=goog.dom.getElement("content"),d=goog.dom.dataset.get(c,"type"),e;"js"===d?e="client/demo/example/"+a+".js":"html"===d?e="client/demo/example/"+a+".htm.html":PR.prettyPrint();goog.net.XhrIo.send(e,function(c){c=c.target.getResponseText();!0===b.status_&&b.installExample_(c,
a,d)},"GET",void 0,{"cache-control":"no-cache"})})};xrx.demo.Demo.prototype.loadPage_retrieval_=function(){this.loadPage_("Topological Retrieval | SemToNotes","client/demo/retrieval.html",goog.dom.getElement("retrievalLink"))};xrx.demo.Demo.prototype.loadPage_about_=function(){this.loadPage_("About | SemToNotes","client/demo/about.html",goog.dom.getElement("apiLink"))};
xrx.demo.Demo.prototype.navigate_=function(){if(this.example_){goog.isArray(this.example_)||(this.example_=[this.example_]);for(var a=0,b=this.example_.length;a<b;a++)this.example_[a].dispose(),this.example_[a]=null;this.example_=null}a=goog.dom.getWindow().location.hash.split("#")[1]||"home";goog.string.contains(a,"!")&&(a=a.split("!")[0]);if(this["loadPage_"+a+"_"])this["loadPage_"+a+"_"]();else this.loadPage_()};
xrx.demo.Demo.prototype.init_=function(){goog.events.listen(this.history_,goog.history.EventType.NAVIGATE,this.navigate_,!1,this);this.history_.setEnabled(!0)};xrx.demo.install=function(){return new xrx.demo.Demo};
