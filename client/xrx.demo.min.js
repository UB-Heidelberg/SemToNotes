...
xrx.shape.RenderStylable.prototype.disposeInternal=function(){this.engineElement_.dispose();this.engineElement_=null;xrx.shape.RenderStylable.superClass_.disposeInternal.call(this)};xrx.vml=function(){};xrx.vml.browserEnabled=!1;xrx.vml.initVmlRendering=function(){xrx.vml.browserEnabled||(goog.style.installStyles(".xrx-vml{behavior:url(#default#VML);display:inline-block}"),xrx.vml.browserEnabled=!0)};
