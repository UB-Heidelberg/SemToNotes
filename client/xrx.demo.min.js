...
break;default:throw Error("Unknown mode.");}};xrx.event.HandlerTarget.prototype.disposeInternal=function(){this.handler_.removeAll();this.handler_.dispose();this.handler_=null;this.cursor_.dispose();this.cursor_=null;xrx.event.HandlerTarget.superClass_.disposeInternal.call(this)};xrx.drawing.EventHandler=function(){xrx.event.HandlerTarget.call(this)};goog.inherits(xrx.drawing.EventHandler,xrx.event.HandlerTarget);xrx.drawing.EventHandler.prototype.handleShapeCreate=function(a){this.creatable_.handleCreate(a)};xrx.drawing.EventHandler.prototype.handleShapeCreated=function(a){this.creatable_.handleCreated(a)};
