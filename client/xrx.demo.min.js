...
xrx.shape.RenderStylable.prototype.setZoomFactor=function(a){this.zoomFactor_=a};xrx.shape.RenderStylable.prototype.setStyle=function(a){xrx.shape.RenderStylable.superClass_.setStyle.call(this,a);this.fillChanged_.color=!0;this.fillChanged_.opacity=!0;this.strokeChanged_.color=!0;this.strokeChanged_.width=!0};xrx.shape.RenderStylable.prototype.setFillColor=function(a){xrx.shape.RenderStylable.superClass_.setFillColor.call(this,a);this.fillChanged_.color=!0};
...
xrx.viewbox.ViewboxZoom.prototype.zoomIn=function(a){console.log(a);this.zoomTo(this.ctm_.getScale()+this.zoomFactor_,a)};xrx.viewbox.ViewboxZoom.prototype.zoomOut=function(a){console.log(a);this.zoomTo(this.ctm_.getScale()-this.zoomFactor_,a)};xrx.viewbox.ViewboxZoom.prototype.disposeInternal=function(){xrx.viewbox.ViewboxZoom.superClass_.disposeInternal.call(this)};xrx.viewbox.ViewboxTranslate=function(){xrx.viewbox.ViewboxZoom.call(this)};goog.inherits(xrx.viewbox.ViewboxTranslate,xrx.viewbox.ViewboxZoom);xrx.viewbox.ViewboxTranslate.prototype.translate=function(a,b){var c=this.ctm_.getIdentity(),d=c.transformPoint([a,b]);this.ctm_=c.translate(d[0],d[1]).concatenate(this.ctm_);this.drawing_.draw();this.dispatchExternal(xrx.drawing.EventType.VIEWBOX_CHANGE,this.drawing_)};xrx.viewbox.ViewboxTranslate.prototype.center=function(){this.centerHorizontally();this.centerVertically()};
...
xrx.drawing.Drawing.prototype.getShapes=function(){return this.layer_[1].getShapes()||[]};xrx.drawing.Drawing.prototype.removeShape=function(a){this.layer_[1].removeShape(a);this.draw()};xrx.drawing.Drawing.prototype.getSelectedShape=function(){return this.selectable_.getShape()};
...
xrx.drawing.Drawing.prototype.handleResize=function(){var a=this;goog.dom.getWindow().clearTimeout(this.timeoutResize_);this.timeoutResize_=goog.dom.getWindow().setTimeout(function(){a.calculateSize_();a.canvas_.setHeight(this.height_);a.canvas_.setWidth(this.width_);a.shield_.setHeight(this.height_);a.shield_.setWidth(this.width_)});this.draw()};
