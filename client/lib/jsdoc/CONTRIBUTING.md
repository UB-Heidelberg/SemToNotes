...
need to be manageable for the maintainers, however. So below you'll find ***REMOVED****The
...
1.***REMOVED****Create a remote to track the base jsdoc3/jsdoc repository**
...
2.***REMOVED****Set up a tracking branch for the base repository**
...
3.***REMOVED****Create your change branch**
