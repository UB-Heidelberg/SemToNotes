...
var ValidatorContext = function ValidatorContext(parent, collectMultiple, errorMessages, options) {
	this.missing = [];
	this.missingMap = {***REMOVED***
	this.formatValidators = parent ? Object.create(parent.formatValidators) : {***REMOVED***
	this.schemas = parent ? Object.create(parent.schemas) : {***REMOVED***
	...
	if (options.banUnknownProperties) {
		...
		this.knownPropertyPaths = {***REMOVED***
		this.unknownPropertyPaths = {***REMOVED***
	}
