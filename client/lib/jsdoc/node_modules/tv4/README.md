...
```javascript
var a = {***REMOVED***
var b = { a: a***REMOVED*****REMOVED***
a.b = b;
var aSchema = { properties: { b: { $ref: 'bSchema' }}***REMOVED***
var bSchema = { properties: { a: { $ref: 'aSchema' }}***REMOVED***
 ...
 ***REMOVED*** `null` (meaning no error)
 ***REMOVED*** an error string (explaining the reason for failure)
