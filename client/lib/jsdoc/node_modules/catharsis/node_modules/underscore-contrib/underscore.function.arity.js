  ...
  _.arity = (function () {
    ...
    return function arity (numberOfArgs, fun) {
      if (FUNCTIONS[numberOfArgs] == null) {
        ...
        var code = "return function ("+pstr+") { return fun.apply(this, arguments);***REMOVED*****REMOVED***";
        FUNCTIONS[numberOfArgs] = new Function(['fun'], code);
      }
      if (fun == null) {
        return function (fun) { return arity(numberOfArgs, fun);***REMOVED*****REMOVED***
      }
