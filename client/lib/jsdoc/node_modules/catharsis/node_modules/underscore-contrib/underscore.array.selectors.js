...
(function(root) {
  ...
  var existy = function(x) { return x != null;***REMOVED*****REMOVED***
  var truthy = function(x) { return (x !== false) && existy(x);***REMOVED*****REMOVED***
  var isSeq = function(x) { return (_.isArray(x)) || (_.isArguments(x));***REMOVED*****REMOVED***

  // Mixing in the array selectors
  // ----------------------------

  _.mixin({
    // Returns the second element of an array. Passing***REMOVED****n** will return all but
    // the first of the head N values in the array.  The***REMOVED****guard** check allows it
    // to work with `_.map`.
    ...
    // Returns the third element of an array. Passing***REMOVED****n** will return all but
    // the first two of the head N values in the array.  The***REMOVED****guard** check allows it
    // to work with `_.map`.
