 ...
 ***REMOVED*****REMOVED***
  ...
  _.mixin({
    ...
    pipeline: function(/*, funs***REMOVED***){
    ...
    // original predicates.
    conjoin: function(/* preds***REMOVED***) {
      var preds = arguments;
    ...
    // original predicates.
    disjoin: function(/* preds***REMOVED***) {
      var preds = arguments;
    ...
    fnull: function(fun /*, defaults***REMOVED***) {
    ...
    functionalize: function(method) {
      return function(ctx /*, args***REMOVED***) {
