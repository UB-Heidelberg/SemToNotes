...
***REMOVED***
***REMOVED*** @fileoverview Functions for formatting duration values.  Such as "3 days"
***REMOVED*** "3 hours", "14 minutes", "2 hours 45 minutes".
***REMOVED***
***REMOVED***
...
***REMOVED***
***REMOVED*** Number of milliseconds in an hour.
***REMOVED*** @type {number}
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Accepts a duration in milliseconds and outputs an absolute duration time in
***REMOVED*** form of "1 day", "2 hours", "20 minutes", "2 days 1 hour 15 minutes" etc.
***REMOVED*** @param {number} durationMs Duration in milliseconds.
***REMOVED*** @return {string} The formatted duration.
***REMOVED***
goog.date.duration.format = function(durationMs) {
   ...
   ***REMOVED*****REMOVED***
    ***REMOVED*** @desc Duration time of zero minutes.
   ***REMOVED*****REMOVED***
  ...
  var daysSeparator = days***REMOVED*** (hours + minutes) ? ' ' : '';
  // We need a space after the hours if there are minutes to come.
  var hoursSeparator = hours***REMOVED*** minutes ? ' ' : '';

 ***REMOVED*****REMOVED***
  ***REMOVED*** @desc The days part of the duration message: 1 day, 5 days.
 ***REMOVED*****REMOVED***
  var MSG_DURATION_DAYS = goog.getMsg(
      ...
      'other {{TEXT} days}}');
 ***REMOVED*****REMOVED***
  ***REMOVED*** @desc The hours part of the duration message: 1 hour, 5 hours.
 ***REMOVED*****REMOVED***
  var MSG_DURATION_HOURS = goog.getMsg(
      ...
      'other {{TEXT} hours}}');
 ***REMOVED*****REMOVED***
  ***REMOVED*** @desc The minutes part of the duration message: 1 minute, 5 minutes.
 ***REMOVED*****REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** @desc Duration time text concatenated from the individual time unit message
  ***REMOVED*** parts. The separator will be a space (e.g. '1 day 2 hours 24 minutes') or
  ***REMOVED*** nothing in case one/two of the duration parts is empty (
  ***REMOVED*** e.g. '1 hour 30 minutes', '3 days 15 minutes', '2 hours').
 ***REMOVED*****REMOVED***
...
***REMOVED***
***REMOVED*** Gets a duration message part for a time unit.
***REMOVED*** @param {string} pattern The pattern to apply.
***REMOVED*** @param {number} count The number of units.
***REMOVED*** @param {string} text The string to use for amount of units in the message.
***REMOVED*** @return {string} The formatted message part.
***REMOVED*** @private
***REMOVED***
