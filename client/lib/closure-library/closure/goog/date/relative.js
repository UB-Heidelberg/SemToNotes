...
***REMOVED***
***REMOVED*** For better quality localization of plurals ("hours"/"minutes"/"days") and
***REMOVED*** to use local digits, goog.date.relativeWithPlurals can be loaded in addition
***REMOVED*** to this namespace.
***REMOVED***
***REMOVED***
...
***REMOVED***
***REMOVED*** @typedef {function(number, boolean, goog.date.relative.Unit): string}
***REMOVED***
goog.date.relative.TimeDeltaFormatter;


***REMOVED***
***REMOVED*** Handles formatting of time deltas.
***REMOVED*** @private {goog.date.relative.TimeDeltaFormatter}
***REMOVED***
goog.date.relative.formatTimeDelta_;


***REMOVED***
***REMOVED*** Sets a different formatting function for time deltas ("3 days ago").
***REMOVED*** While its visibility is public, this function is Closure-internal and should
***REMOVED*** not be used in application code.
***REMOVED*** @param {goog.date.relative.TimeDeltaFormatter} formatter The function to use
***REMOVED***     for formatting time deltas (i.e. relative times).
***REMOVED***
...
***REMOVED*** "Yesterday", "Tomorrow", or "Sept 15".
***REMOVED***
***REMOVED*** @param {number} dateMs Date in milliseconds.
...
goog.date.relative.formatDay = function(dateMs, opt_formatter) {
  ...
  var dayAfterTomorrow = new Date(today.getTime() +
      2***REMOVED*** goog.date.relative.DAY_MS_);

  var message;
  if (dateMs >= tomorrow.getTime() && dateMs < dayAfterTomorrow.getTime()) {
   ***REMOVED*****REMOVED*** @desc Tomorrow.***REMOVED***
...
***REMOVED*** TODO(user):
***REMOVED***
***REMOVED*** I think that this whole relative formatting should move to DateTimeFormat.
***REMOVED*** But we would have to wait for the next version of CLDR, which is cleaning
***REMOVED*** the data for relative dates (even ICU has incomplete support for this).
***REMOVED***
***REMOVED***
