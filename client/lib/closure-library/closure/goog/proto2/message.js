 ...
 ***REMOVED*****REMOVED*** @type {!goog.proto2.Message}***REMOVED***
...
***REMOVED***
***REMOVED*** Returns the value for the given tag number. If a lazy deserializer is
***REMOVED*** instantiated, lazily deserializes the field if required before returning the
***REMOVED*** value.
***REMOVED***
***REMOVED*** @param {number} tag The tag number.
***REMOVED*** @return {*} The corresponding value, if any.
***REMOVED*** @private
***REMOVED***
