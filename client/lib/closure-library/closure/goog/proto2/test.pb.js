...
***REMOVED***
***REMOVED*** Message TestDefaultParent.
***REMOVED***
***REMOVED*** @extends {goog.proto2.Message}
***REMOVED*** @final
***REMOVED***
...
***REMOVED***
***REMOVED*** Overrides {@link goog.proto2.Message#clone} to specify its exact return type.
***REMOVED*** @return {!proto2.TestDefaultParent} The cloned message.
***REMOVED*** @override
***REMOVED***
...
***REMOVED***
***REMOVED*** Gets the value of the child field.
***REMOVED*** @return {proto2.TestDefaultChild} The value.
***REMOVED***
proto2.TestDefaultParent.prototype.getChild = function() {
  return***REMOVED*****REMOVED*** @type {proto2.TestDefaultChild}***REMOVED*** (this.get$Value(1));
***REMOVED***


***REMOVED***
***REMOVED*** Gets the value of the child field or the default value if not set.
***REMOVED*** @return {!proto2.TestDefaultChild} The value.
***REMOVED***
proto2.TestDefaultParent.prototype.getChildOrDefault = function() {
  return***REMOVED*****REMOVED*** @type {!proto2.TestDefaultChild}***REMOVED*** (this.get$ValueOrDefault(1));
***REMOVED***


***REMOVED***
***REMOVED*** Sets the value of the child field.
***REMOVED*** @param {!proto2.TestDefaultChild} value The value.
***REMOVED***
...
***REMOVED***
***REMOVED*** @return {boolean} Whether the child field has a value.
***REMOVED***
...
***REMOVED***
***REMOVED*** @return {number} The number of values in the child field.
***REMOVED***
...
***REMOVED***
***REMOVED*** Clears the values in the child field.
***REMOVED***
...
***REMOVED***
***REMOVED*** Message TestDefaultChild.
***REMOVED***
***REMOVED*** @extends {goog.proto2.Message}
***REMOVED*** @final
***REMOVED***
...
***REMOVED***
***REMOVED*** Overrides {@link goog.proto2.Message#clone} to specify its exact return type.
***REMOVED*** @return {!proto2.TestDefaultChild} The cloned message.
***REMOVED*** @override
***REMOVED***
...
***REMOVED***
***REMOVED*** Gets the value of the foo field.
***REMOVED*** @return {?boolean} The value.
***REMOVED***
proto2.TestDefaultChild.prototype.getFoo = function() {
  return***REMOVED*****REMOVED*** @type {?boolean}***REMOVED*** (this.get$Value(1));
***REMOVED***


***REMOVED***
***REMOVED*** Gets the value of the foo field or the default value if not set.
***REMOVED*** @return {boolean} The value.
***REMOVED***
proto2.TestDefaultChild.prototype.getFooOrDefault = function() {
  return***REMOVED*****REMOVED*** @type {boolean}***REMOVED*** (this.get$ValueOrDefault(1));
***REMOVED***


***REMOVED***
***REMOVED*** Sets the value of the foo field.
***REMOVED*** @param {boolean} value The value.
***REMOVED***
...
***REMOVED***
***REMOVED*** @return {boolean} Whether the foo field has a value.
***REMOVED***
...
***REMOVED***
***REMOVED*** @return {number} The number of values in the foo field.
***REMOVED***
...
***REMOVED***
***REMOVED*** Clears the values in the foo field.
***REMOVED***
