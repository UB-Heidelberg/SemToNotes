...
/*
***REMOVED*** Calling this method evades the logTestFailure in
***REMOVED*** goog.testing.Mock.prototype.$recordAndThrow, so it doesn't look like the
***REMOVED*** test failed.
***REMOVED***
...
***REMOVED***
***REMOVED*** Version of assertThrows that doesn't log the exception generated by the
***REMOVED*** mocks under test.
***REMOVED*** TODO: would be nice to check that a particular substring is in the thrown
***REMOVED*** message so we know it's not something dumb like a syntax error
***REMOVED***
