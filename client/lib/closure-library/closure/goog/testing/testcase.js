...
***REMOVED***
***REMOVED*** Use {@link #autoDiscoverLifecycle} and {@link #autoDiscoverTests}
***REMOVED***
...
***REMOVED***
***REMOVED*** @return {string} The name of the test.
***REMOVED***
...
***REMOVED***
***REMOVED*** Save a reference to {@code window.Date}, so any code that overrides
***REMOVED*** the default behavior doesn't affect our runner.
***REMOVED*** @type {function(new: Date)}
***REMOVED*** @private
***REMOVED***
...
***REMOVED*** {@link #maxRunTime} a timeout will be used to stop the tests blocking the
...
***REMOVED***
***REMOVED*** Creates and adds a new test.
***REMOVED***
***REMOVED*** Convenience function to make syntax less awkward when not using automatic
***REMOVED*** test discovery.
***REMOVED***
...
***REMOVED***
***REMOVED*** Returns the test results object: a map from test names to a list of test
***REMOVED*** failures (if any exist).
***REMOVED*** @return {!Object.<string, !Array.<string>>} Tests results object.
***REMOVED***
...
***REMOVED***
***REMOVED*** Adds any functions defined in the global scope that correspond to
***REMOVED*** lifecycle events for the test case. Overrides setUp, tearDown, setUpPage,
***REMOVED*** tearDownPage and runTests if they are defined.
***REMOVED***
...
***REMOVED*** time has execeeded {@link #maxRunTime}.
***REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** Test results for each test that was run. The test name is always added
  ***REMOVED*** as the key in the map, and the array of strings is an optional list
  ***REMOVED*** of failure messages. If the array is empty, the test passed. Otherwise,
  ***REMOVED*** the test failed.
  ***REMOVED*** @type {!Object.<string, !Array.<string>>}
 ***REMOVED*****REMOVED***
  this.resultsByName = {***REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** Whether the tests have completed.
  ***REMOVED*** @type {boolean}
 ***REMOVED*****REMOVED***
  this.complete = false;
***REMOVED***
