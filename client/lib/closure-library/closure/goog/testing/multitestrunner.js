 ...
 ***REMOVED*****REMOVED***
  ...
  ***REMOVED*** @type {goog.events.EventHandler.<!goog.testing.MultiTestRunner>}
  ***REMOVED*** @private
 ***REMOVED*****REMOVED***
...
***REMOVED*** @return {!Array.<string>} A list of tests from runner that have been marked
***REMOVED***     as failed.
***REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** An event handler for handling events.
  ***REMOVED*** @type {goog.events.EventHandler.<!goog.testing.MultiTestRunner.TestFrame>}
  ***REMOVED*** @private
 ***REMOVED*****REMOVED***
  this.eh_ = new goog.events.EventHandler(this);
