...
***REMOVED*** @param {Object=} opt_c Object #2 (3 arguments).
***REMOVED***
...
***REMOVED***
***REMOVED*** Checks if the given string matches the given regular expression.
***REMOVED*** @param {*} a Failure message (3 arguments) or the expected regular
***REMOVED***     expression as a string or RegExp (2 arguments).
***REMOVED*** @param {*} b The regular expression (3 arguments) or the string to test
***REMOVED***     (2 arguments).
***REMOVED*** @param {*=} opt_c The string to test.
***REMOVED***
