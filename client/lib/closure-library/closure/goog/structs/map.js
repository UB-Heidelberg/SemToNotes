...
***REMOVED*** of the methods used in goog.structs so those functions work on hashes. This
***REMOVED*** is best suited for complex key types. For simple keys such as numbers and
***REMOVED*** strings, and where special names like __proto__ are not a concern, consider
***REMOVED*** using the lighter-weight utilities in goog.object.
***REMOVED***
...
***REMOVED*** @return {!Array.<V>} The values in the map.
***REMOVED***
...
***REMOVED*** @param {function(V, V): boolean=} opt_equalityFn Optional equality function
...
***REMOVED*** @param {DEFAULT=} opt_val The value to return if no item is found for the
***REMOVED***     given key, defaults to undefined.
***REMOVED*** @return {V|DEFAULT} The value for the given key.
***REMOVED*** @template DEFAULT
***REMOVED***
...
***REMOVED***
***REMOVED*** Calls the given function on each entry in the map.
***REMOVED*** @param {function(this:T, V, K, goog.structs.Map.<K,V>)} f
***REMOVED*** @param {T=} opt_obj The value of "this" inside f.
***REMOVED*** @template T
***REMOVED***
