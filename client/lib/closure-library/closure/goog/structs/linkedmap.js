 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** @private {!goog.structs.Map.<string,
  ***REMOVED***     goog.structs.LinkedMap.Node_.<string, VALUE>>}
 ***REMOVED*****REMOVED***
...
***REMOVED*** @param {VALUE=} opt_val A default value that will be returned if the key is
***REMOVED***     not found, defaults to undefined.
***REMOVED*** @return {VALUE} The retrieved value.
***REMOVED***
...
***REMOVED*** @param {string} key The key to retrieve the value for.
***REMOVED*** @param {VALUE} value A default value that will be returned if the key is
***REMOVED***     not found.
***REMOVED***
...
***REMOVED*** @return {VALUE} The value of the first node or undefined if the map is empty.
***REMOVED***
...
***REMOVED*** @return {VALUE} The value of the last node or undefined if the map is empty.
***REMOVED***
...
***REMOVED*** @return {VALUE} The value of the popped node, or undefined if the map was
***REMOVED***     empty.
***REMOVED***
...
***REMOVED***
***REMOVED*** @return {!Array.<VALUE>} The list of the values in the appropriate order for
***REMOVED***     this LinkedMap.
***REMOVED***
...
***REMOVED*** @param {VALUE} value The value to check for.
...
***REMOVED*** @param {Object=} opt_obj The object context to use as "this" for the
***REMOVED***     function.
***REMOVED*** @return {!Array.<VALUE>} The results of the function calls for each item in
***REMOVED***     the LinkedMap.
***REMOVED***
...
***REMOVED*** @return {VALUE} The value of the popped node.
***REMOVED*** @private
***REMOVED***
