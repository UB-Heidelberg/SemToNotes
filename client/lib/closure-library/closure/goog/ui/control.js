...
***REMOVED*** @param {goog.ui.ControlContent=} opt_content Text caption or DOM structure
***REMOVED***     to display as the content of the control (if any).
...
***REMOVED*** Called by renderers during element decoration.
***REMOVED***
