 ...
 ***REMOVED*****REMOVED*** @private {!goog.ui.MenuRenderer}***REMOVED***
...
***REMOVED*** @param {goog.events.Event=} opt_e Event that caused the menu to be opened.
***REMOVED*** @override
***REMOVED***
...
***REMOVED***
***REMOVED*** Attaches or detaches a keydown event listener to/from the given element.
***REMOVED*** Called each time the button enters or exits the document.
***REMOVED*** @param {boolean} attach Whether to attach or detach the event listener.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Handles {@code KEYDOWN} events dispatched by the button element. When the
***REMOVED*** button is focusable and the menu is present and visible, prevents the event
***REMOVED*** from propagating since the desired behavior is only to close the menu.
***REMOVED*** @param {goog.events.Event} e KeyDown event to handle.
***REMOVED*** @private
***REMOVED***
