...
***REMOVED***
***REMOVED*** @define {boolean} Whether to support calling decorate with an element that is
***REMOVED***     not yet in the document. If true, we check if the element is in the
***REMOVED***     document, and avoid calling enterDocument if it isn't. If false, we
***REMOVED***     maintain legacy behavior (always call enterDocument from decorate).
***REMOVED***
...
***REMOVED***
***REMOVED*** @define {number} Defines the default BIDI directionality.
***REMOVED***     0: Unknown.
***REMOVED***     1: Left-to-right.
***REMOVED***     -1: Right-to-left.
***REMOVED***
...
***REMOVED***
***REMOVED*** This should only be used by subclasses and its associated renderers.
***REMOVED***
...
***REMOVED***
***REMOVED*** Similar to {@code getElementByClass} except that it expects the
***REMOVED*** element to be present in the dom thus returning a required value. Otherwise,
***REMOVED*** will assert.
***REMOVED*** @param {string} className The name of the class to look for.
***REMOVED*** @return {!Element} The first item with the class name provided.
***REMOVED***
...
***REMOVED*** @return {!goog.events.EventHandler.<T>} Event handler for this component.
***REMOVED*** @protected
***REMOVED*** @this T
***REMOVED*** @template T
***REMOVED***
...
***REMOVED***
***REMOVED*** Decorates the element for the UI component. If the element is in the
***REMOVED*** document, the enterDocument method will be called.
***REMOVED***
***REMOVED*** If goog.ui.Component.ALLOW_DETACHED_DECORATION is false, the caller must
***REMOVED*** pass an element that is in the document.
***REMOVED***
...
***REMOVED*** parent component's element. If the parent does not yet have an element, then
***REMOVED*** {@code createDom} will automatically be invoked on the parent before
***REMOVED*** rendering the child.
***REMOVED***
***REMOVED*** Invoking {@code parent.addChild(child, true)} will throw an error if the
***REMOVED*** child component is already in the document, regardless of the parent's DOM
***REMOVED*** state.
***REMOVED***
