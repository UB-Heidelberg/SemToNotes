...
***REMOVED*** @param {boolean=} opt_useSeparator If true, number and scale will be
***REMOVED***     separated by a no break space. Default is false.
...
***REMOVED*** @param {boolean=} opt_useSeparator If true, number and scale will be
***REMOVED***     separated by a space. Default is false.
***REMOVED*** @return {string} The human readable form of the byte size.
***REMOVED*** @private
***REMOVED***
goog.format.numericValueToString_ = function(val, conversion,
  ...
  return Math.round(orig_val / scale***REMOVED*** ex) / ex + separator + symbol;
***REMOVED***
