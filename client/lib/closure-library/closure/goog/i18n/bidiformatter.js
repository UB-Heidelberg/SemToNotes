...
***REMOVED***
***REMOVED*** @param {goog.i18n.bidi.Dir|number|boolean|null} contextDir The context
***REMOVED***     directionality, in one of the following formats:
***REMOVED***     1. A goog.i18n.bidi.Dir constant. NEUTRAL is treated the same as null,
***REMOVED***        i.e. unknown, for backward compatibility with legacy calls.
***REMOVED***     2. A number (positive = LTR, negative = RTL, 0 = unknown).
 ...
 ***REMOVED*****REMOVED***
  ...
  ***REMOVED*** @private
 ***REMOVED*****REMOVED***
  this.contextDir_ = goog.i18n.bidi.toDir(contextDir, true /* opt_noNeutral***REMOVED***);
...
***REMOVED*** it is LTR. In case it's NEUTRAL, returns "rtl" if the context directionality
***REMOVED*** is RTL, and "ltr" otherwise.
***REMOVED*** Needed for GXP, which can't handle dirAttr.
***REMOVED*** Example use case:
***REMOVED*** &lt;td expr:dir='bidiFormatter.dirAttrValue(foo)'&gt;
***REMOVED***   &lt;gxp:eval expr='foo'&gt;
***REMOVED*** &lt;/td&gt;
***REMOVED***
...
***REMOVED*** case it's NEUTRAL, returns "rtl" if the context directionality is RTL, and
...
***REMOVED*** If !{@code opt_isHtml}, HTML-escapes {@code str} regardless of wrapping.
***REMOVED***
***REMOVED*** @param {?goog.i18n.bidi.Dir} dir {@code str}'s overall directionality, or
***REMOVED***     null if unknown and needs to be estimated.
***REMOVED*** @param {string} str The input text.
***REMOVED*** @param {boolean=} opt_isHtml Whether {@code str} is HTML / HTML-escaped.
***REMOVED***     Default: false.
***REMOVED*** @param {boolean=} opt_dirReset Whether to append a trailing unicode bidi mark
...
***REMOVED***
***REMOVED*** The internal implementation of spanWrapWithKnownDir for non-null dir, to help
***REMOVED*** the compiler optimize.
***REMOVED***
***REMOVED*** @param {goog.i18n.bidi.Dir} dir {@code str}'s overall directionality.
***REMOVED*** @param {string} str The input text.
***REMOVED*** @param {boolean=} opt_isHtml Whether {@code str} is HTML / HTML-escaped.
...
***REMOVED***
***REMOVED*** The internal implementation of unicodeWrapWithKnownDir for non-null dir, to
***REMOVED*** help the compiler optimize.
***REMOVED***
***REMOVED*** @param {goog.i18n.bidi.Dir} dir {@code str}'s overall directionality.
***REMOVED*** @param {string} str The input text.
***REMOVED*** @param {boolean=} opt_isHtml Whether {@code str} is HTML / HTML-escaped.
...
***REMOVED***
***REMOVED*** Returns a Unicode BiDi mark matching the context directionality (LRM or RLM)
***REMOVED*** if the given directionality or the exit directionality of {@code str} are
***REMOVED*** opposite to the context directionality. Otherwise returns the empty string.
***REMOVED***
***REMOVED*** @param {?goog.i18n.bidi.Dir} dir {@code str}'s overall directionality, or
***REMOVED***     null if unknown and needs to be estimated.
***REMOVED*** @param {string} str The input text.
