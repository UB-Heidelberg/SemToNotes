...
***REMOVED***
***REMOVED*** Rotates this coordinate clockwise about the origin (or, optionally, the given
***REMOVED*** center) by the given angle, in radians.
***REMOVED*** @param {number} radians The angle by which to rotate this coordinate
***REMOVED***     clockwise about the given center, in radians.
***REMOVED*** @param {!goog.math.Coordinate=} opt_center The center of rotation. Defaults
***REMOVED***     to (0, 0) if not given.
***REMOVED***
goog.math.Coordinate.prototype.rotateRadians = function(radians, opt_center) {
  ...
  this.x = (x - center.x)***REMOVED*** cos - (y - center.y)***REMOVED*** sin + center.x;
  this.y = (x - center.x)***REMOVED*** sin + (y - center.y)***REMOVED*** cos + center.y;
***REMOVED***


***REMOVED***
***REMOVED*** Rotates this coordinate clockwise about the origin (or, optionally, the given
***REMOVED*** center) by the given angle, in degrees.
***REMOVED*** @param {number} degrees The angle by which to rotate this coordinate
***REMOVED***     clockwise about the given center, in degrees.
***REMOVED*** @param {!goog.math.Coordinate=} opt_center The center of rotation. Defaults
***REMOVED***     to (0, 0) if not given.
***REMOVED***
