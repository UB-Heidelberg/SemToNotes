...
***REMOVED*** tolerance to adjust for floating point errors.
***REMOVED*** @param {number} a A number.
***REMOVED*** @param {number} b A number.
...
// alias.
***REMOVED***
***REMOVED*** Normalizes an angle to be in range [0-360). Angles outside this range will
***REMOVED*** be normalized to be the equivalent angle with that range.
...
***REMOVED***
***REMOVED*** Normalizes an angle to be in range [0-2*PI). Angles outside this range will
***REMOVED*** be normalized to be the equivalent angle with that range.
***REMOVED*** @param {number} angle Angle in radians.
***REMOVED*** @return {number} Standardized angle.
***REMOVED***
goog.math.standardAngleInRadians = function(angle) {
  return goog.math.modulo(angle, 2***REMOVED*** Math.PI);
***REMOVED***
...
***REMOVED***
***REMOVED*** Returns the unbiased sample variance of the arguments. For a definition,
***REMOVED*** see e.g. http://en.wikipedia.org/wiki/Variance
***REMOVED*** @param {...number} var_args Number samples to analyze.
***REMOVED*** @return {number} The unbiased sample variance of the arguments (0 if fewer
...
***REMOVED***
***REMOVED*** Returns the precise value of floor(log10(num)).
***REMOVED*** Simpler implementations didn't work because of floating point rounding
***REMOVED*** errors. For example
***REMOVED*** <ul>
***REMOVED*** <li>Math.floor(Math.log(num) / Math.LN10) is off by one for num == 1e+3.
***REMOVED*** <li>Math.floor(Math.log(num)***REMOVED*** Math.LOG10E) is off by one for num == 1e+15.
***REMOVED*** <li>Math.floor(Math.log10(num)) is off by one for num == 1e+15 - 1.
***REMOVED*** </ul>
***REMOVED*** @param {number} num A floating point number.
***REMOVED*** @return {number} Its logarithm to base 10 rounded down to the nearest
***REMOVED***     integer if num > 0. -Infinity if num == 0. NaN if num < 0.
***REMOVED***
goog.math.log10Floor = function(num) {
  if (num > 0) {
    var x = Math.round(Math.log(num)***REMOVED*** Math.LOG10E);
