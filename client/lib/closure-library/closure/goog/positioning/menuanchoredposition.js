...
***REMOVED***
***REMOVED*** @fileoverview Anchored viewport positioning class with both adjust and
***REMOVED***     resize options for the popup.
***REMOVED***
...
***REMOVED*** an element.  The positioning behavior changes based on the values of
***REMOVED*** opt_adjust and opt_resize.
***REMOVED***
...
***REMOVED*** @param {boolean=} opt_resize Whether the positioning should be adjusted until
***REMOVED***     the element fits inside the viewport on the X axis and its height is
***REMOVED***     resized so if fits in the viewport. This take precedence over opt_adjust.
***REMOVED***
***REMOVED*** @extends {goog.positioning.AnchoredViewportPosition}
***REMOVED***
