...
***REMOVED***
***REMOVED*** Safe source for a new blank iframe that may not cause a new load of the
***REMOVED*** iframe. This is different from {@code goog.dom.iframe.BLANK_SOURCE} in that
***REMOVED*** it will allow an iframe to be loaded synchronously in more browsers, notably
***REMOVED*** Gecko, following the javascript protocol spec.
***REMOVED***
***REMOVED*** NOTE: This should not be used to replace the source of an existing iframe.
***REMOVED*** The new src value will be ignored, per the spec.
***REMOVED***
***REMOVED*** Due to cross-browser differences, the load is not guaranteed  to be
***REMOVED*** synchronous. If code depends on the load of the iframe,
***REMOVED*** then {@code goog.net.IframeLoadMonitor} or a similar technique should be
***REMOVED*** used.
***REMOVED***
***REMOVED*** According to
***REMOVED*** http://www.whatwg.org/specs/web-apps/current-work/multipage/webappapis.html#javascript-protocol
***REMOVED*** the 'javascript:""' URL should trigger a new load of the iframe, which may be
***REMOVED*** asynchronous. A void src, such as 'javascript:undefined', does not change
***REMOVED*** the browsing context document's, and thus should not trigger another load.
***REMOVED***
***REMOVED*** Intentionally not about:blank, which also triggers a load.
***REMOVED***
***REMOVED*** NOTE: 'javascript:' URL handling spec compliance varies per browser. IE
***REMOVED*** throws an error with 'javascript:undefined'. Webkit browsers will reload the
***REMOVED*** iframe when setting this source on an existing iframe.
***REMOVED***
***REMOVED*** @type {string}
***REMOVED***
