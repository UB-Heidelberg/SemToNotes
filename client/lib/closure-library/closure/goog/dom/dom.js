...
***REMOVED***
***REMOVED*** Gets an element from the current document by element id.
***REMOVED***
***REMOVED*** If an Element is passed in, it is returned.
***REMOVED***
...
***REMOVED***
***REMOVED*** Gets an element by id from the given document (if present).
***REMOVED*** If an element is given, it is returned.
***REMOVED*** @param {!Document} doc
***REMOVED*** @param {string|Element} element Element ID or a DOM node.
***REMOVED*** @return {Element} The resulting element.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Gets an element by id, asserting that the element is found.
***REMOVED***
***REMOVED*** This is used when an element is expected to exist, and should fail with
***REMOVED*** an assertion error if it does not (if assertions are enabled).
***REMOVED***
***REMOVED*** @param {string} id Element ID.
***REMOVED*** @return {!Element} The element with the given ID, if it exists.
***REMOVED***
...
***REMOVED***
***REMOVED*** Helper function for getRequiredElementHelper functions, both static and
***REMOVED*** on DomHelper.  Asserts the element with the given id exists.
***REMOVED*** @param {!Document} doc
***REMOVED*** @param {string} id
***REMOVED*** @return {!Element} The element with the given ID, if it exists.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Note that tag names are case sensitive in the SVG namespace, and this
***REMOVED*** function converts opt_tag to uppercase for comparisons. For queries in the
***REMOVED*** SVG namespace you should use querySelector or querySelectorAll instead.
***REMOVED*** https://bugzilla.mozilla.org/show_bug.cgi?id=963870
***REMOVED*** https://bugs.webkit.org/show_bug.cgi?id=83438
***REMOVED***
...
***REMOVED***
***REMOVED*** Returns a static, array-like list of the elements with the provided
***REMOVED*** className.
***REMOVED*** @see {goog.dom.query}
...
***REMOVED***
***REMOVED*** Ensures an element with the given className exists, and then returns the
***REMOVED*** first element with the provided className.
***REMOVED*** @see {goog.dom.query}
***REMOVED*** @param {string} className the name of the class to look for.
***REMOVED*** @param {!Element|!Document=} opt_root Optional element or document to look
***REMOVED***     in.
***REMOVED*** @return {!Element} The first item with the class name provided.
***REMOVED*** @throws {goog.asserts.AssertionError} Thrown if no element is found.
***REMOVED***
...
***REMOVED***
***REMOVED*** Sets the text content of a node, with cross-browser support.
***REMOVED*** @param {Node} node The node to change the text content of.
***REMOVED*** @param {string|number} text The value that should replace the node's content.
***REMOVED***
...
***REMOVED*** keyboard focus (tabIndex >= 0), false otherwise.  Note that some elements
...
***REMOVED***
***REMOVED*** Returns true if the element can be focused, i.e. it has a tab index that
***REMOVED*** allows it to receive keyboard focus (tabIndex >= 0), or it is an element
***REMOVED*** that natively supports keyboard focus.
***REMOVED*** @param {Element} element Element to check.
***REMOVED*** @return {boolean} Whether the element allows keyboard focus.
***REMOVED***
...
***REMOVED***
***REMOVED*** Returns true if the element has a specified tab index.
***REMOVED*** @param {Element} element Element to check.
***REMOVED*** @return {boolean} Whether the element has a specified tab index.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Returns true if the element's tab index allows the element to be focused.
***REMOVED*** @param {Element} element Element to check.
***REMOVED*** @return {boolean} Whether the element's tab index allows focus.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Returns true if the element is focusable even when tabIndex is not set.
***REMOVED*** @param {Element} element Element to check.
***REMOVED*** @return {boolean} Whether the element natively supports focus.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Returns true if the element has a bounding rectangle that would be visible
***REMOVED*** (i.e. its width and height are greater than zero).
***REMOVED*** @param {Element} element Element to check.
***REMOVED*** @return {boolean} Whether the element has a non-zero bounding rectangle.
***REMOVED*** @private
***REMOVED***
goog.dom.hasNonZeroBoundingRect_ = function(element) {
  var rect = goog.isFunction(element['getBoundingClientRect']) ?
      element.getBoundingClientRect() :
      {'height': element.offsetHeight, 'width': element.offsetWidth***REMOVED***
...
***REMOVED***
***REMOVED*** @private {number} Cached version of the devicePixelRatio.
***REMOVED***
goog.dom.devicePixelRatio_;


***REMOVED***
***REMOVED*** Gives the devicePixelRatio, or attempts to determine if not present.
***REMOVED***
***REMOVED*** By default, this is the same value given by window.devicePixelRatio. If
***REMOVED*** devicePixelRatio is not defined, the ratio is calculated with
***REMOVED*** window.matchMedia, if present. Otherwise, gives 1.0.
***REMOVED***
***REMOVED*** This function is cached so that the pixel ratio is calculated only once
***REMOVED*** and only calculated when first requested.
***REMOVED***
***REMOVED*** @return {number} The number of actual pixels per virtual pixel.
***REMOVED***
...
***REMOVED***
***REMOVED*** Calculates a mediaQuery to check if the current device supports the
***REMOVED*** given actual to virtual pixel ratio.
***REMOVED*** @param {number} pixelRatio The ratio of actual pixels to virtual pixels.
***REMOVED*** @return {number} pixelRatio if applicable, otherwise 0.
***REMOVED*** @private
***REMOVED***
