...
***REMOVED***
***REMOVED*** @fileoverview Provides functions for operating on 4x4 double (64bit)
...
***REMOVED*** @typedef {goog.vec.Float64}***REMOVED*** goog.vec.mat4d.Type;


***REMOVED***
***REMOVED*** Creates a mat4d with all elements initialized to zero.
***REMOVED***
***REMOVED*** @return {!goog.vec.mat4d.Type} The new mat4d.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to receive the
***REMOVED***     values.
...
***REMOVED*** @return {!goog.vec.mat4d.Type} return mat so that operations can be
...
***REMOVED***
***REMOVED*** Initializes mat4d mat from mat4d src.
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The destination matrix.
***REMOVED*** @param {goog.vec.mat4d.Type} src The source matrix.
***REMOVED*** @return {!goog.vec.mat4d.Type} Return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** Initializes mat4d mat from mat4f src (typed as a Float32Array to
***REMOVED*** avoid circular goog.requires).
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The destination matrix.
***REMOVED*** @param {Float32Array} src The source matrix.
***REMOVED*** @return {!goog.vec.mat4d.Type} Return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** Initializes mat4d mat from Array src.
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The destination matrix.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix containing the value to
***REMOVED***     retrieve.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to receive the values.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to receive the values.
***REMOVED*** @param {goog.vec.vec4d.Type} vec The vector containing the values.
***REMOVED*** @return {!goog.vec.mat4d.Type} return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix containing the values.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to recieve the values.
...
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to receive the values.
***REMOVED*** @param {number} column The column index to set the values on.
***REMOVED*** @param {goog.vec.vec4d.Type} vec The vector of elements for the column.
***REMOVED*** @return {!goog.vec.mat4d.Type} return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix supplying the values.
***REMOVED*** @param {number} column The column to get the values from.
***REMOVED*** @param {goog.vec.vec4d.Type} vec The vector of elements to
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to receive the values.
***REMOVED*** @param {goog.vec.vec4d.Type} vec0 The values for column 0.
***REMOVED*** @param {goog.vec.vec4d.Type} vec1 The values for column 1.
***REMOVED*** @param {goog.vec.vec4d.Type} vec2 The values for column 2.
***REMOVED*** @param {goog.vec.vec4d.Type} vec3 The values for column 3.
***REMOVED*** @return {!goog.vec.mat4d.Type} return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix supplying the columns.
***REMOVED*** @param {goog.vec.vec4d.Type} vec0 The vector to receive column 0.
***REMOVED*** @param {goog.vec.vec4d.Type} vec1 The vector to receive column 1.
***REMOVED*** @param {goog.vec.vec4d.Type} vec2 The vector to receive column 2.
***REMOVED*** @param {goog.vec.vec4d.Type} vec3 The vector to receive column 3.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to receive the row values.
...
***REMOVED*** @param {goog.vec.vec4d.Type} vec The vector to receive the row.
***REMOVED*** @return {!goog.vec.vec4d.Type} return vec so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to receive the values.
***REMOVED*** @param {goog.vec.vec4d.Type} vec0 The values for row 0.
***REMOVED*** @param {goog.vec.vec4d.Type} vec1 The values for row 1.
***REMOVED*** @param {goog.vec.vec4d.Type} vec2 The values for row 2.
***REMOVED*** @param {goog.vec.vec4d.Type} vec3 The values for row 3.
***REMOVED*** @return {!goog.vec.mat4d.Type} return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to supply the values.
***REMOVED*** @param {goog.vec.vec4d.Type} vec0 The vector to receive row 0.
***REMOVED*** @param {goog.vec.vec4d.Type} vec1 The vector to receive row 1.
***REMOVED*** @param {goog.vec.vec4d.Type} vec2 The vector to receive row 2.
***REMOVED*** @param {goog.vec.vec4d.Type} vec3 The vector to receive row 3.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix.
***REMOVED*** @return {!goog.vec.mat4d.Type} return mat so operations can be chained.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat0 The first addend.
***REMOVED*** @param {goog.vec.mat4d.Type} mat1 The second addend.
***REMOVED*** @param {goog.vec.mat4d.Type} resultMat The matrix to
***REMOVED***     receive the results (may be either mat0 or mat1).
***REMOVED*** @return {!goog.vec.mat4d.Type} return resultMat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat0 The minuend.
***REMOVED*** @param {goog.vec.mat4d.Type} mat1 The subtrahend.
***REMOVED*** @param {goog.vec.mat4d.Type} resultMat The matrix to receive
...
***REMOVED*** storing the result into resultMat.
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat0 The first (left hand) matrix.
***REMOVED*** @param {goog.vec.mat4d.Type} mat1 The second (right hand) matrix.
***REMOVED*** @param {goog.vec.mat4d.Type} resultMat The matrix to receive
***REMOVED***     the results (may be either mat0 or mat1).
***REMOVED*** @return {!goog.vec.mat4d.Type} return resultMat so that operations can be
***REMOVED***     chained together.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to transpose.
***REMOVED*** @param {goog.vec.mat4d.Type} resultMat The matrix to receive
***REMOVED***     the results (may be mat).
***REMOVED*** @return {!goog.vec.mat4d.Type} return resultMat so that operations can be
***REMOVED***     chained together.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to compute the matrix for.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix to invert.
***REMOVED*** @param {goog.vec.mat4d.Type} resultMat The matrix to receive
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat0 The first matrix.
***REMOVED*** @param {goog.vec.mat4d.Type} mat1 The second matrix.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix supplying the transformation.
***REMOVED*** @param {goog.vec.vec3d.Type} vec The 3 element vector to transform.
***REMOVED*** @param {goog.vec.vec3d.Type} resultVec The 3 element vector to
...
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix supplying the transformation.
***REMOVED*** @param {goog.vec.vec3d.Type} vec The 3 element vector to transform.
***REMOVED*** @param {goog.vec.vec3d.Type} resultVec The 3 element vector
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix supplying the transformation.
***REMOVED*** @param {goog.vec.vec4d.Type} vec The vector to transform.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix.
***REMOVED*** @param {goog.vec.vec3d.Type} eyePt The position of the eye point
***REMOVED***     (camera origin).
***REMOVED*** @param {goog.vec.vec3d.Type} centerPt The point to aim the camera at.
***REMOVED*** @param {goog.vec.vec3d.Type} worldUpVec The vector that identifies
...
***REMOVED*** @param {goog.vec.vec3d.Type} eyePt The position of the eye point
***REMOVED***     (camera origin).
***REMOVED*** @param {goog.vec.vec3d.Type} fwdVec The vector describing where
***REMOVED***     the camera points to.
***REMOVED*** @param {goog.vec.vec3d.Type} worldUpVec The vector that
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix.
***REMOVED*** @param {goog.vec.vec3d.Type} euler The ZXZ Euler angles in
...
***REMOVED*** @return {!goog.vec.vec4d.Type} return euler so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED*** goog.vec.mat4d.multMat(
***REMOVED***     mat,
***REMOVED***     goog.vec.mat4d.makeTranslate(goog.vec.mat4d.create(), x, y, z),
***REMOVED***     mat);
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix.
***REMOVED*** @param {number} x The translation along the x axis.
...
***REMOVED*** goog.vec.mat4d.multMat(
***REMOVED***     mat,
***REMOVED***     goog.vec.mat4d.makeScale(goog.vec.mat4d.create(), x, y, z),
***REMOVED***     mat);
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix.
...
***REMOVED*** goog.vec.mat4d.multMat(
***REMOVED***     mat,
***REMOVED***     goog.vec.mat4d.makeRotate(goog.vec.mat4d.create(), angle, x, y, z),
***REMOVED***     mat);
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix.
...
***REMOVED*** goog.vec.mat4d.multMat(
***REMOVED***     mat,
***REMOVED***     goog.vec.mat4d.makeRotateX(goog.vec.mat4d.create(), angle),
***REMOVED***     mat);
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix.
***REMOVED*** @param {number} angle The angle in radians.
...
***REMOVED*** goog.vec.mat4d.multMat(
***REMOVED***     mat,
***REMOVED***     goog.vec.mat4d.makeRotateY(goog.vec.mat4d.create(), angle),
***REMOVED***     mat);
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix.
***REMOVED*** @param {number} angle The angle in radians.
...
***REMOVED*** goog.vec.mat4d.multMat(
***REMOVED***     mat,
***REMOVED***     goog.vec.mat4d.makeRotateZ(goog.vec.mat4d.create(), angle),
***REMOVED***     mat);
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The matrix.
***REMOVED*** @param {number} angle The angle in radians.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat4d.Type} mat The transformation matrix.
***REMOVED*** @param {goog.vec.vec3d.Type} translation The vector for storing the
***REMOVED***     result.
***REMOVED*** @return {!goog.vec.vec3d.Type} return translation so that operations can be
***REMOVED***     chained.
***REMOVED***
...
***REMOVED***
***REMOVED*** @type {Array.<goog.vec.vec3d.Type>}
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** @type {Array.<goog.vec.vec4d.Type>}
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** @type {Array.<goog.vec.mat4d.Type>}
***REMOVED*** @private
***REMOVED***
