...
***REMOVED***
***REMOVED*** @fileoverview Provides functions for operating on 3x3 double (64bit)
...
***REMOVED*** @typedef {goog.vec.Float64}***REMOVED*** goog.vec.mat3d.Type;


***REMOVED***
***REMOVED*** Creates a mat3d with all elements initialized to zero.
***REMOVED***
***REMOVED*** @return {!goog.vec.mat3d.Type} The new mat3d.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix to receive the
***REMOVED***     values.
...
***REMOVED*** @return {!goog.vec.mat3d.Type} return mat so that operations can be
...
***REMOVED***
***REMOVED*** Initializes mat3d mat from mat3d src.
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The destination matrix.
***REMOVED*** @param {goog.vec.mat3d.Type} src The source matrix.
***REMOVED*** @return {!goog.vec.mat3d.Type} Return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** Initializes mat3d mat from mat3f src (typed as a Float32Array to
...
***REMOVED***
***REMOVED*** Initializes mat3d mat from Array src.
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The destination matrix.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix containing the value to
***REMOVED***     retrieve.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix to receive the values.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix to receive the values.
***REMOVED*** @param {goog.vec.vec3d.Type} vec The vector containing the values.
***REMOVED*** @return {!goog.vec.mat3d.Type} return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix to recieve the values.
...
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix to receive the values.
***REMOVED*** @param {number} column The column index to set the values on.
***REMOVED*** @param {goog.vec.vec3d.Type} vec The vector elements for the column.
***REMOVED*** @return {!goog.vec.mat3d.Type} return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED*** array.
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix supplying the values.
***REMOVED*** @param {number} column The column to get the values from.
***REMOVED*** @param {goog.vec.vec3d.Type} vec The vector elements to receive the
***REMOVED***     column.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix to receive the values.
***REMOVED*** @param {goog.vec.vec3d.Type} vec0 The values for column 0.
***REMOVED*** @param {goog.vec.vec3d.Type} vec1 The values for column 1.
***REMOVED*** @param {goog.vec.vec3d.Type} vec2 The values for column 2.
***REMOVED*** @return {!goog.vec.mat3d.Type} return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
goog.vec.mat3d.setColumns = function(mat, vec0, vec1, vec2) {
  ...
  return***REMOVED*****REMOVED*** @type {!goog.vec.mat3d.Type}***REMOVED***(mat);
***REMOVED***
...
***REMOVED*** elements.
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix supplying the columns.
***REMOVED*** @param {goog.vec.vec3d.Type} vec0 The vector to receive column 0.
***REMOVED*** @param {goog.vec.vec3d.Type} vec1 The vector to receive column 1.
***REMOVED*** @param {goog.vec.vec3d.Type} vec2 The vector to receive column 2.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix to receive the row values.
...
***REMOVED*** @param {goog.vec.vec3d.Type} vec The vector to receive the row.
***REMOVED*** @return {!goog.vec.vec3d.Type} return vec so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix to receive the values.
***REMOVED*** @param {goog.vec.vec3d.Type} vec0 The values for row 0.
***REMOVED*** @param {goog.vec.vec3d.Type} vec1 The values for row 1.
***REMOVED*** @param {goog.vec.vec3d.Type} vec2 The values for row 2.
***REMOVED*** @return {!goog.vec.mat3d.Type} return mat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix to supplying the values.
***REMOVED*** @param {goog.vec.vec3d.Type} vec0 The vector to receive row 0.
***REMOVED*** @param {goog.vec.vec3d.Type} vec1 The vector to receive row 1.
***REMOVED*** @param {goog.vec.vec3d.Type} vec2 The vector to receive row 2.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix.
***REMOVED*** @return {!goog.vec.mat3d.Type} return mat so operations can be chained.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat0 The first addend.
***REMOVED*** @param {goog.vec.mat3d.Type} mat1 The second addend.
***REMOVED*** @param {goog.vec.mat3d.Type} resultMat The matrix to
***REMOVED***     receive the results (may be either mat0 or mat1).
***REMOVED*** @return {!goog.vec.mat3d.Type} return resultMat so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat0 The minuend.
***REMOVED*** @param {goog.vec.mat3d.Type} mat1 The subtrahend.
***REMOVED*** @param {goog.vec.mat3d.Type} resultMat The matrix to receive
...
***REMOVED*** storing the result into resultMat.
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat0 The first (left hand) matrix.
***REMOVED*** @param {goog.vec.mat3d.Type} mat1 The second (right hand) matrix.
***REMOVED*** @param {goog.vec.mat3d.Type} resultMat The matrix to receive
***REMOVED***     the results (may be either mat0 or mat1).
***REMOVED*** @return {!goog.vec.mat3d.Type} return resultMat so that operations can be
***REMOVED***     chained together.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix to transpose.
***REMOVED*** @param {goog.vec.mat3d.Type} resultMat The matrix to receive
***REMOVED***     the results (may be mat).
***REMOVED*** @return {!goog.vec.mat3d.Type} return resultMat so that operations can be
***REMOVED***     chained together.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat0 The matrix to invert.
***REMOVED*** @param {goog.vec.mat3d.Type} resultMat The matrix to receive
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat0 The first matrix.
***REMOVED*** @param {goog.vec.mat3d.Type} mat1 The second matrix.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix supplying the transformation.
***REMOVED*** @param {goog.vec.vec3d.Type} vec The vector to transform.
...
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The 3x3 (9-element) matrix
...
***REMOVED*** goog.vec.mat3d.multMat(
***REMOVED***     mat,
***REMOVED***     goog.vec.mat3d.makeRotate(goog.vec.mat3d.create(), angle, x, y, z),
***REMOVED***     mat);
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix.
...
***REMOVED*** goog.vec.mat3d.multMat(
***REMOVED***     mat,
***REMOVED***     goog.vec.mat3d.makeRotateX(goog.vec.mat3d.create(), angle),
***REMOVED***     mat);
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix.
***REMOVED*** @param {number} angle The angle in radians.
...
***REMOVED*** goog.vec.mat3d.multMat(
***REMOVED***     mat,
***REMOVED***     goog.vec.mat3d.makeRotateY(goog.vec.mat3d.create(), angle),
***REMOVED***     mat);
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix.
***REMOVED*** @param {number} angle The angle in radians.
...
***REMOVED*** goog.vec.mat3d.multMat(
***REMOVED***     mat,
***REMOVED***     goog.vec.mat3d.makeRotateZ(goog.vec.mat3d.create(), angle),
***REMOVED***     mat);
***REMOVED***
***REMOVED*** @param {goog.vec.mat3d.Type} mat The matrix.
***REMOVED*** @param {number} angle The angle in radians.
...
***REMOVED*** @return {!goog.vec.vec3d.Type} return euler so that operations can be
***REMOVED***     chained together.
***REMOVED***
