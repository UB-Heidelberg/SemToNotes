...
***REMOVED***
***REMOVED*** @fileoverview Provides functions for operating on 2 element double (64bit)
***REMOVED*** vectors.
***REMOVED***
...
***REMOVED*** @typedef {goog.vec.Float64}***REMOVED*** goog.vec.vec2d.Type;


***REMOVED***
***REMOVED*** Creates a vec2d with all elements initialized to zero.
***REMOVED***
***REMOVED*** @return {!goog.vec.vec2d.Type} The new vec2d.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec The vector to receive the values.
***REMOVED*** @param {number} v0 The value for element at index 0.
***REMOVED*** @param {number} v1 The value for element at index 1.
***REMOVED*** @return {!goog.vec.vec2d.Type} Return vec so that operations can be
...
***REMOVED***
***REMOVED*** Initializes vec2d vec from vec2d src.
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec The destination vector.
***REMOVED*** @param {goog.vec.vec2d.Type} src The source vector.
***REMOVED*** @return {!goog.vec.vec2d.Type} Return vec so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** Initializes vec2d vec from vec2f src (typed as a Float32Array to
...
***REMOVED***
***REMOVED*** Initializes vec2d vec from Array src.
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec The destination vector.
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec0 The first addend.
***REMOVED*** @param {goog.vec.vec2d.Type} vec1 The second addend.
***REMOVED*** @param {goog.vec.vec2d.Type} resultVec The vector to
***REMOVED***     receive the result. May be vec0 or vec1.
***REMOVED*** @return {!goog.vec.vec2d.Type} Return resultVec so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED*** result into resultVec.
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec0 The minuend.
***REMOVED*** @param {goog.vec.vec2d.Type} vec1 The subtrahend.
***REMOVED*** @param {goog.vec.vec2d.Type} resultVec The vector to
***REMOVED***     receive the result. May be vec0 or vec1.
***REMOVED*** @return {!goog.vec.vec2d.Type} Return resultVec so that operations can be
***REMOVED***     chained together.
...
***REMOVED***
***REMOVED*** @param {!goog.vec.vec2d.Type} vec0 The first vector.
***REMOVED*** @param {!goog.vec.vec2d.Type} vec1 The second vector.
***REMOVED*** @param {!goog.vec.vec2d.Type} resultVec The vector to
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec0 The vector to negate.
***REMOVED*** @param {goog.vec.vec2d.Type} resultVec The vector to
***REMOVED***     receive the result. May be vec0.
***REMOVED*** @return {!goog.vec.vec2d.Type} Return resultVec so that operations can be
***REMOVED***     chained together.
...
***REMOVED*** resultVec.
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec0 The source vector.
***REMOVED*** @param {goog.vec.vec2d.Type} resultVec The vector to receive the result.
***REMOVED***     May be vec0.
***REMOVED*** @return {!goog.vec.vec2d.Type} Return resultVec so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec0 The vector.
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec0 The vector to normalize.
***REMOVED*** @param {goog.vec.vec2d.Type} resultVec The vector to
***REMOVED***     receive the result. May be vec0.
***REMOVED*** @return {!goog.vec.vec2d.Type} Return resultVec so that operations can be
***REMOVED***     chained together.
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec0 First point.
***REMOVED*** @param {goog.vec.vec2d.Type} vec1 Second point.
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec0 Origin point.
***REMOVED*** @param {goog.vec.vec2d.Type} vec1 Target point.
***REMOVED*** @param {goog.vec.vec2d.Type} resultVec The vector to receive the
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec2d.Type} vec0 The source vector.
***REMOVED*** @param {goog.vec.vec2d.Type|number} limit The limit vector or scalar.
***REMOVED*** @param {goog.vec.vec2d.Type} resultVec The vector to receive the
