...
***REMOVED***
***REMOVED*** @fileoverview Provides functions for operating on 4 element float (32bit)
***REMOVED*** vectors.
***REMOVED***
...
***REMOVED*** @typedef {goog.vec.Float32}***REMOVED*** goog.vec.vec4f.Type;


***REMOVED***
***REMOVED*** Creates a vec4f with all elements initialized to zero.
***REMOVED***
***REMOVED*** @return {!goog.vec.vec4f.Type} The new vec4f.
***REMOVED***
...
***REMOVED***
***REMOVED*** Initializes vec4f vec from vec4f src.
***REMOVED***
***REMOVED*** @param {goog.vec.vec4f.Type} vec The destination vector.
***REMOVED*** @param {goog.vec.vec4f.Type} src The source vector.
***REMOVED*** @return {!goog.vec.vec4f.Type} Return vec so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** Initializes vec4f vec from vec4d src (typed as a Float64Array to
...
***REMOVED***
***REMOVED*** Initializes vec4f vec from Array src.
***REMOVED***
***REMOVED*** @param {goog.vec.vec4f.Type} vec The destination vector.
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec4f.Type} vec0 The first addend.
***REMOVED*** @param {goog.vec.vec4f.Type} vec1 The second addend.
...
***REMOVED*** result into resultVec.
***REMOVED***
***REMOVED*** @param {goog.vec.vec4f.Type} vec0 The minuend.
***REMOVED*** @param {goog.vec.vec4f.Type} vec1 The subtrahend.
***REMOVED*** @param {goog.vec.vec4f.Type} resultVec The vector to
***REMOVED***     receive the result. May be vec0 or vec1.
***REMOVED*** @return {!goog.vec.vec4f.Type} Return resultVec so that operations can be
***REMOVED***     chained together.
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec4f.Type} vec0 The vector to negate.
***REMOVED*** @param {goog.vec.vec4f.Type} resultVec The vector to
...
***REMOVED*** resultVec.
***REMOVED***
***REMOVED*** @param {goog.vec.vec4f.Type} vec0 The source vector.
***REMOVED*** @param {goog.vec.vec4f.Type} resultVec The vector to receive the result.
***REMOVED***     May be vec0.
***REMOVED*** @return {!goog.vec.vec4f.Type} Return resultVec so that operations can be
***REMOVED***     chained together.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec4f.Type} vec0 The vector.
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec4f.Type} vec0 The vector to normalize.
***REMOVED*** @param {goog.vec.vec4f.Type} resultVec The vector to
***REMOVED***     receive the result. May be vec0.
***REMOVED*** @return {!goog.vec.vec4f.Type} Return resultVec so that operations can be
***REMOVED***     chained together.
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec4f.Type} v0 The first vector.
***REMOVED*** @param {goog.vec.vec4f.Type} v1 The second vector.
...
***REMOVED*** @param {goog.vec.vec4f.Type} resultVec The vector to receive the
...
***REMOVED***
***REMOVED*** @param {goog.vec.vec4f.Type} vec0 The source vector.
***REMOVED*** @param {goog.vec.vec4f.Type|number} limit The limit vector or scalar.
***REMOVED*** @param {goog.vec.vec4f.Type} resultVec The vector to receive the
