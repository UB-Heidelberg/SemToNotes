...
***REMOVED***
***REMOVED*** @define {boolean} Enables HTML escaping of lowercase letter "e" which helps
***REMOVED*** with detection of double-escaping as this letter is frequently used.
***REMOVED***
...
***REMOVED***
***REMOVED*** Case-insensitive equality checker.
***REMOVED*** @param {string} str1 First string to check.
***REMOVED*** @param {string} str2 Second string to check.
***REMOVED*** @return {boolean} True if {@code str1} and {@code str2} are the same string,
...
***REMOVED***
***REMOVED*** Escapes double quote '"' and single quote '\'' characters in addition to
***REMOVED*** '&', '<', and '>' so that a string can be included in an HTML tag attribute
***REMOVED*** value within double or single quotes.
***REMOVED***
...
***REMOVED***
***REMOVED*** With goog.string.DETECT_DOUBLE_ESCAPING, this function escapes also the
***REMOVED*** lowercase letter "e".
***REMOVED***
***REMOVED*** NOTE(user):
...
***REMOVED***
***REMOVED*** Regular expression that matches a single quote, for use in escaping.
***REMOVED*** @const {!RegExp}
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Regular expression that matches null character, for use in escaping.
***REMOVED*** @const {!RegExp}
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Regular expression that matches a lowercase letter "e", for use in escaping.
***REMOVED*** @const {!RegExp}
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Unescapes a HTML string using the provided document.
***REMOVED***
***REMOVED*** @param {string} str The string to unescape.
***REMOVED*** @param {!Document} document A document to use in escaping the string.
***REMOVED*** @return {string} An unescaped copy of {@code str}.
***REMOVED***
...
***REMOVED*** @private
***REMOVED*** @param {string} str The string to unescape.
***REMOVED*** @param {Document=} opt_document An optional document to use for creating
***REMOVED***     elements. If this is not specified then the default window.document
...
***REMOVED***
***REMOVED*** Preserve spaces that would be otherwise collapsed in HTML by replacing them
***REMOVED*** with non-breaking space Unicode characters.
***REMOVED*** @param {string} str The string in which to preserve whitespace.
***REMOVED*** @return {string} A copy of {@code str} with preserved whitespace.
***REMOVED***
...
***REMOVED***
***REMOVED*** Determines whether a string contains a substring.
***REMOVED*** @param {string} str The string to search.
***REMOVED*** @param {string} subString The substring to search for.
***REMOVED*** @return {boolean} Whether {@code str} contains {@code subString}.
***REMOVED***
...
***REMOVED***
***REMOVED*** Determines whether a string contains a substring, ignoring case.
***REMOVED*** @param {string} str The string to search.
***REMOVED*** @param {string} subString The substring to search for.
***REMOVED*** @return {boolean} Whether {@code str} contains {@code subString}.
***REMOVED***
...
***REMOVED***
***REMOVED*** Converts the supplied string to a number, which may be Infinity or NaN.
...
***REMOVED***
***REMOVED*** Returns whether the given string is lower camel case (e.g. "isFooBar").
***REMOVED***
***REMOVED*** Note that this assumes the string is entirely letters.
***REMOVED*** @see http://en.wikipedia.org/wiki/CamelCase#Variations_and_synonyms
***REMOVED***
***REMOVED*** @param {string} str String to test.
***REMOVED*** @return {boolean} Whether the string is lower camel case.
***REMOVED***
...
***REMOVED***
***REMOVED*** Returns whether the given string is upper camel case (e.g. "FooBarBaz").
***REMOVED***
***REMOVED*** Note that this assumes the string is entirely letters.
***REMOVED*** @see http://en.wikipedia.org/wiki/CamelCase#Variations_and_synonyms
***REMOVED***
***REMOVED*** @param {string} str String to test.
***REMOVED*** @return {boolean} Whether the string is upper camel case.
***REMOVED***
...
***REMOVED***
***REMOVED*** Splits a string on a separator a limited number of times.
***REMOVED***
***REMOVED*** This implementation is more similar to Python or Java, where the limit
***REMOVED*** parameter specifies the maximum number of splits rather than truncating
***REMOVED*** the number of results.
***REMOVED***
***REMOVED*** See http://docs.python.org/2/library/stdtypes.html#str.split
***REMOVED*** See JavaDoc: http://goo.gl/F2AsY
***REMOVED*** See Mozilla reference: http://goo.gl/dZdZs
***REMOVED***
***REMOVED*** @param {string} str String to split.
***REMOVED*** @param {string} separator The separator.
***REMOVED*** @param {number} limit The limit to the number of splits. The resulting array
***REMOVED***     will have a maximum length of limit+1.  Negative numbers are the same
***REMOVED***     as zero.
***REMOVED*** @return {!Array.<string>} The string, split.
***REMOVED***
