...
***REMOVED***
***REMOVED*** If a series of these characters is at the end of a url, it will be considered
***REMOVED*** punctuation and not part of the url.
***REMOVED*** @type {string}
***REMOVED*** @const
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Set of characters to be put into a regex character set ("[...]"), used to
***REMOVED*** match against a url hostname and everything after it. It includes
***REMOVED*** "#-@", which represents the characters "#$%&'()*+,-./0123456789:;<=>?@".
***REMOVED*** @type {string}
***REMOVED*** @const
***REMOVED*** @private
***REMOVED***
