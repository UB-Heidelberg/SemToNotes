 ...
 ***REMOVED*****REMOVED***
  ...
  ***REMOVED*** @type {!goog.events.EventHandler.<!goog.db.IndexedDb>}
  ***REMOVED*** @private
 ***REMOVED*****REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** Fired when the database connection is forcibly closed by the browser,
  ***REMOVED*** without an explicit call to IDBDatabase#close. This behavior is not in the
  ***REMOVED*** spec yet but will be added since it is necessary, see
  ***REMOVED*** https://www.w3.org/Bugs/Public/show_bug.cgi?id=22540.
 ***REMOVED*****REMOVED***
  CLOSE: 'close',
