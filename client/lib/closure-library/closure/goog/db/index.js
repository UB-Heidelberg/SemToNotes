...
***REMOVED***
***REMOVED*** <code>
***REMOVED***  var cursor = index.openCursor(goog.db.Range.bound('a', 'c'));
***REMOVED***
***REMOVED***  var key = goog.events.listen(
***REMOVED***      cursor, goog.db.Cursor.EventType.NEW_DATA,
***REMOVED***      function() {
...
***REMOVED***      cursor, goog.db.Cursor.EventType.COMPLETE,
***REMOVED***      function() {
