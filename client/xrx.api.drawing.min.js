...
xrx.drawing.LayerBackground.prototype.disposeInternal=function(){this.image_.dispose();this.image_=null;xrx.drawing.LayerBackground.superClass_.disposeInternal.call(this)};goog.Timer=function(a,b){goog.events.EventTarget.call(this);this.interval_=a||1;this.timerObject_=b||goog.Timer.defaultTimerObject;this.boundTick_=goog.bind(this.tick_,this);this.last_=goog.now()};goog.inherits(goog.Timer,goog.events.EventTarget);goog.Timer.MAX_TIMEOUT_=2147483647;goog.Timer.prototype.enabled=!1;goog.Timer.defaultTimerObject=goog.global;goog.Timer.intervalScale=.8;goog.Timer.prototype.timer_=null;goog.Timer.prototype.getInterval=function(){return this.interval_};
...
goog.Timer.callOnce=function(a,b,c){if(goog.isFunction(a))c&&(a=goog.bind(a,c));else if(a&&"function"==typeof a.handleEvent)a=goog.bind(a.handleEvent,a);else throw Error("Invalid listener argument");return b>goog.Timer.MAX_TIMEOUT_?-1:goog.Timer.defaultTimerObject.setTimeout(a,b||0)};goog.Timer.clear=function(a){goog.Timer.defaultTimerObject.clearTimeout(a)};xrx.drawing.Hoverable=function(a){xrx.EventTarget.call(this);this.drawing_=a;this.last_=[];this.multiple_=!1};goog.inherits(xrx.drawing.Hoverable,xrx.EventTarget);xrx.drawing.Hoverable.prototype.setMultiple=function(a){this.multiple_=!!a};xrx.drawing.Hoverable.prototype.pop_=function(){var a,b=this.last_.length;if(0<this.last_.length){for(var c=0;c<b;c++)(a=this.last_[c])&&a.getHoverable().hoverOff();this.dispatchExternal(xrx.drawing.EventType.SHAPE_HOVER_OUT,this.drawing_,this.last_)}};
