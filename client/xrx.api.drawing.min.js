...
xrx.drawing.Drawing.prototype.getMode=function(){return this.mode_};xrx.drawing.Drawing.prototype.setMode_=function(a){if(a!==this.mode_||a===xrx.drawing.Mode.CREATE)this.mode_=a,this.registerEvents(a)};
...
xrx.drawing.Drawing.prototype.setModeCreate=function(a){if(a){if(!(a instanceof xrx.shape.Creatable))throw Error("Instance of xrx.shape.Creatable expected.");this.creatable_=a;this.getLayerBackground().setLocked(!0);this.getLayerShape().setLocked(!0);this.getLayerShapeModify().setLocked(!0);this.getLayerShapeCreate().setLocked(!1);this.getLayerShapeModify().removeShapes();this.getLayerShapeCreate().removeShapes();this.setMode_(xrx.drawing.Mode.CREATE)}};
