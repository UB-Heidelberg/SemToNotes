...
xrx.shape.EllipseCreatable.prototype.handleDown=function(a,b){var c=b.getPointTransformed();this.point_[0]=c[0];this.point_[1]=c[1];this.preview_.setCenter(c[0],c[1]);this.preview_.setRadiusX(0);this.preview_.setRadiusY(0);this.target_.getDrawing().eventShapeCreate([this.preview_])};
...
this.close_=null,this.count_=0):(this.preview_.appendCoord(d),1===this.count_&&(this.close_=new xrx.shape.Dragger(this.target_.getModifiable(),0),this.target_.getDrawing().eventShapeCreate([this.close_])),this.close_.setCoords([d]),this.count_+=1))};
...
xrx.shape.Line.prototype.draw=function(){this.startDrawing_();this.engineElement_.draw(this.geometry_.x1,this.geometry_.y1,this.geometry_.x2,this.geometry_.y2,this.getStrokeColor(),this.getRenderingStrokeWidth());this.finishDrawing_()};xrx.shape.Line.prototype.getHoverable=function(){this.hoverable_||(this.hoverable_=new xrx.shape.LineHoverable(this));return this.hoverable_};xrx.shape.Line.prototype.getSelectable=function(){this.selectable_||(this.selectable_=new xrx.shape.LineSelectable(this));return this.selectable_};
xrx.shape.Line.prototype.getModifiable=function(a){this.modifiable_||(this.modifiable_=new xrx.shape.LineModifiable(this));return this.modifiable_};xrx.shape.Line.prototype.getCreatable=function(){this.creatable_||(this.creatable_=new xrx.shape.LineCreatable(this));return this.creatable_};xrx.shape.Line.prototype.disposeInternal=function(){xrx.shape.Line.superClass_.disposeInternal.call(this)};xrx.shape.LineHoverable=function(a){xrx.shape.Hoverable.call(this,a)};
goog.inherits(xrx.shape.LineHoverable,xrx.shape.Hoverable);xrx.shape.LineHoverable.prototype.disposeInternal=function(){xrx.shape.LineHoverable.superClass_.disposeInternal.call(this)};xrx.shape.LineSelectable=function(a){xrx.shape.Selectable.call(this,a)};goog.inherits(xrx.shape.LineSelectable,xrx.shape.Selectable);xrx.shape.LineSelectable.prototype.disposeInternal=function(){xrx.shape.LineSelectable.superClass_.disposeInternal.call(this)};
...
xrx.shape.Rect.prototype.draw=function(){this.startDrawing_();this.engineElement_.draw(this.getCoords(),this.getFillColor(),this.getFillOpacity(),this.getStrokeColor(),this.getRenderingStrokeWidth());this.finishDrawing_()};xrx.shape.Rect.prototype.getHoverable=function(){this.hoverable_||(this.hoverable_=new xrx.shape.RectHoverable(this));return this.hoverable_};xrx.shape.Rect.prototype.getSelectable=function(){this.selectable_||(this.selectable_=new xrx.shape.RectSelectable(this));return this.selectable_};
xrx.shape.Rect.prototype.getModifiable=function(a){this.modifiable_||(this.modifiable_=new xrx.shape.RectModifiable(this));return this.modifiable_};xrx.shape.Rect.prototype.getCreatable=function(){this.creatable_||(this.creatable_=new xrx.shape.RectCreatable(this));return this.creatable_};xrx.shape.Rect.prototype.disposeInternal=function(){xrx.shape.Rect.superClass_.disposeInternal.call(this)};xrx.shape.RectHoverable=function(a){xrx.shape.Hoverable.call(this,a)};
goog.inherits(xrx.shape.RectHoverable,xrx.shape.Hoverable);xrx.shape.RectHoverable.prototype.disposeInternal=function(){xrx.shape.RectHoverable.superClass_.disposeInternal.call(this)};xrx.shape.RectSelectable=function(a){xrx.shape.Selectable.call(this,a)};goog.inherits(xrx.shape.RectSelectable,xrx.shape.Selectable);xrx.shape.RectSelectable.prototype.disposeInternal=function(){xrx.shape.RectSelectable.superClass_.disposeInternal.call(this)};
...
break;default:throw Error("Unknown mode.");}};xrx.event.HandlerTarget.prototype.disposeInternal=function(){this.handler_.removeAll();this.handler_.dispose();this.handler_=null;this.cursor_.dispose();this.cursor_=null;xrx.event.HandlerTarget.superClass_.disposeInternal.call(this)};xrx.drawing.EventHandler=function(){xrx.event.HandlerTarget.call(this)};goog.inherits(xrx.drawing.EventHandler,xrx.event.HandlerTarget);xrx.drawing.EventHandler.prototype.eventShapeCreate=function(a){this.getLayerShapeCreate().addShapes(a);this.draw()};xrx.drawing.EventHandler.prototype.eventShapeCreated=function(a){this.getLayerShape().addShapes(a);this.getLayerShapeCreate().removeShapes();this.draw()};
...
xrx.viewbox.ViewboxGeometry.prototype.disposeInternal=function(){this.testPoint_=null;xrx.viewbox.ViewboxGeometry.superClass_.disposeInternal.call(this)};xrx.viewbox.ViewboxRotate=function(){xrx.viewbox.ViewboxGeometry.call(this)};goog.inherits(xrx.viewbox.ViewboxRotate,xrx.viewbox.ViewboxGeometry);xrx.viewbox.ViewboxRotate.prototype.getRotation=function(){return this.ctm_.getRotation()};xrx.viewbox.ViewboxRotate.prototype.isValidRotation=function(a){a=Math.abs(a);return 0===a||90===a||180===a||270===a};xrx.viewbox.ViewboxRotate.prototype.isVertical=function(){var a=this.ctm_.getRotation();return 0===a||180===a};
...
xrx.drawing.Modifiable.prototype.handleUp=function(a,b){b.getShape()||this.drawing_.getViewbox().handleUp(a,b);this.resetState_();this.propageted_=!1};xrx.drawing.Modifiable.prototype.resetState_=function(){this.mode_=xrx.drawing.Modifiable.Mode.SHAPEHOVER};xrx.drawing.Modifiable.prototype.disposeInternal=function(){this.drawing_.dispose();this.drawing_=null;goog.dispose(this.dragger_);goog.dispose(this.shape_);this.origin_=null;xrx.drawing.Modifiable.superClass_.disposeInternal.call(this)};xrx.drawing.Drawing=function(a,b){xrx.drawing.EventHandler.call(this);this.element_=a;this.layer_=[];this.mode_=xrx.drawing.Mode.NONE;this.modifiable_=new xrx.drawing.Modifiable(this);this.selectable_=new xrx.drawing.Selectable(this);this.hoverable_=new xrx.drawing.Hoverable(this);this.eventBeforeRendering;this.vsm_;this.install_(b)};goog.inherits(xrx.drawing.Drawing,xrx.drawing.EventHandler);xrx.drawing.Drawing.prototype.getElement=function(){return this.element_};
xrx.drawing.Drawing.prototype.getEngine=function(){return this.engine_};xrx.drawing.Drawing.prototype.getCanvas=function(){return this.canvas_};xrx.drawing.Drawing.prototype.getLayerBackground=function(){return this.layer_[0]};xrx.drawing.Drawing.prototype.getLayerShape=function(){return this.layer_[1]};xrx.drawing.Drawing.prototype.getLayerShapeModify=function(){return this.layer_[2]};xrx.drawing.Drawing.prototype.getLayerShapeCreate=function(){return this.layer_[3]};
xrx.drawing.Drawing.prototype.getLayerTool=function(){return this.layer_[4]};xrx.drawing.Drawing.prototype.getViewbox=function(){return this.viewbox_};xrx.drawing.Drawing.prototype.setSize=function(a,b){goog.style.setSize(this.element_,a+"px",b+"px");this.handleResize()};xrx.drawing.Drawing.prototype.setWidth=function(a){this.setSize(a,this.height_)};xrx.drawing.Drawing.prototype.setHeight=function(a){this.setSize(this.width_,a)};
xrx.drawing.Drawing.prototype.setStyle=function(a,b){goog.style.setStyle(this.element_,a,b);this.handleResize()};xrx.drawing.Drawing.prototype.setBackgroundImage=function(a,b){var c=this.layer_[0].getImage();if(!c||c.src!==a){var d=this,c=new goog.net.ImageLoader,e=goog.dom.createElement("img");e.id="_tmp";e.src=a;goog.events.listen(c,goog.events.EventType.LOAD,function(a){d.layer_[0].setImage(a.target);b&&b();d.draw()});c.addImage("_tmp",e);c.start()}};
xrx.drawing.Drawing.prototype.addShapes=function(a){this.layer_[1].addShapes(goog.array.toArray(arguments));this.draw()};xrx.drawing.Drawing.prototype.getShapes=function(){return this.layer_[1].getShapes()||[]};xrx.drawing.Drawing.prototype.removeShape=function(a){this.layer_[1].removeShape(a);this.draw()};xrx.drawing.Drawing.prototype.getSelectedShape=function(){return this.selectable_.getShape()};
...
xrx.drawing.Drawing.prototype.setModeCreate=function(a){a&&(this.creatable_=a,this.getLayerBackground().setLocked(!0),this.getLayerShape().setLocked(!0),this.getLayerShapeModify().setLocked(!0),this.getLayerShapeCreate().setLocked(!1),this.getLayerShapeModify().removeShapes(),this.getLayerShapeCreate().removeShapes(),this.setMode_(xrx.drawing.Mode.CREATE))};
...
this.eventBeforeRendering=this.viewbox_=null;this.vsm_.removeAllListeners();this.vsm_.dispose();this.vsm_=null;xrx.drawing.Drawing.superClass_.disposeInternal.call(this)};xrx.api={};xrx.api.drawing=function(){};
