...
goog.require('xrx.shape.EllipseModifiable');
goog.require('xrx.shape.EllipseSelectable');
goog.require('xrx.shape.Group');
goog.require('xrx.shape.Image');
goog.require('xrx.shape.Line');
goog.require('xrx.shape.LineCreatable');
goog.require('xrx.shape.LineHoverable');
goog.require('xrx.shape.LineModifiable');
goog.require('xrx.shape.LineSelectable');
goog.require('xrx.shape.Polygon');
goog.require('xrx.shape.PolygonCreatable');
goog.require('xrx.shape.PolygonHoverable');
goog.require('xrx.shape.PolygonModifiable');
goog.require('xrx.shape.PolygonSelectable');
goog.require('xrx.shape.Polyline');
goog.require('xrx.shape.PolylineCreatable');
goog.require('xrx.shape.PolylineHoverable');
goog.require('xrx.shape.PolylineModifiable');
