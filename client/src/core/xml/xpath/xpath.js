...
***REMOVED*** 
***REMOVED*** Copyright (c) 2007 Cybozu Labs, Inc.
***REMOVED*** Copyright (c) 2012 Google Inc.
***REMOVED*** 
...
xrx.xpath.XPathFunctions = {***REMOVED***


***REMOVED***
***REMOVED*** XPath namespace resolver.
***REMOVED***
***REMOVED*** @enum {string}
***REMOVED***
...
***REMOVED***
***REMOVED*** Adds a new prefix and URI to the static XPath context.
***REMOVED*** 
***REMOVED*** @param {!string} prefix The namespace prefix.
***REMOVED*** @param {!string} uri The namespace uri.
***REMOVED***
...
***REMOVED***
***REMOVED*** Adds a custom function to the static XPath context.
***REMOVED*** 
***REMOVED*** @param {!xrx.xpath.Function} The function.
***REMOVED***
...
***REMOVED***
***REMOVED*** Enum for XPathResult types.
***REMOVED***
***REMOVED*** @private
***REMOVED*** @enum {number}
***REMOVED***
...
***REMOVED***
***REMOVED*** The exported XPathExpression type.
***REMOVED***
***REMOVED***
***REMOVED*** @extends {XPathExpression}
***REMOVED*** @param {string} expr The expression string.
***REMOVED*** @param {?(XPathNSResolver|function(string): ?string)} nsResolver
***REMOVED***     XPath namespace resolver.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** The exported XPathResult type.
***REMOVED***
***REMOVED***
***REMOVED*** @extends {XPathResult}
***REMOVED*** @param {(!xrx.xpath.NodeSet|number|string|boolean)} value The result value.
***REMOVED*** @param {number} type The result type.
***REMOVED*** @private
***REMOVED***
