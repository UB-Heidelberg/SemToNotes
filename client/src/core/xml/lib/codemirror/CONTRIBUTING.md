...
**Note:** The issue tracker is for***REMOVED***bugs*, not requests for help. Questions
...
- Include information about***REMOVED****the browser in which the problem occurred**. Even
