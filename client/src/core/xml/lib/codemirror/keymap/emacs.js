(function() {
  ...
  function kill(cm, from, to, mayGrow, text) {
    ...
    if (mayGrow) lastKill = {cm: cm, pos: from, gen: cm.changeGeneration()***REMOVED***
    else lastKill = null;
  }
  ...
  var prefixPreservingKeys = {"Alt-G": true, "Ctrl-X": true, "Ctrl-Q": true, "Ctrl-U": true***REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ...
  var prefixMap = {"Ctrl-G": clearPrefix***REMOVED***
  function regPrefix(d) {
    prefixMap[d] = function(cm) { addPrefix(cm, d);***REMOVED*****REMOVED***
    keyMap["Ctrl-" + d] = function(cm) { addPrefix(cm, d);***REMOVED*****REMOVED***
