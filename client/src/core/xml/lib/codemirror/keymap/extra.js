...
(function() {
  ...
  CodeMirror.commands.moveLinesUp = function(cm) { moveSelectedLines(cm, -1);***REMOVED*****REMOVED***
  CodeMirror.commands.moveLinesDown = function(cm) { moveSelectedLines(cm, 1);***REMOVED*****REMOVED***
