(function() {
  ...
  function sim(name, start /*, actions...***REMOVED***) {
  ...
  function at(line, ch) { return function(cm) { eqPos(cm.getCursor(), Pos(line, ch));***REMOVED*****REMOVED*** }
  function txt(str) { return function(cm) { eq(cm.getValue(), str);***REMOVED*****REMOVED*** }
  ...
  testCM("save", function(cm) {
    var saved = false;
    CodeMirror.commands.save = function(cm) { saved = cm.getValue();***REMOVED*****REMOVED***
