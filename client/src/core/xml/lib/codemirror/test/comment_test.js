...
(function() {
  ...
  test("block", "javascript", function(cm) {
    cm.blockComment(Pos(0, 3), Pos(3, 0), {blockCommentLead: "***REMOVED***"});
  }, simpleProg + "\n", "/* function foo() {\n***REMOVED***   return bar;\n***REMOVED*** }\n***REMOVED***");

  test("blockToggle", "javascript", function(cm) {
    cm.blockComment(Pos(0, 3), Pos(2, 0), {blockCommentLead: "***REMOVED***"});
    cm.uncomment(Pos(0, 3), Pos(2, 0), {blockCommentLead: "***REMOVED***"});
