 ...
 ***REMOVED*****REMOVED***
  ...
  var getLineInfo = exports.getLineInfo = function(input, offset) {
    ...
    return {line: line, column: offset - cur***REMOVED***
 ***REMOVED*****REMOVED***
  ...
  var _num = {type: "num"}, _regexp = {type: "regexp"}, _string = {type: "string"***REMOVED***
  var _name = {type: "name"}, _eof = {type: "eof"***REMOVED***
  ...
  var _break = {keyword: "break"}, _case = {keyword: "case", beforeExpr: true}, _catch = {keyword: "catch"***REMOVED***
  var _continue = {keyword: "continue"}, _debugger = {keyword: "debugger"}, _default = {keyword: "default"***REMOVED***
  var _do = {keyword: "do", isLoop: true}, _else = {keyword: "else", beforeExpr: true***REMOVED***
  var _finally = {keyword: "finally"}, _for = {keyword: "for", isLoop: true}, _function = {keyword: "function"***REMOVED***
  var _if = {keyword: "if"}, _return = {keyword: "return", beforeExpr: true}, _switch = {keyword: "switch"***REMOVED***
  var _throw = {keyword: "throw", beforeExpr: true}, _try = {keyword: "try"}, _var = {keyword: "var"***REMOVED***
  var _while = {keyword: "while", isLoop: true}, _with = {keyword: "with"}, _new = {keyword: "new", beforeExpr: true***REMOVED***
  var _this = {keyword: "this"***REMOVED***

  // The keywords that denote values.

  var _null = {keyword: "null", atomValue: null}, _true = {keyword: "true", atomValue: true***REMOVED***
  var _false = {keyword: "false", atomValue: false***REMOVED***

  // Some keywords are treated as regular operators. `in` sometimes
  // (when parsing `for`) needs to be tested against specifically, so
  // we assign a variable name to it for quick comparing.

  var _in = {keyword: "in", binop: 7, beforeExpr: true***REMOVED***
  ...
  var keywordTypes = {"break": _break, "case": _case, "catch": _catch,
                      ...
                      "delete": {keyword: "delete", prefix: true}***REMOVED***

  // Punctuation token types. Again, the `type` property is purely for debugging.

  var _bracketL = {type: "[", beforeExpr: true}, _bracketR = {type: "]"}, _braceL = {type: "{", beforeExpr: true***REMOVED***
  var _braceR = {type: "}"}, _parenL = {type: "(", beforeExpr: true}, _parenR = {type: ")"***REMOVED***
  var _comma = {type: ",", beforeExpr: true}, _semi = {type: ";", beforeExpr: true***REMOVED***
  var _colon = {type: ":", beforeExpr: true}, _dot = {type: "."}, _question = {type: "?", beforeExpr: true***REMOVED***
  ...
  var _slash = {binop: 10, beforeExpr: true}, _eq = {isAssign: true, beforeExpr: true***REMOVED***
  var _assign = {isAssign: true, beforeExpr: true}, _plusmin = {binop: 9, prefix: true, beforeExpr: true***REMOVED***
  var _incdec = {postfix: true, prefix: true, isUpdate: true}, _prefix = {prefix: true, beforeExpr: true***REMOVED***
  var _bin1 = {binop: 1, beforeExpr: true}, _bin2 = {binop: 2, beforeExpr: true***REMOVED***
  var _bin3 = {binop: 3, beforeExpr: true}, _bin4 = {binop: 4, beforeExpr: true***REMOVED***
  var _bin5 = {binop: 5, beforeExpr: true}, _bin6 = {binop: 6, beforeExpr: true***REMOVED***
  var _bin7 = {binop: 7, beforeExpr: true}, _bin8 = {binop: 8, beforeExpr: true***REMOVED***
  var _bin10 = {binop: 10, beforeExpr: true***REMOVED***
  ...
  function curLineLoc() {
    ...
    return {line: tokCurLine, column: tokPos - tokLineStart***REMOVED***
  }
  ...
  function readToken(forceRegexp) {
    ...
    if (isIdentifierStart(code) || code === 92 /* '\'***REMOVED***) return readWord();
    var next = input.charCodeAt(tokPos+1);
  ...
  ***REMOVED****REMOVED****REMOVED***that* in the unary operator node.
  //
  ...
  function startNode() {
    var node = {type: null, start: tokStart, end: null***REMOVED***
    if (options.trackComments && tokCommentsBefore) {
      node.commentsBefore = tokCommentsBefore;
      tokCommentsBefore = null;
    }
    if (options.locations)
      node.loc = {start: tokStartLoc, end: null, source: sourceFile***REMOVED***
    if (options.ranges)
  ...
  function startNodeFrom(other) {
    var node = {type: null, start: other.start***REMOVED***
    if (other.commentsBefore) {
      node.commentsBefore = other.commentsBefore;
      other.commentsBefore = null;
    }
    if (options.locations)
      node.loc = {start: other.loc.start, end: null, source: other.loc.source***REMOVED***
    if (options.ranges)
 ...
 ***REMOVED*****REMOVED***
  ...
  var loopLabel = {kind: "loop"}, switchLabel = {kind: "switch"***REMOVED***
  ...
  // and,***REMOVED***if* the syntactic construct they handle is present, wrap
