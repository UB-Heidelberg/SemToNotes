CodeMirror.defineMode('rst-base', function (config) {
   ...
   ***REMOVED*****REMOVED***
    ...
    function context(phase, stage, mode, local) {
        return {phase: phase, stage: stage, mode: mode, local: local***REMOVED***
    }

    function change(state, tok, ctx) {
        state.tok = tok;
        state.ctx = ctx || {***REMOVED***
    }
    ...
    return {
        startState: function () {
            return {tok: to_normal, ctx: context(undefined, 0)***REMOVED***
        },

        copyState: function (state) {
            return {tok: state.tok, ctx: state.ctx***REMOVED***
        },
