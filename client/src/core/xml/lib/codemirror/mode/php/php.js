 ...
 ***REMOVED*****REMOVED***
  ...
  CodeMirror.defineMode("php", function(config, parserConfig) {
    ...
    function dispatch(stream, state) {
      ...
      if (!isPHP) {
        ...
        if (openPHP != -1) {
          ...
          else state.pending = {end: stream.pos, style: style***REMOVED***
    ...
    return {
      ...
      innerMode: function(state) { return {state: state.curState, mode: state.curMode***REMOVED*** }
   ***REMOVED*****REMOVED***
  }, "htmlmixed", "clike");
