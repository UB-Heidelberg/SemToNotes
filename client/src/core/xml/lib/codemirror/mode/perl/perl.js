...
CodeMirror.defineMode("perl",function(){
        ...
        var PERL={                                      //   null - magic touch
                ...
                y                               :null***REMOVED*** // - transliterate a string
...
CodeMirror.StringStream.prototype.look=function(c){
        return this.string.charAt(this.pos+(c||0));***REMOVED***
...
CodeMirror.StringStream.prototype.prefix=function(c){
        if(c){
                ...
                return this.string.substr(0,this.pos-1);}***REMOVED***

// return a part of suffix of current stream from current position
CodeMirror.StringStream.prototype.suffix=function(c){
        var y=this.string.length;
        var x=y-this.pos+1;
        return this.string.substr(this.pos,(c&&c<y?c:x));***REMOVED***
...
CodeMirror.StringStream.prototype.nsuffix=function(c){
        ...
        this.pos+=l;
        return this.string.substr(p,l);***REMOVED***
