CodeMirror.defineMode("sql", function(config, parserConfig) {
  ...
  var client         = parserConfig.client || {},
      ...
      dateSQL        = parserConfig.dateSQL || {"date" : true, "time" : true, "timestamp" : true***REMOVED***
  ...
  return {
    startState: function() {
      return {tokenize: tokenBase, context: null***REMOVED***
    },
...
/*
   ...
   ***REMOVED*** ODBCdotTable: .tableName
   ***REMOVED*** zerolessFloat: .1
   ***REMOVED*** doubleQuote
   ***REMOVED*** nCharCast: N'string'
   ***REMOVED*** charsetCast: _utf8'string'
   ***REMOVED*** commentHash: use # char for comments
   ***REMOVED*** commentSlashSlash: use // for comments
   ***REMOVED*** commentSpaceRequired: require a space after -- for comments
  atoms:
