(function() {
  ...
  function LintState(cm, options, hasGutter) {
    ...
    this.onMouseOver = function(e) { onMouseOver(cm, e);***REMOVED*****REMOVED***
  }

  function parseOptions(cm, options) {
    if (options instanceof Function) return {getAnnotations: options***REMOVED***
    if (!options || options === true) options = {***REMOVED***
