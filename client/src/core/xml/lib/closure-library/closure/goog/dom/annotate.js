...
***REMOVED*** @param {Function} annotateFn  A function that takes
***REMOVED***   (1) the number of the term that is "hit",
***REMOVED***   (2) the HTML string (search term) to be annotated,
***REMOVED***   and returns the annotated term as an HTML string.
...
***REMOVED***     may be CJK, while others are not. (For correctness, matchWholeWordOnly
***REMOVED***     should always be false for CJK terms.).
***REMOVED*** @param {Function} annotateFn  function(number, string) : string  A function
***REMOVED***     that takes :
***REMOVED***     (1) the number of the term that is "hit",
***REMOVED***     (2) the HTML string (search term) to be annotated,
***REMOVED***     and returns the annotated term as an HTML string.
...
***REMOVED*** @param {*=} opt_ignoreCase  Whether to ignore the case of the query
***REMOVED***   terms when looking for matches.
***REMOVED*** @return {?string} The HTML equivalent of {@code text} with terms
