...
***REMOVED***
***REMOVED*** Maps ranges to values using goog.structs.Inversion.
...
***REMOVED*** @param {Array.<*>} valueArray An array of corresponding values.
...
***REMOVED*** @return {*} Value retrieved from inversion map; null if not found.
***REMOVED***
