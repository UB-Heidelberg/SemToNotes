 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** Classname for the main element
  ***REMOVED*** @type {string}
 ***REMOVED*****REMOVED***
  this.className = goog.getCssName('ac-renderer');

 ***REMOVED*****REMOVED***
  ***REMOVED*** Classname for row divs
  ***REMOVED*** @type {string}
 ***REMOVED*****REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** Class name for active row div.
  ***REMOVED*** Active row will have rowClassName & activeClassName &
  ***REMOVED*** legacyActiveClassName.
  ***REMOVED*** @type {string}
 ***REMOVED*****REMOVED***
...
***REMOVED***
***REMOVED*** @param {Element} elt The container element.
***REMOVED*** @private
***REMOVED***
...
***REMOVED*** param {goog.ui.ac.Renderer} renderer The autocomplete renderer.
***REMOVED*** param {Element} element The main element that controls the rendered
***REMOVED***     autocomplete.
***REMOVED*** param {Array} rows The current set of rows being displayed.
***REMOVED*** param {string} token The current token that has been entered.
***REMOVED***
