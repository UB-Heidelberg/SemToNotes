...
***REMOVED*** max size.
***REMOVED*** @param {*} item The item to add.
***REMOVED***
...
***REMOVED*** @return {*} The item at the specified index.
***REMOVED***
...
***REMOVED***
***REMOVED*** @return {Array} The values in the buffer.
***REMOVED***
...
***REMOVED*** @return {Array} The newest values in the buffer up to {@code count}.
***REMOVED***
...
***REMOVED***
***REMOVED*** @return {Array} The indexes in the buffer.
***REMOVED***
...
***REMOVED*** @return {*} The last item inserted into the buffer, or null if the buffer is
***REMOVED***     empty.
***REMOVED***
