...
***REMOVED*** @return {!(XMLHttpRequest|GearsHttpRequest)} A new XMLHttpRequest object.
***REMOVED***
...
***REMOVED***     true strips the ActiveX probing code.
***REMOVED***
...
goog.net.XmlHttp.setFactory = function(factory, optionsFactory) {
  goog.net.XmlHttp.setGlobalFactory(new goog.net.WrapperXmlHttpFactory(
     ***REMOVED*****REMOVED*** @type {function() : !(XMLHttpRequest|GearsHttpRequest)}***REMOVED*** (factory),
     ***REMOVED*****REMOVED*** @type {function() : !Object}*/ (optionsFactory)));
***REMOVED***
