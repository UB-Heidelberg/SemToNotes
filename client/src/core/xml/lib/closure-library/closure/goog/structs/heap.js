...
***REMOVED*** @return {*} The value removed from the root of the heap.  Returns
...
***REMOVED*** @return {*} The value at the root of the heap. Returns
***REMOVED***     undefined if the heap is empty.
***REMOVED***
...
***REMOVED*** @return {*} The key at the root of the heap. Returns undefined if the
...
***REMOVED*** @return {Array} The values in the heap.
***REMOVED***
...
***REMOVED*** @return {Array} The keys in the heap.
***REMOVED***
...
***REMOVED*** @param {Object} val The value to check for.
...
***REMOVED*** @param {Object} key The key to check for.
