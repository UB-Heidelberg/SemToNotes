...
***REMOVED***
***REMOVED*** Handles mouseout events.  Overrides {@link goog.ui.Control#handleMouseOut}
***REMOVED*** by determining the palette item that the mouse just left (if any), and
***REMOVED*** making sure it is un-highlighted.
***REMOVED*** @param {goog.events.BrowserEvent} e Mouse event to handle.
***REMOVED*** @override
***REMOVED***
