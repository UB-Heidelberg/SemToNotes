...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#isFile}
...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#isDirectory}
***REMOVED*** @return {boolean}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#getName}
...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#getFullPath}
***REMOVED*** @return {string}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#getFileSystem}
...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#getLastModified}
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
goog.testing.fs.Entry.prototype.getLastModified = goog.abstractMethod;


***REMOVED***
***REMOVED*** @see {goog.fs.Entry#getMetadata}
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#moveTo}
***REMOVED*** @param {!goog.testing.fs.DirectoryEntry} parent
***REMOVED*** @param {string=} opt_newName
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#copyTo}
***REMOVED*** @param {!goog.testing.fs.DirectoryEntry} parent
***REMOVED*** @param {string=} opt_newName
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#toUrl}
***REMOVED*** @return {string}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#remove}
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.Entry#getParent}
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.DirectoryEntry#getFile}
***REMOVED*** @param {string} path
***REMOVED*** @param {goog.fs.DirectoryEntry.Behavior=} opt_behavior
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.DirectoryEntry#getDirectory}
***REMOVED*** @param {string} path
***REMOVED*** @param {goog.fs.DirectoryEntry.Behavior=} opt_behavior
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.DirectoryEntry.removeRecursively}
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.DirectoryEntry#listDirectory}
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.DirectoryEntry#createPath}
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
goog.testing.fs.DirectoryEntry.prototype.createPath =
    // This isn't really type-safe.
   ***REMOVED*****REMOVED*** @type {!Function}***REMOVED*** (goog.fs.DirectoryEntry.prototype.createPath);
...
***REMOVED***
***REMOVED*** @see {goog.fs.FileEntry#createWriter}
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
...
***REMOVED***
***REMOVED*** @see {goog.fs.FileEntry#file}
***REMOVED*** @return {!goog.async.Deferred}
***REMOVED***
