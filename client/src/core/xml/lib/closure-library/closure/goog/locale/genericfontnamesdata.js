...
***REMOVED***
***REMOVED*** @fileoverview List of generic font names and font fallbacks.
***REMOVED*** This file lists the font fallback for each font family for each locale or
***REMOVED*** script. In this map, each value is an array of pair. The pair is stored
***REMOVED*** as an array of two elements.
***REMOVED***
***REMOVED*** First element of the pair is the generic name
***REMOVED*** for the font family in that locale. In case of script indexed entries,
***REMOVED*** It will be just font family name. Second element in the pair is a string
***REMOVED*** comma seperated list of font names. API to access this data is provided
***REMOVED*** thru goog.locale.genericFontNames.
***REMOVED***
***REMOVED*** Warning: this file is automatically generated from CLDR.
***REMOVED*** Please contact i18n team or change the script and regenerate data.
***REMOVED*** Code location: http://go/generate_genericfontnames
***REMOVED***
***REMOVED***


***REMOVED***
***REMOVED*** Namespace for Generic Font Names
***REMOVED***
...
***REMOVED***
***REMOVED*** Map from script code or language code to list of pairs of (generic name,
***REMOVED*** font name fallback list).
***REMOVED*** @type {Object}
***REMOVED***

/* ~!@# genmethods.genericFontNamesData() #@!~***REMOVED***
