...
***REMOVED***
***REMOVED*** This is the central manager class for an AutoComplete instance.
***REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** Autcomplete suggestion items.
  ***REMOVED*** @type {Array}
  ***REMOVED*** @protected
  ***REMOVED*** @suppress {underscore}
 ***REMOVED*****REMOVED***
...
***REMOVED***
***REMOVED*** Returns the renderer that renders/shows/highlights/hides the autocomplete
***REMOVED*** menu.
***REMOVED*** @return {goog.events.EventTarget} Renderer used by the this widget.
***REMOVED***
...
***REMOVED***
***REMOVED*** Moves the hilite to the next row, or does nothing if we're already at the
***REMOVED*** end of the current set of matches.  Calls renderer.hiliteId() when there's
***REMOVED*** something to do.
...
***REMOVED***
***REMOVED*** Moves the hilite to the previous row, or does nothing if we're already at
***REMOVED*** the beginning of the current set of matches.  Calls renderer.hiliteId()
***REMOVED*** when there's something to do.
***REMOVED*** @return {boolean} Returns true on a successful hilite.
***REMOVED***
...
***REMOVED***
***REMOVED*** Hilites the id if it's valid, otherwise does nothing.
***REMOVED*** @param {number} id A row id (not index).
***REMOVED*** @return {boolean} Whether the id was hilited.
***REMOVED***
...
***REMOVED***
***REMOVED*** Hilites the index, if it's valid, otherwise does nothing.
