...
***REMOVED***
***REMOVED*** @fileoverview This file contains functions for using Gears.
***REMOVED***
...
***REMOVED***
***REMOVED*** Returns a new Gears factory object.
***REMOVED*** @return {Object} the Gears factory object if available or null otherwise.
***REMOVED***
 ...
 ***REMOVED*****REMOVED*** @preserveTry***REMOVED***
  try {
    var gearsFactory =***REMOVED*****REMOVED*** @type {Function}***REMOVED***
...
***REMOVED***
***REMOVED*** Attempt to create a factory by adding an object element to the DOM.
***REMOVED*** This covers the case for safari.
***REMOVED*** @return {Function} The factory, or null.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Cached result of getFactory
...
***REMOVED***
***REMOVED*** Whether we can create a Gears factory object. This does not cache the
***REMOVED*** result.
***REMOVED*** @return {boolean} true if we can create a Gears factory object.
***REMOVED***
...
***REMOVED***
***REMOVED*** Cached result of hasFactory.
...
***REMOVED***
***REMOVED*** Maximum file name length.
***REMOVED*** @type {number}
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Allow 10 characters for hash (#goog.string.hashCode).
***REMOVED*** @type {number}
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
 ***REMOVED*** Gears only allows file names up to 64 characters, so this function shortens
 ***REMOVED*** file names to fit in this limit. #goog.string.hashCode is used to compress
 ***REMOVED*** the name. This also removes invalid characters.
 ***REMOVED*** @param {string} originalFileName Original (potentially unsafe) file name.
 ***REMOVED*** @return {string} Safe file name. If originalFileName null or empty,
 ***REMOVED***     return originalFileName.
 ***REMOVED*** @throws {Error} If originalFileName is null, empty or contains only
