...
***REMOVED*** @param {Array|Object=} opt_values Initial values to start with.
***REMOVED***
...
***REMOVED*** @param {*} element The primitive or object to add.
***REMOVED*** @override
***REMOVED***
...
***REMOVED*** @param {Array|Object} col A collection containing the elements to add.
***REMOVED***
...
***REMOVED*** @param {Array|Object} col A collection containing the elements to remove.
***REMOVED***
...
***REMOVED*** @param {*} element The primitive or object to remove.
...
***REMOVED*** @param {*} element The primitive or object to test for.
...
***REMOVED*** @param {Object} col A collection-like object.
...
***REMOVED*** @param {Array|Object} col A collection.
***REMOVED*** @return {!goog.structs.Set} A new set containing all the values (primitives
***REMOVED***     or objects) present in both this set and the given collection.
***REMOVED***
...
***REMOVED*** @return {!Array} An array containing all the elements in this set.
***REMOVED***
...
***REMOVED*** @return {!goog.structs.Set} A new set containing all the same elements as
***REMOVED***     this set.
***REMOVED***
...
***REMOVED*** @param {Object} col A collection.
