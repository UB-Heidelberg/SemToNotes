...
***REMOVED***
***REMOVED*** @fileoverview Provides data persistence using HTML5 local storage
***REMOVED*** mechanism. Local storage must be available under window.localStorage,
***REMOVED*** see: http://www.w3.org/TR/webstorage/#the-localstorage-attribute.
***REMOVED***
***REMOVED***
...
***REMOVED***
***REMOVED*** Provides a storage mechanism that uses HTML5 local storage.
***REMOVED***
***REMOVED***
