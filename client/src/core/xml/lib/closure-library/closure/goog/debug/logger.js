...
***REMOVED*** This level is initialized to <CODE>Number.MAX_VALUE</CODE>.
***REMOVED*** @type {!goog.debug.Logger.Level}
***REMOVED***
...
***REMOVED*** This level is initialized to <CODE>Number.MIN_VALUE</CODE>.
***REMOVED*** @type {!goog.debug.Logger.Level}
***REMOVED***
...
***REMOVED***
***REMOVED*** Find or create a logger for a named subsystem. If a logger has already been
...
***REMOVED*** {@see http://code.google.com/webtoolkit/speedtracer/logging-api.html}
...
***REMOVED***
***REMOVED*** Check if a message of the given level would actually be logged by this
...
***REMOVED***
***REMOVED*** Log a message. If the logger is currently enabled for the
...
***REMOVED***
***REMOVED*** Log a message at the Logger.Level.SHOUT level.
...
***REMOVED***
***REMOVED*** Log a message at the Logger.Level.SEVERE level.
***REMOVED*** If the logger is currently enabled for the given message level then the
***REMOVED*** given message is forwarded to all the registered output Handler objects.
***REMOVED*** @param {string} msg The string message.
***REMOVED*** @param {Error=} opt_exception An exception associated with the message.
...
***REMOVED***
***REMOVED*** Log a message at the Logger.Level.WARNING level.
***REMOVED*** If the logger is currently enabled for the given message level then the
***REMOVED*** given message is forwarded to all the registered output Handler objects.
***REMOVED*** @param {string} msg The string message.
***REMOVED*** @param {Error=} opt_exception An exception associated with the message.
...
***REMOVED***
***REMOVED*** Log a message at the Logger.Level.INFO level.
***REMOVED*** If the logger is currently enabled for the given message level then the
***REMOVED*** given message is forwarded to all the registered output Handler objects.
***REMOVED*** @param {string} msg The string message.
***REMOVED*** @param {Error=} opt_exception An exception associated with the message.
...
***REMOVED***
***REMOVED*** Log a message at the Logger.Level.CONFIG level.
***REMOVED*** If the logger is currently enabled for the given message level then the
***REMOVED*** given message is forwarded to all the registered output Handler objects.
***REMOVED*** @param {string} msg The string message.
***REMOVED*** @param {Error=} opt_exception An exception associated with the message.
...
***REMOVED***
***REMOVED*** Log a message at the Logger.Level.FINE level.
***REMOVED*** If the logger is currently enabled for the given message level then the
***REMOVED*** given message is forwarded to all the registered output Handler objects.
***REMOVED*** @param {string} msg The string message.
***REMOVED*** @param {Error=} opt_exception An exception associated with the message.
...
***REMOVED***
***REMOVED*** Log a message at the Logger.Level.FINER level.
***REMOVED*** If the logger is currently enabled for the given message level then the
***REMOVED*** given message is forwarded to all the registered output Handler objects.
***REMOVED*** @param {string} msg The string message.
***REMOVED*** @param {Error=} opt_exception An exception associated with the message.
...
***REMOVED***
***REMOVED*** Log a message at the Logger.Level.FINEST level.
***REMOVED*** If the logger is currently enabled for the given message level then the
***REMOVED*** given message is forwarded to all the registered output Handler objects.
***REMOVED*** @param {string} msg The string message.
***REMOVED*** @param {Error=} opt_exception An exception associated with the message.
...
***REMOVED***
***REMOVED*** Log a LogRecord. If the logger is currently enabled for the
***REMOVED*** given message level then the given message is forwarded to all the
***REMOVED*** registered output Handler objects.
...
***REMOVED***
***REMOVED*** Initialize the LogManager if not already initialized
***REMOVED***
...
***REMOVED*** @return {!Object} Map of logger names to logger objects.
***REMOVED***
...
***REMOVED***
***REMOVED*** Method to find a named logger.
***REMOVED***
***REMOVED*** @param {string} name A name for the logger. This should be a dot-separated
***REMOVED*** name and should normally be based on the package name or class name of the
***REMOVED*** subsystem, such as goog.net.BrowserChannel.
