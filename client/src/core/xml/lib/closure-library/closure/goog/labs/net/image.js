...
***REMOVED***
***REMOVED*** Loads a single image.  Useful for preloading images. May be combined with
***REMOVED*** goog.result.combine to preload many images.
***REMOVED***
...
***REMOVED*** @return {!goog.result.Result} An asyncronous result that will succeed
***REMOVED***     if the image successfully loads or error if the image load fails.
***REMOVED***
