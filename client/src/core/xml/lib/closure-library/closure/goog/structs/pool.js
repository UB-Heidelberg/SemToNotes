 ...
 ***REMOVED*****REMOVED***
  ...
  ***REMOVED*** to be used.
  ***REMOVED*** @type {goog.structs.Queue}
  ***REMOVED*** @private
 ***REMOVED*****REMOVED***
...
***REMOVED*** @param {number} max The maximium count of the pool.
***REMOVED***
...
***REMOVED***
***REMOVED*** @return {Object|undefined} A new object from the pool if there is one
***REMOVED***     available, otherwise undefined.
***REMOVED***
...
***REMOVED*** @param {Object} obj The object to return to the pool of free objects.
...
***REMOVED***
***REMOVED*** @return {Object|undefined} The object removed from the free collection, if
***REMOVED***     there is one available. Otherwise, undefined.
***REMOVED*** @private
***REMOVED***
goog.structs.Pool.prototype.removeFreeObject_ = function() {
  var obj;
  while (this.getFreeCount() > 0) {
    obj =***REMOVED*****REMOVED*** @type {Object}***REMOVED***(this.freeQueue_.dequeue());
...
***REMOVED***
***REMOVED*** @param {Object} obj The object to add to collection of free objects.
***REMOVED***
...
goog.structs.Pool.prototype.adjustForMinMax = function() {
  ...
  while (this.getCount() > this.maxCount_ && this.getFreeCount() > 0) {
    this.disposeObject(***REMOVED*** @type {Object}***REMOVED***(freeQueue.dequeue()));
  }
***REMOVED***


***REMOVED***
***REMOVED*** Should be overriden by sub-classes to return an instance of the object type
***REMOVED*** that is expected in the pool.
***REMOVED*** @return {Object} The created object.
***REMOVED***
...
***REMOVED***
***REMOVED*** Should be overriden to dispose of an object. Default implementation is to
***REMOVED*** remove all its members, which should render it useless. Calls the object's
***REMOVED*** {@code dispose()} method, if available.
***REMOVED*** @param {Object} obj The object to dispose.
***REMOVED***
...
***REMOVED***
***REMOVED*** Should be overriden to determine whether an object has become unusable and
...
***REMOVED*** @param {Object} obj The object to check the pool for.
