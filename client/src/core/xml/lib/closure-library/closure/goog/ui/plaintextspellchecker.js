...
***REMOVED***
***REMOVED*** @fileoverview Plain text spell checker implementation.
***REMOVED***
***REMOVED*** @author eae@google.com (Emil A Eklund)
***REMOVED*** @author sergeys@google.com (Sergey Solyanik)
***REMOVED*** @see ../demos/plaintextspellchecker.html
***REMOVED***
...
***REMOVED***
***REMOVED*** Plain text spell checker implementation.
***REMOVED***
***REMOVED*** @param {goog.spell.SpellCheck} handler Instance of the SpellCheckHandler
***REMOVED***     support object to use. A single instance can be shared by multiple
***REMOVED***     editor components.
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** Correction UI container.
  ***REMOVED*** @type {HTMLDivElement}
  ***REMOVED*** @private
 ***REMOVED*****REMOVED***
  this.overlay_ =***REMOVED*****REMOVED*** @type {HTMLDivElement}***REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** Regular expression for matching line breaks.
  ***REMOVED*** @type {RegExp}
  ***REMOVED*** @private
 ***REMOVED*****REMOVED***
...
***REMOVED***
***REMOVED*** Class name for invalid words.
***REMOVED*** @type {string}
***REMOVED***
...
***REMOVED***
***REMOVED*** Class name for corrected words.
***REMOVED*** @type {string}
***REMOVED***
...
***REMOVED***
***REMOVED*** Class name for correction pane.
***REMOVED*** @type {string}
***REMOVED***
...
***REMOVED***
***REMOVED*** Size of window. Used to check if a resize operation actually changed the size
***REMOVED*** of the window.
...
***REMOVED***
***REMOVED*** Numeric Id of the element that has focus. 0 when not set.
***REMOVED***
***REMOVED*** @type {number}
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Event handler for listening to events without leaking.
...
***REMOVED*** @type {goog.events.KeyHandler|undefined}
***REMOVED*** @private
***REMOVED***
...
goog.ui.PlainTextSpellChecker.prototype.initSuggestionsMenu = function() {
  ...
  this.eventHandler_.listen(***REMOVED*** @type {goog.ui.PopupMenu}***REMOVED*** (this.getMenu()),
...
***REMOVED***
***REMOVED*** Final stage of spell checking - displays the correction UI.
***REMOVED*** @private
***REMOVED***
goog.ui.PlainTextSpellChecker.prototype.finishCheck_ = function() {
  ...
  eh.listen(***REMOVED*** @type {goog.events.KeyHandler}***REMOVED*** (this.keyHandler_),
...
***REMOVED***
***REMOVED*** Start the scan after the dictionary was loaded.
***REMOVED***
...
***REMOVED***
***REMOVED*** Loads few initial dictionary words into the cache.
***REMOVED***
...
***REMOVED***
***REMOVED*** Processes the included and skips the excluded text ranges.
***REMOVED*** @return {goog.ui.AbstractSpellChecker.AsyncResult} Whether the spell
***REMOVED***     checking is pending or done.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Breaks text into included and excluded ranges using the marker RegExp
***REMOVED*** supplied by the caller.
***REMOVED***
***REMOVED*** @param {string} text text to process.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Starts asynchrnonous spell checking.
***REMOVED***
***REMOVED*** @param {string} text text to process.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Processes range of text - recognized words and separators.
***REMOVED***
...
goog.ui.PlainTextSpellChecker.prototype.resume = function() {
  ...
  if (wasVisible) {
    ...
    eh.unlisten(***REMOVED*** @type {goog.events.KeyHandler}***REMOVED*** (this.keyHandler_),
        goog.events.KeyHandler.EventType.KEY, this.handleOverlayKeyEvent);
...
goog.ui.PlainTextSpellChecker.prototype.getElementProperties =
  ...
  if (status == goog.spell.SpellCheck.WordStatus.INVALID) {
    return {'class': this.invalidWordClassName***REMOVED***
  } else if (status == goog.spell.SpellCheck.WordStatus.CORRECTED) {
    return {'class': this.correctedWordClassName***REMOVED***
  }
...
***REMOVED***
***REMOVED*** Handles the click events.
***REMOVED***
...
goog.ui.PlainTextSpellChecker.prototype.onWordClick_ = function(event) {
  if (event.target.className == this.invalidWordClassName ||
    ...
    this.showSuggestionsMenu(***REMOVED*** @type {Element}***REMOVED*** (event.target), event);
...
***REMOVED***
***REMOVED*** Handles window resize events.
***REMOVED***
***REMOVED*** @param {goog.events.BrowserEvent} event Event object.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Resizes overlay to match the size of the bound element then displays the
***REMOVED*** overlay. Helper for {@link #onWindowResize_}.
***REMOVED***
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Updates the position and size of the overlay to match the original element.
***REMOVED***
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Specify ARIA roles and states as appropriate.
***REMOVED*** @private
***REMOVED***
 ...
 ***REMOVED*****REMOVED*** @desc Title for Spell Checker's overlay.*/
...
***REMOVED***
***REMOVED*** Handles key down for overlay.
***REMOVED*** @param {goog.events.BrowserEvent} e The browser event.
***REMOVED*** @return {boolean|undefined} The handled value.
***REMOVED***
...
***REMOVED***
***REMOVED*** Navigate keyboard focus in the given direction.
***REMOVED***
***REMOVED*** @param {goog.ui.AbstractSpellChecker.Direction} direction The direction to
***REMOVED***     navigate in.
***REMOVED*** @return {boolean} Whether the action is handled here.  If not handled
***REMOVED***     here, the initiating event may be propagated.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Handles blur on the menu.
***REMOVED*** @param {goog.events.BrowserEvent} event Blur event.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Sets the focus back on the previously focused word element.
***REMOVED*** @private
***REMOVED***
