...
***REMOVED***
***REMOVED*** See http://wiki/Main/BrowserChannel
***REMOVED*** This doesn't yet completely comform to the design document as we've done
***REMOVED*** some renaming and cleanup in the design document that hasn't yet been
***REMOVED*** implemented in the protocol.
***REMOVED***
...
***REMOVED*** @param {Array} respArray The response array returned by the server.
***REMOVED*** @private
***REMOVED***
...
***REMOVED***
***REMOVED*** Interface for the browser channel handler
***REMOVED***
***REMOVED***
