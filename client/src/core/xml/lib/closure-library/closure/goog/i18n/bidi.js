...
***REMOVED***
***REMOVED*** @param {goog.i18n.bidi.Dir|number|boolean} givenDir Directionality given in
***REMOVED***     one of the following formats:
***REMOVED***     1. A goog.i18n.bidi.Dir constant.
***REMOVED***     2. A number (positive = LRT, negative = RTL, 0 = unknown).
***REMOVED***     3. A boolean (true = RTL, false = LTR).
***REMOVED*** @return {goog.i18n.bidi.Dir} A goog.i18n.bidi.Dir constant matching the given
...
***REMOVED*** as well as Sindhi (sd) and Uyghur (ug).
...
***REMOVED*** given directionality.
***REMOVED*** @param {Element} element Input field element to set directionality to.
***REMOVED*** @param {goog.i18n.bidi.Dir|number|boolean} dir Desired directionality, given
