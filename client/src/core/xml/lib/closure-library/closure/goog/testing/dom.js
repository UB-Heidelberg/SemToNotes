...
***REMOVED*** @private
***REMOVED***
goog.testing.dom.END_TAG_MARKER_ = {***REMOVED***
...
***REMOVED*** @param {goog.dom.TagIterator} iterator The iterator.
***REMOVED*** @return {Node|Object} The resulting iteration item.
***REMOVED*** @private
***REMOVED***
...
***REMOVED*** @param {!Element} actual The element to check: its contents are matched
    ...
    if (expectedNode.nodeType == goog.dom.NodeType.ELEMENT) {
      ...
      if (IE_TEXT_COLLAPSE &&
          goog.style.getCascadedStyle(
             ***REMOVED*****REMOVED*** @type {Element}***REMOVED*** (actualNode), 'display') != 'inline') {
...
***REMOVED*** @param {Node} expectedNode The node whose attributes we are expecting.
***REMOVED*** @param {Node} actualNode The node with the actual attributes.
...
***REMOVED***
***REMOVED*** Assert the class attribute of actualNode is the same as the one in
***REMOVED*** expectedNode, ignoring classes that are useragents.
***REMOVED*** @param {Node} expectedNode The DOM node whose class we expect.
***REMOVED*** @param {Node} actualNode The DOM node with the actual class.
***REMOVED*** @private
***REMOVED***
