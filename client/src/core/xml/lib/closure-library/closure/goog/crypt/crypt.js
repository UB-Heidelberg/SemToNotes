...
***REMOVED*** @param {Array} array Array of numbers representing characters.
...
***REMOVED*** @param {Array.<number>} bytes UTF-8 byte array.
...
***REMOVED*** @param {!Array.<number>} bytes1 Byte array 1.
***REMOVED*** @param {!Array.<number>} bytes2 Byte array 2.
