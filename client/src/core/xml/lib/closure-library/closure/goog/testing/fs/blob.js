...
***REMOVED*** @param {number} start The start byte offset.
***REMOVED*** @param {number} length The number of bytes to slice.
***REMOVED*** @param {string=} opt_contentType The type of the resulting Blob.
***REMOVED*** @return {!goog.testing.fs.Blob} The result of the slice operation.
***REMOVED***
