...
***REMOVED***
***REMOVED*** @fileoverview Character lists and their classifications used by character
***REMOVED*** picker widget. Autogenerated from Unicode data:
***REMOVED*** https://sites/cibu/character-picker.
***REMOVED***
***REMOVED***
...
***REMOVED***
***REMOVED*** Object holding two level character organization and character listing.
***REMOVED***
***REMOVED***
goog.i18n.CharPickerData = function() {***REMOVED***


***REMOVED***
***REMOVED*** @desc Name for a symbol or character category. Used in a pull-down list
***REMOVED***   shown to a  document editing user trying to insert a special character.
***REMOVED***   Newlines are not allowed; translation should be a noun and as consise as
***REMOVED***   possible. More details:
...
***REMOVED***
***REMOVED*** Top catagory names of character organization.
...
***REMOVED***
***REMOVED*** Names of subcategories. Each message this array is the
***REMOVED*** name for the corresponding subcategory specified in
***REMOVED*** {@code goog.i18n.CharPickerData.subcategories}.
***REMOVED*** @type {Array.<string>}
***REMOVED***
...
***REMOVED***
***REMOVED*** List of characters in base88 encoding scheme. Each base88 encoded
***REMOVED*** charater string represents corresponding subcategory specified in
***REMOVED*** {@code goog.i18n.CharPickerData.subcategories}. Encoding
***REMOVED*** scheme is described in {@code goog.i18n.CharListDecompressor}.
***REMOVED*** @type {Array.<string>}
***REMOVED***
...
goog.i18n.CharPickerData.CHARLIST_OF_HAN_10_STROKE_RADICALS = [
  ...
  'w4f0t2',
  'wsC0s;Lr0:9nTgHl1U',
  '^_J077O#9wM(1gQ10#Y]3***REMOVED***gl60@192l2'
];
...
goog.i18n.CharPickerData.CHARLIST_OF_HAN_OTHER = [
    'ItK0GO8n7H4u8v36%2$P3]8va]59388:DnS8Em:6v3MH6n%fmuX4oZ10]B691E8PEn.X417IH10Q710H.AI10n)Yv20%j1d^L20WPB2W20P3e]3XBT(d0112T808YG40', /* numerics***REMOVED***
    'ozC0:4>nC0]l8w%70886G6%m^u30U8?8V2GmO8Ewgs06', /* punctuation***REMOVED***
    'HF;S8091:IIk40F3PB|%CF2[U%8#2oyr06868EG8116Of28GX2MGMHB6O', /* compatibility***REMOVED***
    'o(D0XB]`].o#V1]8XBv5^A2018$X1PUv1f2Qf60Qq10gt402ZA0', /* less common***REMOVED***
    'PK6mE86W6e68Wn1uX113v2]88888888', /* pinyin***REMOVED***
    'oxC0|', /* ideo desc***REMOVED***
    'AQC0N28M8d7H%F3' /* strokes***REMOVED***
];
...
***REMOVED***
***REMOVED*** Subcategory names. Each subarray in this array is a list of subcategory
***REMOVED*** names for the corresponding category specified in
***REMOVED*** {@code goog.i18n.CharPickerData.categories}.
...
***REMOVED***
***REMOVED*** Character lists in base88 encoding scheme. Each subarray is a list of
***REMOVED*** base88 encoded charater strings representing corresponding subcategory
***REMOVED*** specified in {@code goog.i18n.CharPickerData.categories}. Encoding
***REMOVED*** scheme is described in {@code goog.i18n.CharListDecompressor}.
***REMOVED*** @type {Array.<Array.<string>>}
***REMOVED***
