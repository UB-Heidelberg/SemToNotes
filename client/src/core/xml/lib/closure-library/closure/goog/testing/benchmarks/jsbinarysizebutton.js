...
***REMOVED***
***REMOVED*** @fileoverview Sample code to instantiate a few goog.ui.Buttons.  The
***REMOVED*** size of the resulting jsbinary for this sample file is tracked using
***REMOVED*** Greenspan (http://go/greenspan).
***REMOVED***
***REMOVED***
...
***REMOVED***b1, goog.ui.Component.EventType.ACTION, logEvent);
  ...
  ***REMOVED***b, goog.ui.Component.EventType.ACTION, logEvent);
  });
}
