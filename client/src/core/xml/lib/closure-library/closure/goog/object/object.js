...
***REMOVED*** @param {T=} opt_obj This is used as the 'this' object within f.
***REMOVED*** @return {!Object.<T,R>} a new object with the results from f.
...
***REMOVED*** @param {Object.<K,V>} obj The object to which to add the key-value pair.
***REMOVED*** @param {string} key The key to add.
***REMOVED*** @param {K} value The value to add.
***REMOVED*** @template K,V
***REMOVED***
...
***REMOVED*** o; // {a: 0, b: 1}
***REMOVED*** goog.object.extend(o, {c: 2});
***REMOVED*** o; // {a: 0, b: 1, c: 2}
***REMOVED***
***REMOVED*** @param {Object} target  The object to modify.
