...
***REMOVED***
***REMOVED*** @fileoverview Data for time zone detection.
***REMOVED***
***REMOVED*** The following code was generated by the timezone_detect.py script in:
***REMOVED*** http://go/i18n_tools which uses following files in this directory:
***REMOVED*** http://go/timezone_data
***REMOVED*** Files: olson2fingerprint.txt, country2olsons.txt, popular_olsons.txt
***REMOVED***
***REMOVED*** After automatic generation, we added some manual editing. Projecting on
***REMOVED*** future changes, it is very unlikely that we will need to change the time
***REMOVED*** zone ID groups. Most of the further modifications will be about relative
***REMOVED*** time zone order in each time zone group. The easiest way to do that is
***REMOVED*** to modify this code directly, and that's what we decide to do.
***REMOVED***
***REMOVED***
...
***REMOVED***
***REMOVED*** Time zone fingerprint mapping to time zone list.
***REMOVED*** @enum {Array.<string>}
***REMOVED***
