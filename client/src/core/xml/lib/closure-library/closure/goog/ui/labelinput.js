...
***REMOVED***
***REMOVED*** Known issue: Where the placeholder attribute isn't supported, screen reader
***REMOVED*** users encounter trouble because the label is deleted upon focus. For now we
***REMOVED*** set the "aria-label" attribute.
***REMOVED***
...
***REMOVED***
***REMOVED*** @return {boolean} Whether the value has changed been changed by the user.
***REMOVED***
...
***REMOVED***
***REMOVED*** This method focuses the input and if selects all the text. If the value
***REMOVED*** hasn't changed it will set the value to the label so that the label text is
***REMOVED*** selected.
***REMOVED***
