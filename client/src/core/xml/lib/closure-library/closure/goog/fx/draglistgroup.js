...
***REMOVED***
***REMOVED*** The user-supplied CSS class to add to the clone of the current drag item
...
***REMOVED***     the draggerEl hovers over it during a drag action.
***REMOVED***
...
goog.fx.DragListGroup.prototype.handleDragItemMouseover_ = function(e) {
  goog.dom.classes.add.apply(null,
      goog.array.concat(***REMOVED*** @type {Element}***REMOVED*** (e.currentTarget),
...
***REMOVED***
***REMOVED*** Note: Copied from abstractdragdrop.js. TODO(user): consolidate.
