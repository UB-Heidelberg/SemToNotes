...
***REMOVED***
***REMOVED*** @param {number} initialCount Initial number of objects to populate the
***REMOVED***     free pool at construction time.
...
***REMOVED*** @return {*} An object from the pool or a new one if necessary.
***REMOVED***
...
***REMOVED*** @param {*} obj The object to release.
***REMOVED***
...
***REMOVED*** @return {*} The created object.
***REMOVED***
...
***REMOVED*** @param {*} obj The object to dispose.
***REMOVED***
