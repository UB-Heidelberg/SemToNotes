...
***REMOVED***
***REMOVED*** To implement specific SHA-2 such as SHA-256, create a sub-class with
***REMOVED*** overridded reset(). See sha256.js for an example.
***REMOVED***
***REMOVED*** TODO(user): SHA-512/384 are not currently implemented. Could be added
***REMOVED*** if needed.
***REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ...
  ***REMOVED*** Sub-class needs to reset it when overriding reset().
 ...
 ***REMOVED*****REMOVED***
  ...
  ***REMOVED*** function.
  ***REMOVED*** It is a subclass-dependent value. Sub-class needs to explicitly set it
  ***REMOVED*** when overriding reset().
  ***REMOVED*** @type {!Array.<number>}
  ***REMOVED*** @protected
 ***REMOVED*****REMOVED***
  this.hash = [];
...
***REMOVED*** @param {!Array.<number>} chunk A 512-bit message chunk to be processed.
***REMOVED*** @private
***REMOVED***
...
goog.crypt.Sha2.prototype.digest = function() {
  var digest = [];
  var totalBits = this.total***REMOVED*** 8;
