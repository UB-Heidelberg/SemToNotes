...
***REMOVED***
***REMOVED***
***REMOVED*** @extends {goog.structs.Heap}
***REMOVED***
...
***REMOVED*** @param {*} priority The priority of the value. A smaller value here means a
...
***REMOVED*** @return {*} The element at the head of this queue. Returns
***REMOVED***     undefined if the queue is empty.
***REMOVED***
