...
***REMOVED***
***REMOVED*** @param {number} code The error code for the error.
...
goog.fs.Error = function(code, action) {
  ...
  this.code =***REMOVED*****REMOVED*** @type {goog.fs.Error.ErrorCode}***REMOVED*** (code);
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {number} errorCode The error code for the error.
***REMOVED*** @return {string} A debug message for the given error code. These messages are
***REMOVED***     for debugging only and are not localized.
***REMOVED***
