...
***REMOVED***
***REMOVED*** @fileoverview The file contains enumerations for ARIA states
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** Default value.  Used for live regions that should never be spoken.
 ***REMOVED*****REMOVED***
  OFF: 'off',
 ***REMOVED*****REMOVED***
  ***REMOVED*** Spoke only when the user is idle.  Best option in most cases.
 ***REMOVED*****REMOVED***
  POLITE: 'polite',
 ***REMOVED*****REMOVED***
  ***REMOVED*** Spoken as soon as possible, which means that the information has a
  ***REMOVED*** higher priority than normal, but does not necessarily interrupt
  ***REMOVED*** immediately.
 ***REMOVED*****REMOVED***
  ASSERTIVE: 'assertive'
***REMOVED***
