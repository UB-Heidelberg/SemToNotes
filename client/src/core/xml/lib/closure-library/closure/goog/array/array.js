...
***REMOVED*** @param {goog.array.ArrayLike} array The array.
***REMOVED*** @return {*} Last item in array.
***REMOVED***
...
***REMOVED***
***REMOVED*** Returns the index of the first element of an array with a specified
***REMOVED*** value, or -1 if the element is not present in the array.
***REMOVED***
***REMOVED*** See {@link http://tinyurl.com/developer-mozilla-org-array-indexof}
***REMOVED***
***REMOVED*** @param {goog.array.ArrayLike} arr The array to be searched.
***REMOVED*** @param {*} obj The object for which we are searching.
...
***REMOVED*** @param {S=} opt_obj The object to be used as the value of 'this'
***REMOVED***     within f.
***REMOVED*** @return {!Array} a new array in which only elements that passed the test are
***REMOVED***     present.
***REMOVED*** @template T,S
***REMOVED***
...
***REMOVED***     return something. The result will be inserted into a new array.
***REMOVED*** @param {S=} opt_obj The object to be used as the value of 'this'
***REMOVED***     within f.
***REMOVED*** @return {!Array} a new array with the results from f.
***REMOVED*** @template T,S
***REMOVED***
...
***REMOVED*** @param {goog.array.ArrayLike} arr Array from which to remove value.
...
***REMOVED*** @param {goog.array.ArrayLike} object  The object to convert to an array.
***REMOVED*** @return {!Array} The object converted into an array. If object has a
...
***REMOVED*** @param {goog.array.ArrayLike} arr  Array or array-like object to clone.
***REMOVED*** @return {!Array} Clone of the input array.
***REMOVED***
...
***REMOVED*** a; // [0, 1, 2]
***REMOVED***
***REMOVED*** @param {Array} arr1  The array to modify.
***REMOVED*** @param {...*} var_args The elements or arrays of elements to add to arr1.
***REMOVED***
...
***REMOVED***     are floored).
***REMOVED*** @param {...*} var_args Optional, additional elements to insert into the
***REMOVED***     array.
***REMOVED*** @return {!Array} the removed elements.
***REMOVED***
...
***REMOVED***
***REMOVED*** @param {goog.array.ArrayLike} arr The array from which to remove duplicates.
...
***REMOVED***
***REMOVED*** @param {goog.array.ArrayLike} arr The array to be searched.
***REMOVED*** @param {*} target The sought value.
***REMOVED*** @param {Function=} opt_compareFn Optional comparison function by which the
***REMOVED***     array is ordered. Should take 2 arguments to compare, and return a
...
***REMOVED***
***REMOVED*** @param {goog.array.ArrayLike} arr The array to be searched.
***REMOVED*** @param {Function} evaluator Evaluator function that receives 3 arguments
***REMOVED***     (the element, the index and the array). Should return a negative number,
***REMOVED***     zero, or a positive number depending on whether the desired index is
***REMOVED***     before, at, or after the element passed to it.
...
***REMOVED***
***REMOVED*** @param {goog.array.ArrayLike} arr The array to be searched.
***REMOVED*** @param {Function} compareFn Either an evaluator or a comparison function,
***REMOVED***     as defined by binarySearch and binarySelect above.
***REMOVED*** @param {boolean} isEvaluator Whether the function is an evaluator or a
***REMOVED***     comparison function.
***REMOVED*** @param {*=} opt_target If the function is a comparison function, then this is
***REMOVED***     the target to binary search for.
***REMOVED*** @param {Object=} opt_selfObj If the function is an evaluator, this is an
...
***REMOVED***
***REMOVED*** @deprecated Use {@link goog.array.equals}.
***REMOVED*** @param {goog.array.ArrayLike} arr1 See {@link goog.array.equals}.
***REMOVED*** @param {goog.array.ArrayLike} arr2 See {@link goog.array.equals}.
***REMOVED*** @param {Function=} opt_equalsFn See {@link goog.array.equals}.
***REMOVED*** @return {boolean} See {@link goog.array.equals}.
***REMOVED***
...
***REMOVED*** @param {!goog.array.ArrayLike} arr1 The first array to compare.
***REMOVED*** @param {!goog.array.ArrayLike} arr2 The second array to compare.
***REMOVED*** @param {?function(?, ?): number=} opt_compareFn Optional comparison function
***REMOVED***     by which the array is to be ordered. Should take 2 arguments to compare,
***REMOVED***     and return a negative number, zero, or a positive number depending on
***REMOVED***     whether the first argument is less than, equal to, or greater than the
***REMOVED***     second.
...
***REMOVED*** operators.
***REMOVED*** @param {*} a The first object to be compared.
***REMOVED*** @param {*} b The second object to be compared.
...
***REMOVED*** @param {Array.<T>} array The array to modify.
***REMOVED*** @param {T} value The object to insert.
***REMOVED*** @param {?function(T,T):number=} opt_compareFn Optional comparison function by
***REMOVED***     which the
***REMOVED***     array is ordered. Should take 2 arguments to compare, and return a
***REMOVED***     negative number, zero, or a positive number depending on whether the
***REMOVED***     first argument is less than, equal to, or greater than the second.
...
***REMOVED*** @param {Array} array The array to modify.
***REMOVED*** @param {*} value The object to remove.
***REMOVED*** @param {Function=} opt_compareFn Optional comparison function by which the
***REMOVED***     array is ordered. Should take 2 arguments to compare, and return a
***REMOVED***     negative number, zero, or a positive number depending on whether the
***REMOVED***     first argument is less than, equal to, or greater than the second.
...
***REMOVED*** @param {function(T,number,Array.<T>):?} sorter Function to call for every
***REMOVED***     element.  This
***REMOVED***     takes 3 arguments (the element, the index and the array) and must
***REMOVED***     return a valid object key (a string, number, etc), or undefined, if
***REMOVED***     that object should not be placed in a bucket.
...
***REMOVED***
***REMOVED*** @param {*} value The value to repeat.
***REMOVED*** @param {number} n The repeat count.
***REMOVED*** @return {!Array} An array with the repeated value.
***REMOVED***
