...
***REMOVED*** @param {Function} listener Function to callback when the action is triggered.
***REMOVED*** @param {number} interval Interval over which to throttle. The handler can
