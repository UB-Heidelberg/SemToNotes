...
***REMOVED*** @return {Object} Contains two properties: 'hex', which is a string containing
***REMOVED***     a hex representation of the color, as well as 'type', which is a string
...
***REMOVED*** @param {string} hexColor Color to convert.
***REMOVED*** @return {Array} array containing [r, g, b] as ints in [0, 255].
***REMOVED***
