***REMOVED***
***REMOVED*** @fileoverview A function call expression.
***REMOVED***
...
***REMOVED***
***REMOVED*** A function call expression.
***REMOVED***
***REMOVED***
***REMOVED*** @extends {xrx.xpath.Expr}
***REMOVED*** @param {!xrx.xpath.FunctionCall.BuiltInFunc} func Function.
***REMOVED*** @param {!Array.<!xrx.xpath.Expr>} args Arguments to the function.
***REMOVED***
 ...
 ***REMOVED*****REMOVED***
  ***REMOVED*** @type {!xrx.xpath.FunctionCall.BuiltInFunc}
  ***REMOVED*** @private
 ***REMOVED*****REMOVED***
  this.func_ = func;
...
xrx.xpath.FunctionCall.prototype.evaluate = function(ctx) {
  ...
  return***REMOVED*****REMOVED*** @type {!(string|boolean|number|xrx.xpath.NodeSet)}***REMOVED*** (result);
***REMOVED***
...
***REMOVED***
***REMOVED*** A mapping from function names to Func objects.
***REMOVED***
***REMOVED*** @private
***REMOVED*** @type {!Object.<string, !xrx.xpath.FunctionCall.BuiltInFunc>}
***REMOVED***
xrx.xpath.FunctionCall.nameToFuncMap_ = {***REMOVED***


***REMOVED***
***REMOVED*** Constructs a Func and maps its name to it.
***REMOVED***
***REMOVED*** @param {string} name Name of the function.
***REMOVED*** @param {xrx.xpath.DataType} returnType Datatype of the function return value.
...
***REMOVED*** @return {!xrx.xpath.FunctionCall.BuiltInFunc} The function created.
***REMOVED***
xrx.xpath.FunctionCall.createFunc = function(name, returnType,
  ...
  var func = new xrx.xpath.Function(name, returnType,
      needContextPosition, needContextNodeWithoutArgs, needContextNodeWithArgs,
      evaluate, minArgs, opt_maxArgs, opt_nodesetsRequired);
  func =***REMOVED*****REMOVED*** @type {!xrx.xpath.FunctionCall.BuiltInFunc}***REMOVED*** (func);
...
***REMOVED***
***REMOVED*** Returns the function object for this name.
***REMOVED***
***REMOVED*** @param {string} name The function's name.
***REMOVED*** @return {xrx.xpath.FunctionCall.BuiltInFunc} The function object.
***REMOVED***
...
***REMOVED***
***REMOVED*** An XPath function enumeration.
***REMOVED***
***REMOVED*** <p>A list of XPath 1.0 functions:
***REMOVED*** http://www.w3.org/TR/xpath/#corelib
***REMOVED***
***REMOVED*** @enum {!Object}
***REMOVED***
