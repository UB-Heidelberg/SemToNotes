***REMOVED***
***REMOVED*** @fileoverview A class representing operations on union expressions.
***REMOVED***
...
***REMOVED***
***REMOVED*** Constructor for UnionExpr.
***REMOVED***
***REMOVED*** @param {!Array.<!xrx.xpath.Expr>} paths The paths in the union.
