...
e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(a){a.call(goog.global)};COMPILED||(goog.global.COMPILED=COMPILED);var xrx={drawing:function(){}};xrx.drawing.State={DRAG:1,NONE:2};xrx.drawing.Mode={VIEW:1,MODIFY:2,DELETE:3,CREATE:4,DISABLED:5,SELECT:6,HOVER:7,HOVERMULTIPLE:8};xrx.drawing.Orientation={C:"C",NE:"NE",SE:"SE",SW:"SW",NW:"NW"};xrx.drawing.EventType={VIEWBOX_CHANGE:"eventViewboxChange",SHAPE_HOVER_IN:"eventShapeHoverIn",SHAPE_HOVER_MOVE:"eventShapeHoverMove",SHAPE_HOVER_OUT:"eventShapeHoverOut",SHAPE_BEFORE_DRAW:"eventShapeBeforeDraw"};xrx.shape=function(){};xrx.shape.EventType={SHAPE_BEFORE_DRAW:"eventShapeBeforeDraw"};xrx.shape.Stylable=function(){this.fill_={color:"",opacity:0};this.stroke_={color:"black",width:1}};xrx.shape.Stylable.prototype.setStyle=function(a){this.stroke_.color=a.getStrokeColor();this.stroke_.width=a.getStrokeWidth();this.fill_.color=a.getFillColor();this.fill_.opacity=a.getFillOpacity()};xrx.shape.Stylable.prototype.getStrokeWidth=function(){return this.stroke_.width};xrx.shape.Stylable.prototype.setStrokeWidth=function(a){void 0!==a&&(this.stroke_.width=a)};
xrx.shape.Stylable.prototype.getStrokeColor=function(){return this.stroke_.color};xrx.shape.Stylable.prototype.setStrokeColor=function(a){void 0!==a&&(this.stroke_.color=a)};xrx.shape.Stylable.prototype.getFillColor=function(){return this.fill_.color};xrx.shape.Stylable.prototype.setFillColor=function(a){0===this.fill_.opacity&&(this.fill_.opacity=1);void 0!==a&&(this.fill_.color=a)};xrx.shape.Stylable.prototype.getFillOpacity=function(){return this.fill_.opacity};
xrx.shape.Stylable.prototype.setFillOpacity=function(a){void 0!==a&&(this.fill_.opacity=a)};xrx.shape.RenderStylable=function(a){xrx.shape.Stylable.call(this);this.engineElement_=a;this.zoomFactor_=1};goog.inherits(xrx.shape.RenderStylable,xrx.shape.Stylable);xrx.shape.RenderStylable.prototype.getEngineElement=function(){return this.engineElement_};xrx.shape.RenderStylable.prototype.setZoomFactor=function(a){this.zoomFactor_=a};xrx.shape.RenderStylable.prototype.getRenderingStrokeWidth=function(){return this.stroke_.width/this.zoomFactor_};
xrx.shape.RenderStylable.prototype.startDrawing_=function(){this.drawing_.eventBeforeRendering(this);this.engineElement_.applyTransform(this.ctm_);this.engineElement_.startDrawing()};xrx.shape.RenderStylable.prototype.finishDrawing_=function(){this.engineElement_.finishDrawing()};goog.dom={};goog.dom.NodeType={ELEMENT:1,ATTRIBUTE:2,TEXT:3,CDATA_SECTION:4,ENTITY_REFERENCE:5,ENTITY:6,PROCESSING_INSTRUCTION:7,COMMENT:8,DOCUMENT:9,DOCUMENT_TYPE:10,DOCUMENT_FRAGMENT:11,NOTATION:12};goog.debug={};goog.debug.Error=function(a){if(Error.captureStackTrace)Error.captureStackTrace(this,goog.debug.Error);else{var b=Error().stack;b&&(this.stack=b)}a&&(this.message=String(a))};goog.inherits(goog.debug.Error,Error);goog.debug.Error.prototype.name="CustomError";goog.string={};goog.string.DETECT_DOUBLE_ESCAPING=!1;goog.string.Unicode={NBSP:"\u00a0"};goog.string.startsWith=function(a,b){return 0==a.lastIndexOf(b,0)};goog.string.endsWith=function(a,b){var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c};goog.string.caseInsensitiveStartsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(0,b.length))};goog.string.caseInsensitiveEndsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(a.length-b.length,b.length))};
...
goog.dom.classes.has=function(a,b){return goog.array.contains(goog.dom.classes.get(a),b)};goog.dom.classes.enable=function(a,b,c){c?goog.dom.classes.add(a,b):goog.dom.classes.remove(a,b)};goog.dom.classes.toggle=function(a,b){var c=!goog.dom.classes.has(a,b);goog.dom.classes.enable(a,b,c);return c};goog.object={};goog.object.forEach=function(a,b,c){for(var d in a)b.call(c,a[d],d,a)};goog.object.filter=function(a,b,c){var d={},e;for(e in a)b.call(c,a[e],e,a)&&(d[e]=a[e]);return d};goog.object.map=function(a,b,c){var d={},e;for(e in a)d[e]=b.call(c,a[e],e,a);return d};goog.object.some=function(a,b,c){for(var d in a)if(b.call(c,a[d],d,a))return!0;return!1};goog.object.every=function(a,b,c){for(var d in a)if(!b.call(c,a[d],d,a))return!1;return!0};
...
goog.object.createImmutableView=function(a){var b=a;Object.isFrozen&&!Object.isFrozen(a)&&(b=Object.create(a),Object.freeze(b));return b};goog.object.isImmutableView=function(a){return!!Object.isFrozen&&Object.isFrozen(a)};goog.dom.TagName={A:"A",ABBR:"ABBR",ACRONYM:"ACRONYM",ADDRESS:"ADDRESS",APPLET:"APPLET",AREA:"AREA",ARTICLE:"ARTICLE",ASIDE:"ASIDE",AUDIO:"AUDIO",B:"B",BASE:"BASE",BASEFONT:"BASEFONT",BDI:"BDI",BDO:"BDO",BIG:"BIG",BLOCKQUOTE:"BLOCKQUOTE",BODY:"BODY",BR:"BR",BUTTON:"BUTTON",CANVAS:"CANVAS",CAPTION:"CAPTION",CENTER:"CENTER",CITE:"CITE",CODE:"CODE",COL:"COL",COLGROUP:"COLGROUP",COMMAND:"COMMAND",DATA:"DATA",DATALIST:"DATALIST",DD:"DD",DEL:"DEL",DETAILS:"DETAILS",DFN:"DFN",DIALOG:"DIALOG",DIR:"DIR",DIV:"DIV",
...
TIME:"TIME",TITLE:"TITLE",TR:"TR",TRACK:"TRACK",TT:"TT",U:"U",UL:"UL",VAR:"VAR",VIDEO:"VIDEO",WBR:"WBR"};goog.labs={};goog.labs.userAgent={};goog.labs.userAgent.util={};goog.labs.userAgent.util.getNativeUserAgentString_=function(){var a=goog.labs.userAgent.util.getNavigator_();return a&&(a=a.userAgent)?a:""};goog.labs.userAgent.util.getNavigator_=function(){return goog.global.navigator};goog.labs.userAgent.util.userAgent_=goog.labs.userAgent.util.getNativeUserAgentString_();goog.labs.userAgent.util.setUserAgent=function(a){goog.labs.userAgent.util.userAgent_=a||goog.labs.userAgent.util.getNativeUserAgentString_()};
...
goog.style.getCssTranslation=function(a){a=goog.style.getComputedTransform(a);return a?(a=a.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};xrx.vml=function(){};xrx.vml.browserEnabled=!1;xrx.vml.initVmlRendering=function(){xrx.vml.browserEnabled||(goog.style.installStyles(".xrx-vml{behavior:url(#default#VML);display:inline-block}"),xrx.vml.browserEnabled=!0)};xrx.vml.isSupported=function(){return!!document.namespaces};
xrx.vml.createElement=function(a){return goog.dom.htmlToDocumentFragment("<"+a+'  xmlns="urn:schemas-microsoft.com:vml" class="xrx-vml"><fill xmlns="urn:schemas-microsoft.com:vml" class="xrx-vml"></fill><stroke xmlns="urn:schemas-microsoft.com:vml" class="xrx-vml"></stroke><skew xmlns="urn:schemas-microsoft.com:vml" class="xrx-vml"></skew></'+a+">")};
xrx.vml.setPath=function(a,b,c){for(var d="m ",e=0,f=b.length;e<f;e++)d+=b[e][0]+","+b[e][1],0!==e&&e!==f-1&&(d+=", "),0===e&&(d+=" l ");c&&(d+=" x ");a.path=d+" e"};xrx.engine=function(){};xrx.engine.CANVAS="canvas";xrx.engine.SVG="svg";xrx.engine.VML="vml";xrx.engine.isOldIE=function(){return goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher(9)};xrx.engine.Element=function(){};xrx.engine.Element.prototype.startDrawing=function(){};xrx.engine.Element.prototype.finishDrawing=function(){};xrx.vml.Element=function(a){xrx.engine.Element.call(this);this.element_=a};goog.inherits(xrx.vml.Element,xrx.engine.Element);xrx.vml.Element.prototype.getElement=function(){return this.element_};xrx.vml.Element.prototype.applyTransform=function(a){};xrx.vml.Stylable=function(a){xrx.vml.Element.call(this,a);a=goog.dom.getChildren(a);this.fill_=a[0];this.stroke_=a[1];this.skew_=a[2]};goog.inherits(xrx.vml.Stylable,xrx.vml.Element);xrx.vml.Stylable.prototype.strokeAndFill_=function(a,b,c,d){void 0!==a&&this.setFillColor(a);void 0!==b&&this.setFillOpacity(b);void 0!==c&&this.setStrokeColor(c);void 0!==d&&this.setStrokeWidth(d)};xrx.vml.Stylable.prototype.setStrokeWidth=function(a){this.stroke_.weight=""+a};
...
xrx.vml.Rect.prototype.draw=function(a,b,c,d,e,f,g,h){void 0!==a&&this.setX(a);void 0!==b&&this.setY(b);void 0!==c&&this.setWidth(c);void 0!==d&&this.setHeight(d);this.strokeAndFill_(e,f,g,h)};xrx.vml.Rect.create=function(a){a=xrx.vml.createElement("rect");a.style.position="absolute";return new xrx.vml.Rect(a)};xrx.canvas=function(){};xrx.canvas.isSupported=function(){return!!document.createElement("canvas").getContext};xrx.canvas.Element=function(a){xrx.engine.Element.call(this);this.canvas_=a;this.context_=a.getElement().getContext("2d")};goog.inherits(xrx.canvas.Element,xrx.engine.Element);xrx.canvas.Element.prototype.getCanvas=function(){return this.canvas_};xrx.canvas.Element.prototype.getContext=function(){return this.context_};xrx.canvas.Element.prototype.applyTransform=function(a){a&&this.context_.setTransform(a.m00_,a.m10_,a.m01_,a.m11_,a.m02_,a.m12_)};xrx.canvas.Stylable=function(a){xrx.canvas.Element.call(this,a)};goog.inherits(xrx.canvas.Stylable,xrx.canvas.Element);xrx.canvas.Stylable.prototype.strokeAndFill_=function(a,b,c,d){this.context_.fillStyle=a;this.context_.globalAlpha=b;this.context_.fill();this.context_.globalAlpha=1;this.context_.strokeStyle=c;this.context_.lineWidth=d;0<d&&this.context_.stroke()};xrx.canvas.Image=function(a){xrx.canvas.Stylable.call(this,a)};goog.inherits(xrx.canvas.Image,xrx.canvas.Stylable);xrx.canvas.Image.prototype.draw=function(a){a&&this.context_.drawImage(a,0,0,a.naturalWidth,a.naturalHeight)};xrx.canvas.Image.create=function(a){return new xrx.canvas.Image(a)};xrx.canvas.Circle=function(a){xrx.canvas.Stylable.call(this,a)};goog.inherits(xrx.canvas.Circle,xrx.canvas.Stylable);xrx.canvas.Circle.prototype.draw=function(a,b,c,d,e,f,g){this.context_.beginPath();this.context_.arc(a,b,c,0,2*Math.PI);this.strokeAndFill_(d,e,f,g)};xrx.canvas.Circle.create=function(a){return new xrx.canvas.Circle(a)};xrx.vml.Polyline=function(a){xrx.vml.Stylable.call(this,a)};goog.inherits(xrx.vml.Polyline,xrx.vml.Stylable);xrx.vml.Polyline.prototype.setCoords=function(a){xrx.vml.setPath(this.element_,a)};xrx.vml.Polyline.prototype.draw=function(a,b,c,d,e){void 0!==a&&this.setCoords(a);this.strokeAndFill_(b,c,d,e)};xrx.vml.Polyline.create=function(a){a=xrx.vml.createElement("shape");a.style.position="absolute";a.style.top="0px";a.style.left="0px";a.style.width="100px";a.style.height="100px";return new xrx.vml.Polyline(a)};xrx.vml.Ellipse=function(a){xrx.vml.Stylable.call(this,a);this.rx_;this.ry_};goog.inherits(xrx.vml.Ellipse,xrx.vml.Stylable);xrx.vml.Ellipse.prototype.setCenter=function(a,b){var c=a-this.rx_,d=b-this.ry_;void 0!==a&&(this.element_.style.left=c+"px");void 0!==b&&(this.element_.style.top=d+"px")};xrx.vml.Ellipse.prototype.setRadiusX=function(a){this.rx_=a;this.element_.style.width=2*this.rx_+"px"};xrx.vml.Ellipse.prototype.setRadiusY=function(a){this.ry_=a;this.element_.style.height=2*this.ry_+"px"};
...
xrx.canvas.Canvas.create=function(a){var b=goog.dom.createElement("canvas"),b=new xrx.canvas.Canvas(b);goog.dom.appendChild(a,b.getElement());return b};xrx.canvas.Group=function(a){xrx.canvas.Container.call(this,a)};goog.inherits(xrx.canvas.Group,xrx.canvas.Container);xrx.canvas.Group.create=function(a){return new xrx.canvas.Group(a)};xrx.svg=function(){};xrx.svg.Namespace={svg:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink"};xrx.svg.isSupported=function(){return!!document.createElementNS&&!!document.createElementNS(xrx.svg.Namespace.svg,"svg").createSVGRect};xrx.svg.setCoords=function(a,b){for(var c="",d=0,e=b.length;d<e;d++)c+=b[d][0]+","+b[d][1]+" ";a.setAttribute("points",c)};xrx.svg.Element=function(a){xrx.engine.Element.call(this);this.element_=a};goog.inherits(xrx.svg.Element,xrx.engine.Element);xrx.svg.Element.prototype.getElement=function(){return this.element_};xrx.svg.Element.prototype.applyTransform=function(a){a&&this.element_.setAttribute("transform","matrix("+a.m00_+","+a.m10_+","+a.m01_+","+a.m11_+","+a.m02_+","+a.m12_+")")};xrx.svg.Stylable=function(a){xrx.svg.Element.call(this,a)};goog.inherits(xrx.svg.Stylable,xrx.svg.Element);xrx.svg.Stylable.prototype.strokeAndFill_=function(a,b,c,d){void 0!==a&&this.setFillColor(a);void 0!==b&&this.setFillOpacity(b);void 0!==c&&this.setStrokeColor(c);void 0!==d&&this.setStrokeWidth(d)};xrx.svg.Stylable.prototype.setStrokeWidth=function(a){this.element_.setAttribute("stroke-width",a)};
xrx.svg.Stylable.prototype.setStrokeColor=function(a){this.element_.setAttribute("stroke",a);this.element_.setAttribute("stroke-color",a)};xrx.svg.Stylable.prototype.setFillColor=function(a){this.element_.setAttribute("fill",a)};xrx.svg.Stylable.prototype.setFillOpacity=function(a){this.element_.setAttribute("fill-opacity",a)};xrx.svg.Line=function(a){xrx.svg.Stylable.call(this,a)};goog.inherits(xrx.svg.Line,xrx.svg.Stylable);xrx.svg.Line.prototype.setCoords=function(a,b,c,d){void 0!==a&&this.element_.setAttribute("x1",a);void 0!==b&&this.element_.setAttribute("y1",b);void 0!==c&&this.element_.setAttribute("x2",c);void 0!==d&&this.element_.setAttribute("y2",d)};xrx.svg.Line.prototype.draw=function(a,b,c,d,e,f){this.setCoords(a,b,c,d);this.strokeAndFill_(void 0,void 0,e,f)};
xrx.svg.Line.create=function(a){a=document.createElementNS(xrx.svg.Namespace.svg,"line");return new xrx.svg.Line(a)};xrx.canvas.Rect=function(a){xrx.canvas.Stylable.call(this,a)};goog.inherits(xrx.canvas.Rect,xrx.canvas.Stylable);xrx.canvas.Rect.prototype.drawPath_=function(a,b,c,d){this.context_.beginPath();this.context_.moveTo(a,b);this.context_.lineTo(a+c,b);this.context_.lineTo(a+c,b+d);this.context_.lineTo(a,b+d);this.context_.closePath()};xrx.canvas.Rect.prototype.draw=function(a,b,c,d,e,f,g,h){this.drawPath_(a,b,c,d);this.strokeAndFill_(e,f,g,h)};xrx.canvas.Rect.create=function(a){return new xrx.canvas.Rect(a)};xrx.canvas.Polyline=function(a){xrx.canvas.Stylable.call(this,a)};goog.inherits(xrx.canvas.Polyline,xrx.canvas.Stylable);xrx.canvas.Polyline.prototype.drawPath_=function(a){this.context_.beginPath();this.context_.moveTo(a[0][0],a[0][1]);for(var b=1,c=a.length;b<c;b++)this.context_.lineTo(a[b][0],a[b][1])};xrx.canvas.Polyline.prototype.draw=function(a,b,c,d,e){this.drawPath_(a);this.strokeAndFill_(b,c,d,e)};xrx.canvas.Polyline.create=function(a){return new xrx.canvas.Polyline(a)};xrx.vml.Image=function(a){xrx.vml.Stylable.call(this,a)};goog.inherits(xrx.vml.Image,xrx.vml.Stylable);xrx.vml.Image.prototype.setImage=function(a){this.element_.src=a.src;this.element_.width=a.naturalWidth;this.element_.height=a.naturalHeight};xrx.vml.Image.prototype.draw=function(a){void 0!==a&&this.setImage(a)};
xrx.vml.Image.create=function(a){a=goog.dom.htmlToDocumentFragment('<image  xmlns="urn:schemas-microsoft.com:vml" class="xrx-vml" src="about:blank"></image>');a.style.position="absolute";a.style.display="inline";a.style.left="0px";a.style.top="0px";return new xrx.vml.Image(a)};xrx.svg.Container=function(a){xrx.svg.Element.call(this,a);this.childs_=[]};goog.inherits(xrx.svg.Container,xrx.svg.Element);xrx.svg.Container.prototype.addChild=function(a){this.childs_.push(a);goog.dom.append(this.element_,a.getElement())};xrx.svg.Container.prototype.getChildren=function(){return this.childs_};xrx.svg.Container.prototype.removeChildren=function(){goog.dom.removeChildren(this.element_);this.childs_=[]};
xrx.svg.Container.prototype.removeChildAt=function(a){goog.dom.removeNode(this.childs_[a].getElement());this.childs_.splice(a,1)};xrx.svg.Canvas=function(a){xrx.svg.Container.call(this,a);this.height_=this.width_=0};goog.inherits(xrx.svg.Canvas,xrx.svg.Container);xrx.svg.Canvas.prototype.getEventTarget=function(){return this.element_};xrx.svg.Canvas.prototype.getWidth=function(){return this.width_};xrx.svg.Canvas.prototype.setWidth=function(a){this.width_=a;this.element_.setAttribute("width",a)};xrx.svg.Canvas.prototype.getHeight=function(){return this.height_};
xrx.svg.Canvas.prototype.setHeight=function(a){this.height_=a;this.element_.setAttribute("height",a)};xrx.svg.Canvas.prototype.startDrawing=function(){};xrx.svg.Canvas.prototype.finishDrawing=function(){};xrx.svg.Canvas.create=function(a){var b=document.createElementNS(xrx.svg.Namespace.svg,"svg");goog.style.setStyle(b,"overflow","hidden");b=new xrx.svg.Canvas(b);goog.dom.appendChild(a,b.getElement());return b};xrx.canvas.Line=function(a){xrx.canvas.Stylable.call(this,a)};goog.inherits(xrx.canvas.Line,xrx.canvas.Stylable);xrx.canvas.Line.prototype.drawPath_=function(a,b,c,d){this.context_.beginPath();this.context_.moveTo(a,b);this.context_.lineTo(c,d)};xrx.canvas.Line.prototype.draw=function(a,b,c,d,e,f){this.drawPath_(a,b,c,d);this.strokeAndFill_(void 0,void 0,e,f)};xrx.canvas.Line.create=function(a){return new xrx.canvas.Line(a)};xrx.svg.Polygon=function(a){xrx.svg.Stylable.call(this,a)};goog.inherits(xrx.svg.Polygon,xrx.svg.Stylable);xrx.svg.Polygon.prototype.setCoords=function(a){xrx.svg.setCoords(this.element_,a)};xrx.svg.Polygon.prototype.draw=function(a,b,c,d,e){void 0!==a&&this.setCoords(a);this.strokeAndFill_(b,c,d,e)};xrx.svg.Polygon.create=function(a){a=document.createElementNS(xrx.svg.Namespace.svg,"polygon");return new xrx.svg.Polygon(a)};xrx.svg.Circle=function(a){xrx.svg.Stylable.call(this,a)};goog.inherits(xrx.svg.Circle,xrx.svg.Stylable);xrx.svg.Circle.prototype.setCenter=function(a,b){void 0!==a&&this.element_.setAttribute("cx",a);void 0!==b&&this.element_.setAttribute("cy",b)};xrx.svg.Circle.prototype.setRadius=function(a){this.element_.setAttribute("r",a)};xrx.svg.Circle.prototype.draw=function(a,b,c,d,e,f,g){this.setCenter(a,b);void 0!==c&&this.setRadius(c);this.strokeAndFill_(d,e,f,g)};
xrx.svg.Circle.create=function(a){a=document.createElementNS(xrx.svg.Namespace.svg,"circle");return new xrx.svg.Circle(a)};xrx.canvas.Ellipse=function(a){xrx.canvas.Stylable.call(this,a)};goog.inherits(xrx.canvas.Ellipse,xrx.canvas.Stylable);xrx.canvas.Ellipse.prototype.draw=function(a,b,c,d,e,f,g,h){if(this.context_.ellipse)this.context_.beginPath(),this.context_.ellipse(a,b,c,d,0,0,2*Math.PI,!0),this.context_.closePath();else for(var k,l,m=0;m<=2*Math.PI;m+=.01)k=a+c*Math.sin(m),l=b-d*Math.cos(m),0===m?this.context_.moveTo(k,l):this.context_.lineTo(k,l);this.strokeAndFill_(e,f,g,h)};xrx.canvas.Ellipse.create=function(a){return new xrx.canvas.Ellipse(a)};xrx.svg.Ellipse=function(a){xrx.svg.Stylable.call(this,a)};goog.inherits(xrx.svg.Ellipse,xrx.svg.Stylable);xrx.svg.Ellipse.prototype.setCenter=function(a,b){void 0!==a&&this.element_.setAttribute("cx",a);void 0!==b&&this.element_.setAttribute("cy",b)};xrx.svg.Ellipse.prototype.setRadiusX=function(a){this.element_.setAttribute("rx",a)};xrx.svg.Ellipse.prototype.setRadiusY=function(a){this.element_.setAttribute("ry",a)};
xrx.svg.Ellipse.prototype.draw=function(a,b,c,d,e,f,g,h){this.setCenter(a,b);void 0!==c&&this.setRadiusX(c);void 0!==d&&this.setRadiusY(d);this.strokeAndFill_(e,f,g,h)};xrx.svg.Ellipse.create=function(a){a=document.createElementNS(xrx.svg.Namespace.svg,"ellipse");return new xrx.svg.Ellipse(a)};xrx.vml.Container=function(a){xrx.vml.Element.call(this,a);this.childs_=[]};goog.inherits(xrx.vml.Container,xrx.vml.Element);xrx.vml.Container.prototype.addChild=function(a){console.log(a);this.childs_.push(a);this.element_.appendChild(a.getElement())};xrx.vml.Container.prototype.getChildren=function(){return this.childs_};xrx.vml.Container.prototype.removeChildren=function(){goog.dom.removeChildren(this.element_);this.childs_=[]};
xrx.vml.Container.prototype.removeChildAt=function(a){goog.dom.removeNode(this.childs_[a].getElement());this.childs_.splice(a,1)};xrx.vml.Canvas=function(a){xrx.vml.Container.call(this,a);this.height_=this.width_=0};goog.inherits(xrx.vml.Canvas,xrx.vml.Container);xrx.vml.Canvas.prototype.getEventTarget=function(){return this.element_};xrx.vml.Canvas.prototype.getWidth=function(){return this.width_};xrx.vml.Canvas.prototype.setWidth=function(a){this.width_=a;this.element_.parentElement.style.width=a+"px";this.element_.style.width=a+"px"};xrx.vml.Canvas.prototype.getHeight=function(){return this.height_};
xrx.vml.Canvas.prototype.setHeight=function(a){this.height_=a;this.element_.parentElement.style.height=a+"px";this.element_.style.height=a+"px"};xrx.vml.Canvas.prototype.startDrawing=function(){};xrx.vml.Canvas.prototype.finishDrawing=function(){};
xrx.vml.Canvas.create=function(a){xrx.vml.initVmlRendering();var b=goog.dom.createElement("div");b.style.display="inline-block";b.style.position="relative";b.style.overflow="hidden";b.style.width="100px";b.style.height="100px";var c=goog.dom.htmlToDocumentFragment('<group  xmlns="urn:schemas-microsoft.com:vml" class="xrx-vml" coordorigin="0,0" coordsize="100,100"></group>');goog.dom.appendChild(b,c);goog.dom.appendChild(a,b);c.style.position="absolute";c.style.left="0px";c.style.top="0px";c.style.width=
"100px";c.style.height="100px";return new xrx.vml.Canvas(c)};xrx.vml.Polygon=function(a){xrx.vml.Stylable.call(this,a)};goog.inherits(xrx.vml.Polygon,xrx.vml.Stylable);xrx.vml.Polygon.prototype.setCoords=function(a){xrx.vml.setPath(this.element_,a,!0)};xrx.vml.Polygon.prototype.draw=function(a,b,c,d,e){void 0!==a&&this.setCoords(a);this.strokeAndFill_(b,c,d,e)};xrx.vml.Polygon.create=function(a){a=xrx.vml.createElement("shape");a.style.position="absolute";a.style.top="0px";a.style.left="0px";a.style.width="100px";a.style.height="100px";return new xrx.vml.Polygon(a)};xrx.svg.Group=function(a){xrx.svg.Container.call(this,a)};goog.inherits(xrx.svg.Group,xrx.svg.Container);xrx.svg.Group.create=function(a){a=document.createElementNS(xrx.svg.Namespace.svg,"g");return new xrx.svg.Group(a)};xrx.vml.Group=function(a){xrx.vml.Container.call(this,a)};goog.inherits(xrx.vml.Group,xrx.vml.Container);xrx.vml.Group.create=function(a){a=goog.dom.htmlToDocumentFragment('<group  xmlns="urn:schemas-microsoft.com:vml" class="xrx-vml"></group>');a.style.position="absolute";a.style.left="0px";a.style.top="0px";a.style.width="100px";a.style.height="100px";return new xrx.vml.Group(a)};xrx.svg.Image=function(a){xrx.svg.Stylable.call(this,a)};goog.inherits(xrx.svg.Image,xrx.svg.Stylable);xrx.svg.Image.prototype.setWidth=function(a){this.element_.setAttribute("width",a)};xrx.svg.Image.prototype.setHeight=function(a){this.element_.setAttribute("height",a)};xrx.svg.Image.prototype.setImage=function(a){this.element_.setAttributeNS(xrx.svg.Namespace.xlink,"xlink:href",a.src)};xrx.svg.Image.prototype.draw=function(a){void 0!==a&&(this.setImage(a),this.setWidth(a.naturalWidth),this.setHeight(a.naturalHeight))};
xrx.svg.Image.create=function(a){a=document.createElementNS(xrx.svg.Namespace.svg,"image");return new xrx.svg.Image(a)};xrx.vml.Circle=function(a){xrx.vml.Stylable.call(this,a);this.r_};goog.inherits(xrx.vml.Circle,xrx.vml.Stylable);xrx.vml.Circle.prototype.setCenter=function(a,b,c){c=a-this.r_;var d=b-this.r_;void 0!==a&&(this.element_.style.left=c+"px");void 0!==b&&(this.element_.style.top=d+"px")};xrx.vml.Circle.prototype.setRadius=function(a){this.r_=a;a=2*this.r_;this.element_.style.width=a+"px";this.element_.style.height=a+"px"};
...
xrx.svg.Rect.prototype.draw=function(a,b,c,d,e,f,g,h){void 0!==a&&this.setX(a);void 0!==b&&this.setY(b);void 0!==c&&this.setWidth(c);void 0!==d&&this.setHeight(d);this.strokeAndFill_(e,f,g,h)};xrx.svg.Rect.create=function(a){a=document.createElementNS(xrx.svg.Namespace.svg,"rect");return new xrx.svg.Rect(a)};xrx.svg.Polyline=function(a){xrx.svg.Stylable.call(this,a)};goog.inherits(xrx.svg.Polyline,xrx.svg.Stylable);xrx.svg.Polyline.prototype.setCoords=function(a){xrx.svg.setCoords(this.element_,a)};xrx.svg.Polyline.prototype.draw=function(a,b,c,d,e){void 0!==a&&this.setCoords(a);this.strokeAndFill_(b,c,d,e)};xrx.svg.Polyline.create=function(a){a=document.createElementNS(xrx.svg.Namespace.svg,"polyline");return new xrx.svg.Polyline(a)};xrx.vml.Line=function(a){xrx.vml.Stylable.call(this,a)};goog.inherits(xrx.vml.Line,xrx.vml.Stylable);xrx.vml.Line.prototype.setCoords=function(a){xrx.vml.setPath(this.element_,a,!1)};xrx.vml.Line.prototype.draw=function(a,b,c,d,e,f){this.setCoords([[a,b],[c,d]]);this.strokeAndFill_(void 0,void 0,e,f)};xrx.vml.Line.create=function(a){a=xrx.vml.createElement("shape");a.style.position="absolute";a.style.top="0px";a.style.left="0px";a.style.width="100px";a.style.height="100px";return new xrx.vml.Line(a)};xrx.engine.Engines=function(){};xrx.shape.Shape=function(a,b){xrx.shape.RenderStylable.call(this,b);this.drawing_=a;this.hoverable_;this.selectable_;this.modifiable_;this.isModifiable_=!0;this.creatable_};goog.inherits(xrx.shape.Shape,xrx.shape.RenderStylable);xrx.shape.Shape.prototype.getDrawing=function(){return this.drawing_};xrx.shape.Shape.prototype.setModifiable=function(a){!1===a?this.isModifiable_=!1:this.isModifiable_=!0};xrx.shape.Shape.prototype.isModifiable=function(){return this.isModifiable_};xrx.shape.Geometry=function(a,b,c){xrx.shape.Shape.call(this,a,b);this.geometry_=c;this.zoomFactor_=1};goog.inherits(xrx.shape.Geometry,xrx.shape.Shape);xrx.shape.Geometry.prototype.setZoomFactor=function(a){this.zoomFactor_=a};xrx.shape.Geometry.prototype.getGeometry=function(){return this.geometry_};xrx.shape.Geometry.prototype.setCTM=function(a){this.ctm_=a};
xrx.shape.Geometry.prototype.getCoordsCopy=function(){for(var a=this.getCoords(),b=a.length,c=Array(b),d=0;d<b;d++)c[d]=Array(2),c[d][0]=a[d][0],c[d][1]=a[d][1];return c};xrx.shape.Container=function(a,b){xrx.shape.Geometry.call(this,a,b);this.childs_=[]};goog.inherits(xrx.shape.Container,xrx.shape.Geometry);xrx.shape.Container.prototype.getChildren=function(){return this.childs_};xrx.shape.Container.prototype.addChildren=function(a){goog.isArray(a)||(a=[a]);for(var b=0,c=a.length;b<c;b++)this.childs_.push(a[b]),this.engineElement_.addChild(a[b].getEngineElement())};xrx.shape.Container.prototype.removeChildren=function(){this.childs_=[];this.engineElement_.removeChildren()};
xrx.shape.Container.prototype.removeChildAt=function(a){this.childs_.splice(a,1);this.engineElement_.removeChildAt(a)};xrx.shape.Group=function(a,b){xrx.shape.Container.call(this,a,b)};goog.inherits(xrx.shape.Group,xrx.shape.Container);xrx.shape.Group.prototype.draw=function(){this.startDrawing_();for(var a=this.getChildren(),b=0,c=a.length;b<c;b++)a[b].draw();this.finishDrawing_()};xrx.shape.Group.create=function(a){var b=a.getCanvas(),c=b.getEngine(),b=b.getEngineElement(),c=c.createGroup(b);return new xrx.shape.Group(a,c)};xrx.drawing.Layer=function(a){this.drawing_=a;this.locked_=!1;this.group_;this.shapes_=[];this.create_()};xrx.drawing.Layer.prototype.getDrawing=function(){return this.drawing_};xrx.drawing.Layer.prototype.setLocked=function(a){!0===a?this.locked_=!0:this.locked_=!1};xrx.drawing.Layer.prototype.isLocked=function(){return this.locked_};xrx.drawing.Layer.prototype.getGroup=function(){return this.group_};xrx.drawing.Layer.prototype.getShapes=function(){return this.shapes_};
...
goog.events.MouseWheelHandler.prototype.disposeInternal=function(){goog.events.MouseWheelHandler.superClass_.disposeInternal.call(this);goog.events.unlistenByKey(this.listenKey_);this.listenKey_=null};goog.events.MouseWheelEvent=function(a,b,c,d){goog.events.BrowserEvent.call(this,b);this.type=goog.events.MouseWheelHandler.EventType.MOUSEWHEEL;this.detail=a;this.deltaX=c;this.deltaY=d};goog.inherits(goog.events.MouseWheelEvent,goog.events.BrowserEvent);xrx.event={};xrx.event.Type=function(){};xrx.event.Type.CLICK=goog.userAgent.MOBILE?goog.events.EventType.TOUCHSTART:goog.events.EventType.CLICK;xrx.event.Type.DBLCLICK=goog.events.EventType.DBLCLICK;xrx.event.Type.DOWN=goog.userAgent.MOBILE?goog.events.EventType.TOUCHSTART:goog.events.EventType.MOUSEDOWN;xrx.event.Type.IN=goog.events.EventType.MOUSEOVER;
...
xrx.event.Type.UP=goog.userAgent.MOBILE?goog.events.EventType.TOUCHEND:goog.events.EventType.MOUSEUP;xrx.event.Type.WHEEL=goog.events.MouseWheelHandler.EventType.MOUSEWHEEL;xrx.drawing.Cursor=function(a){this.drawing_=a;this.needPoint_=!1;this.point=null;this.needPointTransformed_=!1;this.pointTransformed_=null;this.needShape_=!1;this.shape_=null;this.needShapes_=!1;this.shapes_=null};xrx.drawing.Cursor.prototype.getPoint=function(){return this.point_};xrx.drawing.Cursor.prototype.getPointTransformed=function(){return this.pointTransformed_};xrx.drawing.Cursor.prototype.getShape=function(){return this.shape_};xrx.drawing.Cursor.prototype.getShapes=function(){return this.shapes_};
xrx.drawing.Cursor.prototype.reset=function(){this.needShapes_=this.needShape_=this.needPointTransformed_=this.needPoint_=!1};xrx.drawing.Cursor.prototype.needPoint=function(){this.needPoint_=!0};xrx.drawing.Cursor.prototype.needPointTransformed=function(){this.needPointTransformed_=!0};xrx.drawing.Cursor.prototype.needShape=function(){this.needShape_=!0};xrx.drawing.Cursor.prototype.needShapes=function(){this.needShapes_=!0};
xrx.drawing.Cursor.prototype.calculatePoint_=function(a){this.needPoint_?this.point_=this.drawing_.getOffsetPoint(a):this.point_=null};xrx.drawing.Cursor.prototype.calculatePointTransformed_=function(a){null===this.point_&&this.calculatePoint_(a);this.needPointTransformed_?this.pointTransformed_=this.drawing_.getViewbox().getCTM().transformPoint(this.point_):this.pointTransformed_=null};
xrx.drawing.Cursor.prototype.calculateShape_=function(a){null===this.pointTransformed_&&this.calculatePointTransformed_(a);this.needShape_?this.shape_=this.drawing_.getShapeSelected(this.pointTransformed_):this.shape_=null};xrx.drawing.Cursor.prototype.calculateShapes_=function(a){null===this.pointTransformed_&&this.calculatePointTransformed_(a);this.needShapes_?this.shapes_=this.drawing_.getShapesSelected(this.pointTransformed_):this.shapes_=null};
xrx.drawing.Cursor.prototype.calculate=function(a){this.calculatePoint_(a);this.calculatePointTransformed_(a);this.calculateShape_(a);this.calculateShapes_(a)};xrx.event.Handler={CLICK:"handleClick",DBLCLICK:"handleDblClick",DOWN:"handleDown",IN:"handleIn",INPUT:"handleInput",MOVE:"handleMove",OUT:"handleOut",UP:"handleUp",WHEEL:"handleWheel"};xrx.geometry=function(){};xrx.geometry.addCoordsX=function(a,b){for(var c=0,d=a.length;c<d;c++)a[c][0]+=b};xrx.geometry.addCoordsY=function(a,b){for(var c=0,d=a.length;c<d;c++)a[c][1]+=b};xrx.geometry.getBBox=function(a){for(var b,c,d={x:a[0][0],y:a[0][1],x2:a[0][0],y2:a[0][1],width:0,height:0},e=1,f=a.length;e<f;e++)b=a[e][0],c=a[e][1],b<d.x&&(d.x=b),c<d.y&&(d.y=c),b>d.x2&&(d.x2=b),c>d.y2&&(d.y2=c);d.width=d.x2-d.x;d.height=d.y2-d.y;return d};xrx.geometry.Geometry=function(){};xrx.geometry.Rect=function(){xrx.geometry.Geometry.call(this);this.height=this.width=this.y=this.x=0};goog.inherits(xrx.geometry.Rect,xrx.geometry.Geometry);xrx.geometry.Rect.prototype.getBox=function(){return new goog.math.Box(this.y,this.x+this.width,this.y+this.height,this.x)};xrx.geometry.Rect.prototype.containsPoint=function(a){return a[0]>=this.x&&a[1]>=this.y&&a[0]<=this.x+this.width&&a[1]<=this.y+this.height};xrx.shape.Image=function(a,b){xrx.shape.Geometry.call(this,a,b,new xrx.geometry.Rect)};goog.inherits(xrx.shape.Image,xrx.shape.Geometry);xrx.shape.Image.prototype.getImage=function(){return this.image_};xrx.shape.Image.prototype.setImage=function(a){this.image_=a;this.geometry_.width=a.naturalWidth;this.geometry_.height=a.naturalHeight};xrx.shape.Image.prototype.getHeight=function(){return this.geometry_.height};xrx.shape.Image.prototype.getWidth=function(){return this.geometry_.width};
xrx.shape.Image.prototype.draw=function(){this.startDrawing_();this.image_&&this.engineElement_.draw(this.image_);this.finishDrawing_()};xrx.shape.Image.create=function(a){var b=a.getCanvas(),c=b.getEngine(),b=b.getEngineElement(),c=c.createImage(b);return new xrx.shape.Image(a,c)};xrx.shape.Modifiable=function(a){this.shape_=a;this.dragger_};xrx.shape.Modifiable.prototype.getShape=function(){return this.shape_};xrx.shape.Modifiable.prototype.getHelper=function(){return this.dragger_};xrx.shape.Modifiable.prototype.setDragger=function(a){this.dragger_=a};xrx.shape.Hoverable=function(a){xrx.shape.Stylable.call(this);this.shape_=a;this.store_=new xrx.shape.Stylable};goog.inherits(xrx.shape.Hoverable,xrx.shape.Stylable);xrx.shape.Hoverable.prototype.hoverOn=function(){this.store_.setStyle(this.shape_);this.shape_.setStyle(this)};xrx.shape.Hoverable.prototype.hoverOff=function(){this.shape_.setStyle(this.store_)};xrx.geometry.Ellipse=function(){xrx.geometry.Geometry.call(this);this.ry=this.rx=this.cy=this.cx=0};goog.inherits(xrx.geometry.Ellipse,xrx.geometry.Geometry);xrx.geometry.Ellipse.prototype.containsPoint=function(a){return 1>=(a[0]-this.cx)*(a[0]-this.cx)/(this.rx*this.rx)+(a[1]-this.cy)*(a[1]-this.cy)/(this.ry*this.ry)};xrx.shape.Creatable=function(a,b){this.target_=a;this.preview_=b};xrx.shape.Creatable.prototype.setEventHandler=function(a){this.eventHandler_=a};xrx.shape.Creatable.prototype.setFillColor=function(a){this.preview_.setFillColor(a)};xrx.shape.Creatable.prototype.setFillOpacity=function(a){this.preview_.setFillOpacity(a)};xrx.shape.Creatable.prototype.setStrokeColor=function(a){this.preview_.setStrokeColor(a)};xrx.shape.Creatable.prototype.setStrokeWidth=function(a){this.preview_.setStrokeWidth(a)};xrx.shape.Selectable=function(a){xrx.shape.Stylable.call(this);this.shape_=a;this.store_=new xrx.shape.Stylable};goog.inherits(xrx.shape.Selectable,xrx.shape.Stylable);xrx.shape.Selectable.prototype.selectOn=function(){this.store_.setStyle(this.shape_);this.shape_.setStyle(this)};xrx.shape.Selectable.prototype.selectOff=function(){this.shape_.setStyle(this.store_)};xrx.shape.Ellipse=function(a,b){xrx.shape.Geometry.call(this,a,b,new xrx.geometry.Ellipse)};goog.inherits(xrx.shape.Ellipse,xrx.shape.Geometry);xrx.shape.Ellipse.prototype.getCenter=function(){return[this.geometry_.cx,this.geometry_.cy]};xrx.shape.Ellipse.prototype.setCenter=function(a,b){this.geometry_.cx=a;this.geometry_.cy=b};xrx.shape.Ellipse.prototype.getRadiusX=function(){return this.geometry_.rx};xrx.shape.Ellipse.prototype.setRadiusX=function(a){this.geometry_.rx=a};
xrx.shape.Ellipse.prototype.getRadiusY=function(){return this.geometry_.ry};xrx.shape.Ellipse.prototype.setRadiusY=function(a){this.geometry_.ry=a};xrx.shape.Ellipse.prototype.getCoords=function(){return[this.getCenter()]};xrx.shape.Ellipse.prototype.setCoords=function(a){this.setCenter(a[0][0],a[0][1])};
xrx.shape.Ellipse.prototype.draw=function(){this.startDrawing_();var a=this.getCenter();this.engineElement_.draw(a[0],a[1],this.getRadiusX(),this.getRadiusY(),this.getFillColor(),this.getFillOpacity(),this.getStrokeColor(),this.getRenderingStrokeWidth());this.finishDrawing_()};xrx.shape.Ellipse.prototype.getHoverable=function(){this.hoverable_||(this.hoverable_=xrx.shape.EllipseHoverable.create(this));return this.hoverable_};
xrx.shape.Ellipse.prototype.setHoverable=function(a){if(!a instanceof xrx.shape.EllipseHoverable)throw Error("Instance of xrx.shape.EllipseHoverable expected.");this.hoverable_=a};xrx.shape.Ellipse.prototype.getSelectable=function(){this.selectable_||(this.selectable_=xrx.shape.EllipseSelectable.create(this));return this.selectable_};
xrx.shape.Ellipse.prototype.setSelectable=function(a){if(!a instanceof xrx.shape.EllipseSelectable)throw Error("Instance of xrx.shape.EllipseSelectable expected.");this.selectable_=a};xrx.shape.Ellipse.prototype.getModifiable=function(a){this.modifiable_||(this.modifiable_=xrx.shape.EllipseModifiable.create(this));return this.modifiable_};
xrx.shape.Ellipse.prototype.setModifiable=function(a){if(!a instanceof xrx.shape.EllipseModifiable)throw Error("Instance of xrx.shape.EllipseModifiable expected.");this.modifiable_=a};xrx.shape.Ellipse.prototype.getCreatable=function(){this.creatable_||(this.creatable_=xrx.shape.EllipseCreatable.create(this));return this.creatable_};
xrx.shape.Ellipse.prototype.setCreatable=function(a){if(!a instanceof xrx.shape.EllipseCreatable)throw Error("Instance of xrx.shape.EllipseCreatable expected.");this.creatable_=a};xrx.shape.Ellipse.create=function(a){var b=a.getCanvas(),c=b.getEngine(),b=b.getEngineElement(),c=c.createEllipse(b);return new xrx.shape.Ellipse(a,c)};xrx.shape.EllipseHoverable=function(a){xrx.shape.Hoverable.call(this,a)};goog.inherits(xrx.shape.EllipseHoverable,xrx.shape.Hoverable);
xrx.shape.EllipseHoverable.create=function(a){return new xrx.shape.EllipseHoverable(a)};xrx.shape.EllipseSelectable=function(a){xrx.shape.Selectable.call(this,a)};goog.inherits(xrx.shape.EllipseSelectable,xrx.shape.Selectable);xrx.shape.EllipseSelectable.create=function(a){return new xrx.shape.EllipseSelectable(a)};xrx.shape.EllipseModifiable=function(a){xrx.shape.Modifiable.call(this,a)};goog.inherits(xrx.shape.EllipseModifiable,xrx.shape.Modifiable);
xrx.shape.EllipseModifiable.prototype.setCoords=function(a){this.shape_.setCoords(a);this.dragger_[0].setCoordX(a[0][0]+this.shape_.getRadiusX());this.dragger_[0].setCoordY(a[0][1]);this.dragger_[1].setCoordX(a[0][0]);this.dragger_[1].setCoordY(a[0][1]+this.shape_.getRadiusY())};
...
xrx.shape.EllipseModifiable.create=function(a){var b=a.getCenter(),c=a.getRadiusX(),d=a.getRadiusY();a=new xrx.shape.EllipseModifiable(a);var e=xrx.shape.Dragger.create(a,0);e.setCoords([[b[0]+c,b[1]]]);c=xrx.shape.Dragger.create(a,1);c.setCoords([[b[0],b[1]+d]]);a.setDragger([e,c]);return a};xrx.shape.EllipseCreatable=function(a){xrx.shape.Creatable.call(this,a,xrx.shape.Ellipse.create(a.getDrawing()));this.point_=Array(2)};goog.inherits(xrx.shape.EllipseCreatable,xrx.shape.Creatable);
xrx.shape.EllipseCreatable.prototype.getCoords=function(){return this.helper_.getCoords()};xrx.shape.EllipseCreatable.prototype.handleDown=function(a,b){var c=b.getPointTransformed();this.point_[0]=c[0];this.point_[1]=c[1];this.preview_.setCenter(c[0],c[1]);this.target_.getDrawing().eventShapeCreate([this.preview_])};
...
xrx.shape.EllipseCreatable.prototype.handleUp=function(a,b){var c=xrx.shape.Ellipse.create(this.target_.getDrawing()),d=this.preview_.getCenter();c.setStyle(this.target_);c.setCenter(d[0],d[1]);c.setRadiusX(this.preview_.getRadiusX());c.setRadiusY(this.preview_.getRadiusY());this.target_.getDrawing().eventShapeCreated(c)};xrx.shape.EllipseCreatable.create=function(a){return new xrx.shape.EllipseCreatable(a)};xrx.geometry.Line=function(){xrx.geometry.Geometry.call(this);this.y2=this.x2=this.y1=this.x1=0;this.arr_=[[this.x1,this.y1],[this.x2,this.y2]]};goog.inherits(xrx.geometry.Line,xrx.geometry.Geometry);
xrx.geometry.Line.containsPoint=function(a,b){var c,d,e,f,g=a[0][0],h=a[0][1],k=a[1][0],l=a[1][1];g<k?(c=g,d=k):(c=k,d=g);h<l?(e=h,f=l):(e=l,f=h);if(b[0]<c||b[0]>d||b[1]<e||b[1]>f)return!1;if(7>Math.abs(g-k))return 7>Math.abs(b[0]-g);if(7>Math.abs(h-l))return 7>Math.abs(b[1]-h);c=(l-h)/(k-g);return 7>Math.abs(b[1]-(c*b[0]+(h-c*g)))};
xrx.geometry.Line.prototype.containsPoint=function(a){this.arr_[0][0]=this.x1;this.arr_[0][1]=this.y1;this.arr_[1][0]=this.x2;this.arr_[1][1]=this.y2;return xrx.geometry.Line.containsPoint(this.arr_,a)};xrx.geometry.Polyline=function(a){xrx.geometry.Geometry.call(this);this.coords=void 0===a?[]:Array(a);if(void 0!==a)for(var b=0;b<a;b++)this.coords[b]=Array(2)};goog.inherits(xrx.geometry.Polyline,xrx.geometry.Geometry);xrx.geometry.Polyline.prototype.containsPoint=function(a){for(var b=!1,c=0,d=this.coords.length-1;c<d&&(b=xrx.geometry.Line.containsPoint([this.coords[c],this.coords[c+1]],a),!0!==b);c++);return b};xrx.shape.PathLike=function(a,b,c){xrx.shape.Geometry.call(this,a,b,c)};goog.inherits(xrx.shape.PathLike,xrx.shape.Geometry);xrx.shape.PathLike.prototype.setCoords=function(a){this.geometry_.coords=a};xrx.shape.PathLike.prototype.getCoords=function(a){return this.geometry_.coords};xrx.shape.PathLike.prototype.setCoordAt=function(a,b){this.geometry_.coords[a][0]=b[0];this.geometry_.coords[a][1]=b[1]};xrx.shape.PathLike.prototype.setCoordXAt=function(a,b){this.geometry_.coords[a][0]=b};
xrx.shape.PathLike.prototype.setCoordYAt=function(a,b){this.geometry_.coords[a][1]=b};xrx.shape.PathLike.prototype.setLastCoord=function(a){var b=this.geometry_.coords.length-1;this.geometry_.coords[b][0]=a[0];this.geometry_.coords[b][1]=a[1]};xrx.shape.PathLike.prototype.appendCoord=function(a){this.geometry_.coords.push(a)};xrx.shape.Polyline=function(a,b){xrx.shape.PathLike.call(this,a,b,new xrx.geometry.Polyline)};goog.inherits(xrx.shape.Polyline,xrx.shape.PathLike);xrx.shape.Polyline.prototype.draw=function(){this.startDrawing_();this.engineElement_.draw(this.getCoords(),this.getFillColor(),this.getFillOpacity(),this.getStrokeColor(),this.getRenderingStrokeWidth());this.finishDrawing_()};
xrx.shape.Polyline.prototype.getHoverable=function(){this.hoverable_||(this.hoverable_=xrx.shape.PolylineHoverable.create(this));return this.hoverable_};xrx.shape.Polyline.prototype.setHoverable=function(a){if(!a instanceof xrx.shape.PolylineHoverable)throw Error("Instance of xrx.shape.PolylineHoverable expected.");this.hoverable_=a};xrx.shape.Polyline.prototype.getSelectable=function(){this.selectable_||(this.selectable_=xrx.shape.PolylineSelectable.create(this));return this.selectable_};
xrx.shape.Polyline.prototype.setSelectable=function(a){if(!a instanceof xrx.shape.PolylineSelectable)throw Error("Instance of xrx.shape.PolylineSelectable expected.");this.selectable_=a};xrx.shape.Polyline.prototype.getModifiable=function(a){this.modifiable_||(this.modifiable_=xrx.shape.PolylineModifiable.create(this));return this.modifiable_};
xrx.shape.Polyline.prototype.setModifiable=function(a){if(!a instanceof xrx.shape.PolylineModifiable)throw Error("Instance of xrx.shape.PolylineModifiable expected.");this.modifiable_=a};xrx.shape.Polyline.prototype.getCreatable=function(){this.creatable_||(this.creatable_=xrx.shape.PolylineCreatable.create(this));return this.creatable_};
xrx.shape.Polyline.prototype.setCreatable=function(a){if(!a instanceof xrx.shape.PolylineCreatable)throw Error("Instance of xrx.shape.PolylineCreatable expected.");this.creatable_=a};xrx.shape.Polyline.create=function(a){var b=a.getCanvas(),c=b.getEngine(),b=b.getEngineElement(),c=c.createPolyline(b);return new xrx.shape.Polyline(a,c)};xrx.shape.PolylineHoverable=function(a){xrx.shape.Hoverable.call(this,a)};goog.inherits(xrx.shape.PolylineHoverable,xrx.shape.Hoverable);
xrx.shape.PolylineHoverable.create=function(a){return new xrx.shape.PolylineHoverable(a)};xrx.shape.PolylineSelectable=function(a){xrx.shape.Selectable.call(this,a)};goog.inherits(xrx.shape.PolylineSelectable,xrx.shape.Selectable);xrx.shape.PolylineSelectable.create=function(a){return new xrx.shape.PolylineSelectable(a)};xrx.shape.PolylineModifiable=function(a,b){xrx.shape.Modifiable.call(this,a,b)};goog.inherits(xrx.shape.PolylineModifiable,xrx.shape.Modifiable);
...
xrx.shape.PolylineModifiable.create=function(a){var b=a.getCoords();a=new xrx.shape.PolylineModifiable(a);for(var c=[],d,e=0,f=b.length;e<f;e++)d=xrx.shape.Dragger.create(a,e),d.setCoords([b[e]]),c.push(d);a.setDragger(c);return a};xrx.shape.PolylineModifiable.prototype.move=function(a,b){for(var c=this.shape_.getCoordsCopy(),d=0,e=c.length;d<e;d++)c[d][0]+=a,c[d][1]+=b;this.setCoords(c)};
xrx.shape.PolylineCreatable=function(a){xrx.shape.Creatable.call(this,a,xrx.shape.Polyline.create(a.getDrawing()));this.count_=0};goog.inherits(xrx.shape.PolylineCreatable,xrx.shape.Creatable);xrx.shape.PolylineCreatable.prototype.getCoords=function(){return this.preview_.getCoords()};
xrx.shape.PolylineCreatable.prototype.handleDown=function(a,b){var c=b.getShape(),d=b.getPointTransformed();0===this.count_?(this.preview_.setCoords([d,goog.array.clone(d)]),this.count_+=1,this.target_.getDrawing().eventShapeCreate([this.preview_])):this.close_&&c===this.close_&&1===this.count_||(this.close_&&c===this.close_?(c=xrx.shape.Polyline.create(this.target_.getDrawing()),c.setStyle(this.target_),c.setCoords(this.preview_.getCoordsCopy().splice(0,this.count_)),this.target_.getDrawing().eventShapeCreated(c),
this.close_=null,this.count_=0):(this.preview_.appendCoord(d),1===this.count_&&(this.close_=xrx.shape.Dragger.create(this.target_.getModifiable(),0),this.target_.getDrawing().eventShapeCreate([this.close_])),this.close_.setCoords([d]),this.count_+=1))};
xrx.shape.PolylineCreatable.prototype.handleMove=function(a,b){var c=b.getShape(),d=b.getPointTransformed();0!==this.count_&&(this.preview_.setLastCoord(d),this.close_&&c===this.close_?(this.close_.setStrokeColor("red"),this.close_.setStrokeWidth(3)):this.close_&&(this.close_.setStrokeColor("black"),this.close_.setStrokeWidth(1)))};xrx.shape.PolylineCreatable.prototype.handleUp=function(a,b){};xrx.shape.PolylineCreatable.create=function(a){return new xrx.shape.PolylineCreatable(a)};xrx.geometry.Path=function(a){xrx.geometry.Geometry.call(this);this.coords=void 0===a?[]:Array(a);if(void 0!==a)for(var b=0;b<a;b++)this.coords[b]=Array(2)};goog.inherits(xrx.geometry.Path,xrx.geometry.Geometry);xrx.geometry.Path.prototype.containsPoint=function(a){var b=a[0];a=a[1];for(var c=this.coords,d,e,f=!1,g=0,h=c.length-1;g<c.length;h=g++)d=c[g][0],yi=c[g][1],e=c[h][0],yj=c[h][1],(d=yi>a!=yj>a&&b<(e-d)*(a-yi)/(yj-yi)+d)&&(f=!f);return f};xrx.geometry.Circle=function(){xrx.geometry.Geometry.call(this);this.r=this.cy=this.cx=0};goog.inherits(xrx.geometry.Circle,xrx.geometry.Geometry);xrx.geometry.Circle.prototype.containsPoint=function(a){return(this.cx-a[0])*(this.cx-a[0])+(this.cy-a[1])*(this.cy-a[1])<=this.r*this.r};xrx.shape.Circle=function(a,b){xrx.shape.Geometry.call(this,a,b,new xrx.geometry.Circle)};goog.inherits(xrx.shape.Circle,xrx.shape.Geometry);xrx.shape.Circle.prototype.getCenter=function(){return[this.geometry_.cx,this.geometry_.cy]};xrx.shape.Circle.prototype.setCenter=function(a,b){this.geometry_.cx=a;this.geometry_.cy=b};xrx.shape.Circle.prototype.getRadius=function(){return this.geometry_.r};xrx.shape.Circle.prototype.setRadius=function(a){this.geometry_.r=a};
xrx.shape.Circle.prototype.getCoords=function(){return[this.getCenter()]};xrx.shape.Circle.prototype.setCoords=function(a){this.setCenter(a[0][0],a[0][1])};xrx.shape.Circle.prototype.setCoordX=function(a){this.geometry_.cx=a};xrx.shape.Circle.prototype.setCoordY=function(a){this.geometry_.cy=a};
xrx.shape.Circle.prototype.draw=function(){this.startDrawing_();var a=this.getCenter();this.engineElement_.draw(a[0],a[1],this.getRadius(),this.getFillColor(),this.getFillOpacity(),this.getStrokeColor(),this.getRenderingStrokeWidth());this.finishDrawing_()};xrx.shape.Circle.prototype.getHoverable=function(){this.hoverable_||(this.hoverable_=xrx.shape.CircleHoverable.create(this));return this.hoverable_};
xrx.shape.Circle.prototype.setHoverable=function(a){if(!a instanceof xrx.shape.CircleHoverable)throw Error("Instance of xrx.shape.CircleHoverable expected.");this.hoverable_=a};xrx.shape.Circle.prototype.getSelectable=function(){this.selectable_||(this.selectable_=xrx.shape.CircleSelectable.create(this));return this.selectable_};
xrx.shape.Circle.prototype.setSelectable=function(a){if(!a instanceof xrx.shape.CircleSelectable)throw Error("Instance of xrx.shape.CircleSelectable expected.");this.selectable_=a};xrx.shape.Circle.prototype.getModifiable=function(){this.modifiable_||(this.modifiable_=xrx.shape.CircleModifiable.create(this));return this.modifiable_};
xrx.shape.Circle.prototype.setModifiable=function(a){if(!a instanceof xrx.shape.CircleModifiable)throw Error("Instance of xrx.shape.CircleModifiable expected.");this.modifiable_=a};xrx.shape.Circle.prototype.getCreatable=function(){this.creatable_||(this.creatable_=xrx.shape.CircleCreatable.create(this));return this.creatable_};
xrx.shape.Circle.prototype.setCreatable=function(a){if(!a instanceof xrx.shape.CircleCreatable)throw Error("Instance of xrx.shape.CircleCreatable expected.");this.creatable_=a};xrx.shape.Circle.create=function(a){var b=a.getCanvas(),c=b.getEngine(),b=b.getEngineElement(),c=c.createCircle(b);return new xrx.shape.Circle(a,c)};xrx.shape.CircleHoverable=function(a){xrx.shape.Hoverable.call(this,a)};goog.inherits(xrx.shape.CircleHoverable,xrx.shape.Hoverable);xrx.shape.CircleHoverable.create=function(a){return new xrx.shape.CircleHoverable(a)};
xrx.shape.CircleSelectable=function(a){xrx.shape.Selectable.call(this,a)};goog.inherits(xrx.shape.CircleSelectable,xrx.shape.Selectable);xrx.shape.CircleSelectable.create=function(a){return new xrx.shape.CircleSelectable(a)};xrx.shape.CircleModifiable=function(a){xrx.shape.Modifiable.call(this,a)};goog.inherits(xrx.shape.CircleModifiable,xrx.shape.Modifiable);
xrx.shape.CircleModifiable.prototype.setCoords=function(a){this.shape_.setCoords(a);this.dragger_[0].setCoordX(a[0][0]+this.shape_.getRadius());this.dragger_[0].setCoordY(a[0][1])};xrx.shape.CircleModifiable.prototype.setCoordAt=function(a,b){this.shape_.setRadius(Math.abs(b[0]-this.shape_.getCenter()[0]));this.dragger_[0].setCoordX(b[0])};xrx.shape.CircleModifiable.prototype.move=function(a,b){var c=this.shape_.getCoordsCopy();c[0][0]+=a;c[0][1]+=b;this.setCoords(c)};
xrx.shape.CircleModifiable.create=function(a){var b=a.getCenter(),c=a.getRadius();a=new xrx.shape.CircleModifiable(a);var d=xrx.shape.Dragger.create(a,0);d.setCoords([[b[0]+c,b[1]]]);a.setDragger([d]);return a};xrx.shape.CircleCreatable=function(a){xrx.shape.Creatable.call(this,a,xrx.shape.Circle.create(a.getDrawing()));this.point_=Array(2)};goog.inherits(xrx.shape.CircleCreatable,xrx.shape.Creatable);xrx.shape.CircleCreatable.prototype.getCoords=function(){return this.preview_.getCoords()};
xrx.shape.CircleCreatable.prototype.handleDown=function(a,b){var c=b.getPointTransformed();this.point_[0]=c[0];this.point_[1]=c[1];this.preview_.setCenter(c[0],c[1]);this.preview_.setRadius(0);this.target_.getDrawing().eventShapeCreate([this.preview_])};xrx.shape.CircleCreatable.prototype.handleMove=function(a,b){var c=b.getPointTransformed(),d=c[0]-this.point_[0],e=c[1]-this.point_[1];this.preview_.setCenter(c[0]-d/2,c[1]-e/2);this.preview_.setRadius(Math.sqrt(d*d+e*e)/2)};
xrx.shape.CircleCreatable.prototype.handleUp=function(a,b){b.getPointTransformed();var c=xrx.shape.Circle.create(this.target_.getDrawing()),d=this.preview_.getCenter();c.setStyle(this.target_);c.setCenter(d[0],d[1]);c.setRadius(this.preview_.getRadius());this.target_.getDrawing().eventShapeCreated(c)};xrx.shape.CircleCreatable.create=function(a){return new xrx.shape.CircleCreatable(a)};xrx.shape.Dragger=function(a,b){var c=a.getShape().getDrawing();xrx.shape.Circle.call(this,c,c.getEngine().createCircle(c.getCanvas().getEngineElement()));this.modifiable_=a;this.pos_=b};goog.inherits(xrx.shape.Dragger,xrx.shape.Circle);xrx.shape.Dragger.prototype.setCoord=function(a){this.modifiable_.setCoordAt(this.pos_,a)};xrx.shape.Dragger.prototype.getPosition=function(){return this.pos_};xrx.shape.Dragger.prototype.getRadius=function(){return this.geometry_.r/this.zoomFactor_};
xrx.shape.Dragger.create=function(a,b){var c=new xrx.shape.Dragger(a,b);c.setRadius(5);c.setStrokeColor("black");c.setStrokeWidth(1);c.setFillColor("white");c.setFillOpacity(1);return c};xrx.shape.Polygon=function(a,b){xrx.shape.PathLike.call(this,a,b,new xrx.geometry.Path)};goog.inherits(xrx.shape.Polygon,xrx.shape.PathLike);xrx.shape.Polygon.prototype.draw=function(){this.startDrawing_();this.engineElement_.draw(this.getCoords(),this.getFillColor(),this.getFillOpacity(),this.getStrokeColor(),this.getRenderingStrokeWidth());this.finishDrawing_()};xrx.shape.Polygon.prototype.getHoverable=function(){this.hoverable_||(this.hoverable_=xrx.shape.PolygonHoverable.create(this));return this.hoverable_};
xrx.shape.Polygon.prototype.setHoverable=function(a){if(!a instanceof xrx.shape.PolygonHoverable)throw Error("Instance of xrx.shape.PolygonHoverable expected.");this.hoverable_=a};xrx.shape.Polygon.prototype.getSelectable=function(){this.selectable_||(this.selectable_=xrx.shape.PolygonSelectable.create(this));return this.selectable_};
xrx.shape.Polygon.prototype.setSelectable=function(a){if(!a instanceof xrx.shape.PolygonSelectable)throw Error("Instance of xrx.shape.PolygonSelectable expected.");this.selectable_=a};xrx.shape.Polygon.prototype.getModifiable=function(a){this.modifiable_||(this.modifiable_=xrx.shape.PolygonModifiable.create(this));return this.modifiable_};
xrx.shape.Polygon.prototype.setModifiable=function(a){if(!a instanceof xrx.shape.PolygonModifiable)throw Error("Instance of xrx.shape.PolygonModifiable expected.");this.modifiable_=a};xrx.shape.Polygon.prototype.getCreatable=function(){this.creatable_||(this.creatable_=xrx.shape.PolygonCreatable.create(this));return this.creatable_};
xrx.shape.Polygon.prototype.setCreatable=function(a){if(!a instanceof xrx.shape.PolygonCreatable)throw Error("Instance of xrx.shape.PolygonCreatable expected.");this.creatable_=a};xrx.shape.Polygon.create=function(a){var b=a.getCanvas(),c=b.getEngine(),b=b.getEngineElement(),c=c.createPolygon(b);return new xrx.shape.Polygon(a,c)};xrx.shape.PolygonHoverable=function(a){xrx.shape.Hoverable.call(this,a)};goog.inherits(xrx.shape.PolygonHoverable,xrx.shape.Hoverable);
xrx.shape.PolygonHoverable.create=function(a){return new xrx.shape.PolygonHoverable(a)};xrx.shape.PolygonSelectable=function(a){xrx.shape.Selectable.call(this,a)};goog.inherits(xrx.shape.PolygonSelectable,xrx.shape.Selectable);xrx.shape.PolygonSelectable.create=function(a){return new xrx.shape.PolygonSelectable(a)};xrx.shape.PolygonModifiable=function(a,b){xrx.shape.Modifiable.call(this,a,b)};goog.inherits(xrx.shape.PolygonModifiable,xrx.shape.Modifiable);
...
xrx.shape.PolygonModifiable.prototype.move=function(a,b){for(var c=this.shape_.getCoordsCopy(),d=0,e=c.length;d<e;d++)c[d][0]+=a,c[d][1]+=b;this.setCoords(c)};xrx.shape.PolygonModifiable.create=function(a){var b=a.getCoords();a=new xrx.shape.PolygonModifiable(a);for(var c=[],d,e=0,f=b.length;e<f;e++)d=xrx.shape.Dragger.create(a,e),d.setCoords([b[e]]),c.push(d);a.setDragger(c);return a};
xrx.shape.PolygonCreatable=function(a){xrx.shape.Creatable.call(this,a,xrx.shape.Polyline.create(a.getDrawing()));this.count_=0};goog.inherits(xrx.shape.PolygonCreatable,xrx.shape.Creatable);xrx.shape.PolygonCreatable.prototype.getCoords=function(){return this.preview_.getCoords()};
xrx.shape.PolygonCreatable.prototype.handleDown=function(a,b){var c=b.getShape(),d=b.getPointTransformed();0===this.count_?(this.preview_.setCoords([d,goog.array.clone(d)]),this.close_=xrx.shape.Dragger.create(this.target_.getModifiable(),0),this.close_.setCoords([d]),this.count_+=1,this.target_.getDrawing().eventShapeCreate([this.preview_,this.close_])):this.close_&&c===this.close_&&1===this.count_||(this.close_&&c===this.close_?(c=xrx.shape.Polygon.create(this.target_.getDrawing()),c.setStyle(this.target_),
c.setCoords(this.preview_.getCoordsCopy().splice(0,this.count_)),this.target_.getDrawing().eventShapeCreated(c),this.close_=null,this.count_=0):(this.preview_.setLastCoord(d),this.preview_.appendCoord(d),this.count_+=1))};xrx.shape.PolygonCreatable.prototype.handleMove=function(a,b){var c=b.getShape(),d=b.getPointTransformed();0!==this.count_&&(this.preview_.setLastCoord(d),c===this.close_?(this.close_.setStrokeColor("red"),this.close_.setStrokeWidth(3)):(this.close_.setStrokeColor("black"),this.close_.setStrokeWidth(1)))};
xrx.shape.PolygonCreatable.prototype.handleUp=function(){};xrx.shape.PolygonCreatable.create=function(a){return new xrx.shape.PolygonCreatable(a)};xrx.shape.Line=function(a,b){xrx.shape.Geometry.call(this,a,b,new xrx.geometry.Line)};goog.inherits(xrx.shape.Line,xrx.shape.Geometry);xrx.shape.Line.prototype.getX1=function(){return this.geometry_.x1};xrx.shape.Line.prototype.setX1=function(a){this.geometry_.x1=a};xrx.shape.Line.prototype.getY1=function(){return this.geometry_.y1};xrx.shape.Line.prototype.setY1=function(a){this.geometry_.y1=a};xrx.shape.Line.prototype.getX2=function(){return this.geometry_.x2};
...
xrx.shape.Line.prototype.draw=function(){this.startDrawing_();this.engineElement_.draw(this.geometry_.x1,this.geometry_.y1,this.geometry_.x2,this.geometry_.y2,this.getStrokeColor(),this.getRenderingStrokeWidth());this.finishDrawing_()};xrx.shape.Line.prototype.getHoverable=function(){this.hoverable_||(this.hoverable_=xrx.shape.LineHoverable.create(this));return this.hoverable_};
xrx.shape.Line.prototype.setHoverable=function(a){if(!a instanceof xrx.shape.LineHoverable)throw Error("Instance of xrx.shape.LineHoverable expected.");this.hoverable_=a};xrx.shape.Line.prototype.getSelectable=function(){this.selectable_||(this.selectable_=xrx.shape.LineSelectable.create(this));return this.selectable_};xrx.shape.Line.prototype.setSelectable=function(a){if(!a instanceof xrx.shape.LineSelectable)throw Error("Instance of xrx.shape.LineSelectable expected.");this.selectable_=a};
xrx.shape.Line.prototype.getModifiable=function(a){this.modifiable_||(this.modifiable_=xrx.shape.LineModifiable.create(this));return this.modifiable_};xrx.shape.Line.prototype.setModifiable=function(a){if(!a instanceof xrx.shape.LineModifiable)throw Error("Instance of xrx.shape.LineModifiable expected.");this.modifiable_=a};xrx.shape.Line.prototype.getCreatable=function(){this.creatable_||(this.creatable_=xrx.shape.LineCreatable.create(this));return this.creatable_};
xrx.shape.Line.prototype.setCreatable=function(a){if(!a instanceof xrx.shape.LineCreatable)throw Error("Instance of xrx.shape.LineCreatable expected.");this.creatable_=a};xrx.shape.Line.create=function(a){var b=a.getCanvas(),c=b.getEngine(),b=b.getEngineElement(),c=c.createLine(b);return new xrx.shape.Line(a,c)};xrx.shape.LineHoverable=function(a){xrx.shape.Hoverable.call(this,a)};goog.inherits(xrx.shape.LineHoverable,xrx.shape.Hoverable);xrx.shape.LineHoverable.create=function(a){return new xrx.shape.LineHoverable(a)};
xrx.shape.LineSelectable=function(a){xrx.shape.Selectable.call(this,a)};goog.inherits(xrx.shape.LineSelectable,xrx.shape.Selectable);xrx.shape.LineSelectable.create=function(a){return new xrx.shape.LineSelectable(a)};xrx.shape.LineModifiable=function(a,b){xrx.shape.Modifiable.call(this,a,b)};goog.inherits(xrx.shape.LineModifiable,xrx.shape.Modifiable);
xrx.shape.LineModifiable.prototype.setCoords=function(a){this.shape_.setCoords(a);this.dragger_[0].setCoordX(a[0][0]);this.dragger_[0].setCoordY(a[0][1]);this.dragger_[1].setCoordX(a[1][0]);this.dragger_[1].setCoordY(a[1][1])};xrx.shape.LineModifiable.prototype.setCoordAt=function(a,b){0===a?(this.dragger_[0].setCoordX(b[0]),this.dragger_[0].setCoordY(b[1]),this.shape_.setX1(b[0]),this.shape_.setY1(b[1])):(this.dragger_[1].setCoordX(b[0]),this.dragger_[1].setCoordY(b[1]),this.shape_.setX2(b[0]),this.shape_.setY2(b[1]))};
xrx.shape.LineModifiable.prototype.move=function(a,b){var c=this.shape_.getCoordsCopy();c[0][0]+=a;c[0][1]+=b;c[1][0]+=a;c[1][1]+=b;this.setCoords(c)};xrx.shape.LineModifiable.create=function(a){var b=new xrx.shape.LineModifiable(a),c=xrx.shape.Dragger.create(b,0);c.setCoords([[a.getX1(),a.getY1()]]);var d=xrx.shape.Dragger.create(b,1);d.setCoords([[a.getX2(),a.getY2()]]);b.setDragger([c,d]);return b};xrx.shape.LineCreatable=function(a){xrx.shape.Creatable.call(this,a,xrx.shape.Line.create(a.getDrawing()))};
goog.inherits(xrx.shape.LineCreatable,xrx.shape.Creatable);xrx.shape.LineCreatable.prototype.getCoords=function(){return this.helper_.getCoords()};xrx.shape.LineCreatable.prototype.handleDown=function(a,b){var c=b.getPointTransformed();this.preview_.setX1(c[0]);this.preview_.setY1(c[1]);this.target_.getDrawing().eventShapeCreate([this.preview_])};xrx.shape.LineCreatable.prototype.handleMove=function(a,b){var c=b.getPointTransformed();this.preview_.setX2(c[0]);this.preview_.setY2(c[1])};
xrx.shape.LineCreatable.prototype.handleUp=function(a,b){var c=b.getPointTransformed(),d=xrx.shape.Line.create(this.target_.getDrawing());d.setStyle(this.target_);d.setX1(this.preview_.getX1());d.setY1(this.preview_.getY1());d.setX2(c[0]);d.setY2(c[1]);this.target_.getDrawing().eventShapeCreated(d)};xrx.shape.LineCreatable.create=function(a){return new xrx.shape.LineCreatable(a)};xrx.shape.Rect=function(a,b){xrx.shape.PathLike.call(this,a,b,new xrx.geometry.Path(4))};goog.inherits(xrx.shape.Rect,xrx.shape.PathLike);xrx.shape.Rect.prototype.setX=function(a){this.geometry_.coords[0][0]=a;this.geometry_.coords[3][0]=a};xrx.shape.Rect.prototype.getX=function(){return this.geometry_.coords[0][0]};xrx.shape.Rect.prototype.setY=function(a){this.geometry_.coords[0][1]=a;this.geometry_.coords[1][1]=a};xrx.shape.Rect.prototype.getY=function(){return this.geometry_.coords[0][1]};
xrx.shape.Rect.prototype.setWidth=function(a){var b=this.geometry_.coords[0][0];this.geometry_.coords[1][0]=b+a;this.geometry_.coords[2][0]=b+a};xrx.shape.Rect.prototype.getWidth=function(){var a=this.geometry_.coords;return a[1][0]-a[0][0]};xrx.shape.Rect.prototype.setHeight=function(a){var b=this.geometry_.coords[0][1];this.geometry_.coords[2][1]=b+a;this.geometry_.coords[3][1]=b+a};xrx.shape.Rect.prototype.getHeight=function(){var a=this.geometry_.coords;return a[3][1]-a[0][1]};
xrx.shape.Rect.prototype.setAffineCoords=function(a){var b=this.getCoords();0===a||2===a?(b[1][0]=b[2][0],b[1][1]=b[0][1],b[3][0]=b[0][0],b[3][1]=b[2][1]):(b[0][0]=b[3][0],b[0][1]=b[1][1],b[2][0]=b[1][0],b[2][1]=b[3][1]);return b};xrx.shape.Rect.prototype.draw=function(){this.startDrawing_();this.engineElement_.draw(this.getCoords(),this.getFillColor(),this.getFillOpacity(),this.getStrokeColor(),this.getRenderingStrokeWidth());this.finishDrawing_()};
xrx.shape.Rect.prototype.getHoverable=function(){this.hoverable_||(this.hoverable_=xrx.shape.RectHoverable.create(this));return this.hoverable_};xrx.shape.Rect.prototype.setHoverable=function(a){if(!a instanceof xrx.shape.RectHoverable)throw Error("Instance of xrx.shape.RectHoverable expected.");this.hoverable_=a};xrx.shape.Rect.prototype.getSelectable=function(){this.selectable_||(this.selectable_=xrx.shape.RectSelectable.create(this));return this.selectable_};
xrx.shape.Rect.prototype.setSelectable=function(a){if(!a instanceof xrx.shape.RectSelectable)throw Error("Instance of xrx.shape.RectSelectable expected.");this.selectable_=a};xrx.shape.Rect.prototype.getModifiable=function(a){this.modifiable_||(this.modifiable_=xrx.shape.RectModifiable.create(this));return this.modifiable_};xrx.shape.Rect.prototype.setModifiable=function(a){if(!a instanceof xrx.shape.RectModifiable)throw Error("Instance of xrx.shape.RectModifiable expected.");this.modifiable_=a};
xrx.shape.Rect.prototype.getCreatable=function(){this.creatable_||(this.creatable_=xrx.shape.RectCreatable.create(this));return this.creatable_};xrx.shape.Rect.prototype.setCreatable=function(a){if(!a instanceof xrx.shape.RectCreatable)throw Error("Instance of xrx.shape.RectCreatable expected.");this.creatable_=a};xrx.shape.Rect.create=function(a){var b=a.getCanvas(),c=b.getEngine(),b=b.getEngineElement(),c=c.createRect(b);return new xrx.shape.Rect(a,c)};
xrx.shape.RectHoverable=function(a){xrx.shape.Hoverable.call(this,a)};goog.inherits(xrx.shape.RectHoverable,xrx.shape.Hoverable);xrx.shape.RectHoverable.create=function(a){return new xrx.shape.RectHoverable(a)};xrx.shape.RectSelectable=function(a){xrx.shape.Selectable.call(this,a)};goog.inherits(xrx.shape.RectSelectable,xrx.shape.Selectable);xrx.shape.RectSelectable.create=function(a){return new xrx.shape.RectSelectable(a)};xrx.shape.RectModifiable=function(a,b){xrx.shape.Modifiable.call(this,a,b)};
goog.inherits(xrx.shape.RectModifiable,xrx.shape.Modifiable);xrx.shape.RectModifiable.prototype.setCoords=function(a,b){for(var c=0,d=this.dragger_.length;c<d;c++)c!==b&&(this.dragger_[c].setCoordX(a[c][0]),this.dragger_[c].setCoordY(a[c][1]));this.shape_.setCoords(a)};
...
xrx.shape.RectModifiable.prototype.move=function(a,b){for(var c=this.shape_.getCoordsCopy(),d=0,e=c.length;d<e;d++)c[d][0]+=a,c[d][1]+=b;this.setCoords(c)};xrx.shape.RectModifiable.create=function(a){for(var b=a.getCoords(),c=[],d=new xrx.shape.RectModifiable(a),e=0,f=b.length;e<f;e++)a=xrx.shape.Dragger.create(d,e),a.setCoords([b[e]]),c.push(a);d.setDragger(c);return d};xrx.shape.RectCreatable=function(a){xrx.shape.Creatable.call(this,a,xrx.shape.Rect.create(a.getDrawing()))};
goog.inherits(xrx.shape.RectCreatable,xrx.shape.Creatable);xrx.shape.RectCreatable.prototype.getCoords=function(){return this.preview_.getCoords()};xrx.shape.RectCreatable.prototype.handleDown=function(a,b){var c=b.getPointTransformed(),d=Array(4);d[0]=goog.array.clone(c);d[1]=goog.array.clone(c);d[2]=goog.array.clone(c);d[3]=goog.array.clone(c);this.preview_.setCoords(d);this.target_.getDrawing().eventShapeCreate([this.preview_])};
xrx.shape.RectCreatable.prototype.handleMove=function(a,b){var c=b.getPointTransformed();this.preview_.setCoordAt(2,c);this.preview_.setAffineCoords(2)};xrx.shape.RectCreatable.prototype.handleUp=function(a,b){var c=xrx.shape.Rect.create(this.target_.getDrawing());c.setStyle(this.target_);c.setCoords(this.preview_.getCoordsCopy());this.target_.getDrawing().eventShapeCreated(c)};xrx.shape.RectCreatable.create=function(a){return new xrx.shape.RectCreatable(a)};xrx.shape.Canvas=function(a,b){xrx.shape.Container.call(this,a,b)};goog.inherits(xrx.shape.Canvas,xrx.shape.Container);xrx.shape.Canvas.prototype.getElement=function(){return this.drawing_.getElement()};xrx.shape.Canvas.prototype.getEngine=function(){return this.drawing_.getEngine()};xrx.shape.Canvas.prototype.getHeight=function(){return this.engineElement_.getHeight()};xrx.shape.Canvas.prototype.setHeight=function(a){this.engineElement_.setHeight(a)};xrx.shape.Canvas.prototype.getWidth=function(){return this.engineElement_.getWidth()};
xrx.shape.Canvas.prototype.setWidth=function(a){this.engineElement_.setWidth(a)};xrx.shape.Canvas.prototype.draw=function(){this.startDrawing_();for(var a=0,b=this.childs_.length;a<b;a++)this.childs_[a].draw();this.finishDrawing_()};xrx.shape.Canvas.create=function(a){var b=a.getElement(),b=a.getEngine().createCanvas(b);return new xrx.shape.Canvas(a,b)};xrx.shape.Shapes=function(){};xrx.event.HandlerTarget=function(){this.handler_=new goog.events.EventHandler(this);this.cursor_=new xrx.drawing.Cursor(this)};xrx.event.HandlerTarget.prototype.getHandler=function(){return this.handler_};xrx.event.HandlerTarget.prototype.registerEvent_=function(a,b,c){this.cursor_.calculate(a);a.preventDefault();a.stopPropagation();a.getBrowserEvent().changedTouches&&a.init(a.getBrowserEvent().changedTouches[0],a.currentTarget);b[c](a,this.cursor_);this.draw()};
xrx.event.HandlerTarget.prototype.registerClick=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.CLICK,function(c){b.registerEvent_(c,a,xrx.event.Handler.CLICK)},!1)};xrx.event.HandlerTarget.prototype.registerDblClick=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.DBLCLICK,function(c){b.registerEvent_(c,a,xrx.event.Handler.DBLCLICK)},!1)};
xrx.event.HandlerTarget.prototype.registerDown=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.DOWN,function(c){b.registerEvent_(c,a,xrx.event.Handler.DOWN)},!1)};xrx.event.HandlerTarget.prototype.registerDrag=function(a){this.registerDown(a);this.registerMove(a);this.registerUp(a)};
xrx.event.HandlerTarget.prototype.registerMove=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.MOVE,function(c){b.registerEvent_(c,a,xrx.event.Handler.MOVE)},!1)};xrx.event.HandlerTarget.prototype.registerHover=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.MOVE,function(c){b.registerEvent_(c,a,xrx.event.Handler.MOVE)},!1)};
xrx.event.HandlerTarget.prototype.registerOut=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.OUT,function(c){b.registerEvent_(c,a,xrx.event.Handler.OUT)},!1)};xrx.event.HandlerTarget.prototype.registerUp=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.UP,function(c){b.registerEvent_(c,a,xrx.event.Handler.UP)},!1)};
xrx.event.HandlerTarget.prototype.registerWheel=function(a){if(!goog.userAgent.MOBILE){var b=this,c=new goog.events.MouseWheelHandler(b.canvas_.getEngineElement().getEventTarget());this.handler_.listen(c,xrx.event.Type.WHEEL,function(c){b.registerEvent_(c,a,xrx.event.Handler.WHEEL)},!1)}};xrx.event.HandlerTarget.prototype.disposeInternal=function(){this.handler_&&(this.handler_.dispose(),this.handler_=null)};
xrx.event.HandlerTarget.prototype.registerEvents=function(a){this.handler_.removeAll();this.cursor_.reset();switch(a){case void 0:case xrx.drawing.Mode.DISABLED:break;case xrx.drawing.Mode.VIEW:this.cursor_.needPoint();this.cursor_.needPointTransformed();this.registerDblClick(this.viewbox_);this.registerDrag(this.viewbox_);this.registerOut(this.viewbox_);this.registerWheel(this.viewbox_);break;case xrx.drawing.Mode.SELECT:this.cursor_.needPoint();this.cursor_.needPointTransformed();this.cursor_.needShape();
this.registerDown(this.selectable_);this.registerWheel(this.viewbox_);break;case xrx.drawing.Mode.MODIFY:this.cursor_.needPoint();this.cursor_.needPointTransformed();this.cursor_.needShape();this.registerDrag(this.modifiable_);this.registerWheel(this.viewbox_);break;case xrx.drawing.Mode.CREATE:this.cursor_.needPoint();this.cursor_.needPointTransformed();this.cursor_.needShape();this.registerDown(this.create_);this.registerMove(this.create_);this.registerUp(this.create_);this.registerWheel(this.viewbox_);
break;case xrx.drawing.Mode.HOVER:this.cursor_.needPoint();this.cursor_.needPointTransformed();this.cursor_.needShape();this.registerHover(this.hoverable_);this.registerOut(this.hoverable_);this.registerWheel(this.viewbox_);this.registerDrag(this.viewbox_);break;case xrx.drawing.Mode.HOVERMULTIPLE:this.cursor_.needPoint();this.cursor_.needPointTransformed();this.cursor_.needShapes();this.registerHover(this.hoverable_);this.registerOut(this.hoverable_);this.registerWheel(this.viewbox_);this.registerDrag(this.viewbox_);
break;default:throw Error("Unknown mode.");}};xrx.drawing.EventHandler=function(){xrx.event.HandlerTarget.call(this)};goog.inherits(xrx.drawing.EventHandler,xrx.event.HandlerTarget);xrx.drawing.EventHandler.prototype.eventShapeCreate=function(a){this.getLayerShapeCreate().addShapes(a);this.draw()};xrx.drawing.EventHandler.prototype.eventShapeCreated=function(a){this.getLayerShape().addShapes(a);this.getLayerShapeCreate().removeShapes();this.draw()};
...
goog.net.ImageLoader.prototype.disposeInternal=function(){delete this.imageIdToRequestMap_;delete this.imageIdToImageMap_;goog.dispose(this.handler_);goog.net.ImageLoader.superClass_.disposeInternal.call(this)};xrx.EventTarget=function(){};xrx.EventTarget.prototype.dispatchExternal=function(a,b){if(!goog.string.startsWith(a,"event"))throw Error('Invalid event-type "". Prefix "event*" expected.');var c;void 0!==b?c=b:c=this;c[a]&&(2>=arguments.length?c[a].apply(c):c[a].apply(c,this.argsArray_(arguments)))};xrx.EventTarget.prototype.argsArray_=function(a){for(var b=a.length-2,c=Array(b),d=0;d<b;d++)c[d]=a[d+2];return c};xrx.geometry.Box=function(){xrx.geometry.Geometry.call(this)};goog.inherits(xrx.geometry.Box,xrx.geometry.Geometry);xrx.geometry.Box.containsPoint=function(a,b){return b[0]>=a[3]&&b[0]<=a[1]&&b[1]>=a[0]&&b[1]<=a[2]};xrx.geometry.Point=function(){xrx.geometry.Geometry.call(this)};goog.inherits(xrx.geometry.Point,xrx.geometry.Geometry);xrx.geometry.Point.distancePoint=function(a,b){var c=a[0]-b[0],d=a[1]-b[1];return Math.sqrt(c*c+d*d)};xrx.viewbox={};xrx.viewbox.ViewboxGeometry=function(){this.testPoint_=Array(2)};goog.inherits(xrx.viewbox.ViewboxGeometry,xrx.EventTarget);xrx.viewbox.ViewboxGeometry.prototype.getWidth=function(a,b){if(!0===b&&this.isHorizontal())return this.getHeight(a);var c=this.getDrawing().getLayerBackground().getImage().getWidth();return a?c*this.ctm_.getScale():c};
xrx.viewbox.ViewboxGeometry.prototype.getHeight=function(a,b){if(!0===b&&this.isHorizontal())return this.getWidth(a);var c=this.getDrawing().getLayerBackground().getImage().getHeight();return a?c*this.ctm_.getScale():c};
xrx.viewbox.ViewboxGeometry.prototype.getBox=function(){var a=this.getRotation(),b=Array(4),c=this.getDrawing().getLayerBackground().getImage(),d=c.getWidth(),c=c.getHeight();this.ctm_.transform([0,0,d,c],0,b,0,4);return 0===a?[b[1],b[2],b[3],b[0]]:90===a?[b[2],b[3],b[0],b[1]]:180===a?[b[3],b[0],b[1],b[2]]:[b[0],b[1],b[2],b[3]]};xrx.viewbox.ViewboxGeometry.prototype.containsPoint=function(a){var b=this.getBox();return xrx.geometry.Box.containsPoint(b,a)};
xrx.viewbox.ViewboxGeometry.prototype.getCenterPoint_=function(a){var b=this.getDrawing().getLayerBackground().getImage(),b=[b.getWidth()/2,b.getHeight()/2];if(!0!==a)return b;a=Array(2);this.ctm_.transform(b,0,a,0,1);return a};xrx.viewbox.ViewboxGeometry.prototype.getVisibleOrientation_=function(a){var b=["NW","SW","SE","NE"];a=goog.array.indexOf(b,a);var c=this.getRotation()/90;return b[(a+c)%4]};xrx.viewbox.ViewboxGeometry.prototype.FixPoints_={C:[0,0],NE:[0,0],SE:[0,0],SW:[0,0],NW:[0,0]};
xrx.viewbox.ViewboxGeometry.prototype.getFixPoints_=function(){var a=this.getDrawing().getLayerBackground().getImage(),b=a.getWidth(),a=a.getHeight();this.FixPoints_.C=[b/2,a/2];this.FixPoints_.NE=[b,0];this.FixPoints_.SE=[b,a];this.FixPoints_.SW=[0,a];this.FixPoints_.NW=[0,0];return this.FixPoints_};xrx.viewbox.ViewboxGeometry.prototype.getFixPoint_=function(a,b,c){var d=this.getFixPoints_();a=c?d[this.getVisibleOrientation_(a)]:d[a];return!0===b?(b=Array(2),this.ctm_.transform(a,0,b,0,1),b):a};xrx.viewbox.ViewboxRotate=function(){xrx.viewbox.ViewboxGeometry.call(this)};goog.inherits(xrx.viewbox.ViewboxRotate,xrx.viewbox.ViewboxGeometry);xrx.viewbox.ViewboxRotate.prototype.getRotation=function(){return this.ctm_.getRotation()};xrx.viewbox.ViewboxRotate.prototype.isValidRotation=function(a){a=Math.abs(a);return 0===a||90===a||180===a||270===a};xrx.viewbox.ViewboxRotate.prototype.isVertical=function(){var a=this.ctm_.getRotation();return 0===a||180===a};
...
xrx.viewbox.ViewboxRotate.prototype.rotateBy=function(a,b){if(void 0===b)this.rotateBy_(a,void 0,void 0);else if(this.isFixPoint_(b))this.rotateBy_(a,void 0,b);else if(this.isOrientation_(b))this.rotateBy_(a,b,void 0);else throw Error("Invalid fix-point. Array[2] or xrx.drawing.Orientation.* expected.");};xrx.viewbox.ViewboxRotate.prototype.rotateLeft=function(a){this.rotateBy(-90,a)};xrx.viewbox.ViewboxRotate.prototype.rotateRight=function(a){this.rotateBy(90,a)};
...
xrx.viewbox.ViewboxZoom.prototype.zoomTo=function(a,b){var c;c=void 0!==b?this.containsPoint(b)?b:this.getCenterPoint_(!0):this.getCenterPoint_(!0);a<this.zoomMin_&&(a=this.zoomMin_);a>this.zoomMax_&&(a=this.zoomMax_);var d=1/this.getZoomValue()*a;this.zoomOffset_(c,d);this.ctm_.scale(d,d);this.dispatchExternal(xrx.drawing.EventType.VIEWBOX_CHANGE,this.drawing_)};xrx.viewbox.ViewboxZoom.prototype.zoomIn=function(a){this.zoomTo(this.ctm_.getScale()+this.zoomFactor_,a)};
xrx.viewbox.ViewboxZoom.prototype.zoomOut=function(a){this.zoomTo(this.ctm_.getScale()-this.zoomFactor_,a)};xrx.viewbox.ViewboxTranslate=function(){xrx.viewbox.ViewboxZoom.call(this)};goog.inherits(xrx.viewbox.ViewboxTranslate,xrx.viewbox.ViewboxZoom);xrx.viewbox.ViewboxTranslate.prototype.translate=function(a,b){var c=this.ctm_.getIdentity(),d=c.transformPoint([a,b]);this.ctm_=c.translate(d[0],d[1]).concatenate(this.ctm_);this.dispatchExternal(xrx.drawing.EventType.VIEWBOX_CHANGE,this.drawing_)};xrx.viewbox.ViewboxTranslate.prototype.center=function(){this.centerHorizontally();this.centerVertically()};
xrx.viewbox.ViewboxTranslate.prototype.centerHorizontally=function(){var a=this.getFixPoint_(xrx.drawing.Orientation.NW,!0,!0),b=this.getWidth(!0,!0),a=this.getDrawing().getWidth()/2-(a[0]+b/2);this.translate(a,0);this.dispatchExternal(xrx.drawing.EventType.VIEWBOX_CHANGE,this.drawing_)};
xrx.viewbox.ViewboxTranslate.prototype.centerVertically=function(){var a=this.getFixPoint_(xrx.drawing.Orientation.NW,!0,!0),b=this.getHeight(!0,!0),a=this.getDrawing().getHeight()/2-(a[1]+b/2);this.translate(0,a);this.dispatchExternal(xrx.drawing.EventType.VIEWBOX_CHANGE,this.drawing_)};xrx.drawing.FastAffineTransform=function(){goog.math.AffineTransform.call(this);this.identity_;this.inverse_;this.clone_};goog.inherits(xrx.drawing.FastAffineTransform,goog.math.AffineTransform);xrx.drawing.FastAffineTransform.prototype.getIdentity=function(){this.identity_||(this.identity_=new xrx.drawing.FastAffineTransform);this.identity_.setTransform(1,0,0,1,0,0);return this.identity_};
xrx.drawing.FastAffineTransform.prototype.getInverse=function(){this.inverse_||(this.inverse_=new xrx.drawing.FastAffineTransform);var a=this.getDeterminant();this.inverse_.setTransform(this.m11_/a,-this.m10_/a,-this.m01_/a,this.m00_/a,(this.m01_*this.m12_-this.m11_*this.m02_)/a,(this.m10_*this.m02_-this.m00_*this.m12_)/a);return this.inverse_};xrx.drawing.FastAffineTransform.prototype.getClone=function(){this.clone_||(this.clone_=new xrx.drawing.FastAffineTransform);return this.clone_.copyFrom(this)};
xrx.drawing.FastAffineTransform.prototype.transformPoint=function(a,b){var c=void 0!==b?b:Array(2);this.createInverse().transform(a,0,c,0,1);return c};xrx.drawing.FastAffineTransform.prototype.getScale=function(){var a=this.getRotation();this.getClone().rotate(goog.math.toRadians(360-a));return this.clone_.getScaleX()};xrx.drawing.FastAffineTransform.prototype.getRotation=function(){return{0:0,2:90,3:180,"-2":270}[Math.round(Math.atan2(this.getShearY(),this.getScaleY()))]};xrx.viewbox.ViewboxTransform=function(){this.ctm_=new xrx.drawing.FastAffineTransform;xrx.viewbox.ViewboxTranslate.call(this)};goog.inherits(xrx.viewbox.ViewboxTransform,xrx.viewbox.ViewboxTranslate);xrx.viewbox.ViewboxTransform.prototype.getCTM=function(){return this.ctm_};xrx.viewbox.ViewboxTransform.prototype.setCTM=function(a){this.ctm_=a};xrx.viewbox.ViewboxTransform.prototype.ctmDump=function(){return[this.ctm_.m00_,this.ctm_.m10_,this.ctm_.m01_,this.ctm_.m11_,this.ctm_.m02_,this.ctm_.m12_]};
xrx.viewbox.ViewboxTransform.prototype.ctmRestore=function(a){if(6!==a.length)throw Error("Invalid CTM dump.");this.ctm_.setTransform(a[0],a[1],a[2],a[3],a[4],a[5])};xrx.viewbox.ViewboxTransform.prototype.fitToWidth=function(){var a=this.getWidth(!0,!0),a=this.drawing_.getCanvas().getWidth()/a;this.ctm_.scale(a,a);this.dispatchExternal(xrx.drawing.EventType.VIEWBOX_CHANGE,this.drawing_)};
xrx.viewbox.ViewboxTransform.prototype.fitToHeight=function(){var a=this.getHeight(!0,!0),a=this.drawing_.getCanvas().getHeight()/a;this.ctm_.scale(a,a);this.dispatchExternal(xrx.drawing.EventType.VIEWBOX_CHANGE,this.drawing_)};xrx.viewbox.ViewboxTransform.prototype.fit=function(a){var b=this.getWidth(!0,!0),c=this.getHeight(!0,!0);b>c?this.fitToWidth():this.fitToHeight();!0===a&&this.center()};xrx.viewbox.Viewbox=function(a){xrx.viewbox.ViewboxTransform.call(this);this.drawing_=a;this.group_=xrx.shape.Group.create(this.drawing_);this.state_=xrx.drawing.State.NONE};goog.inherits(xrx.viewbox.Viewbox,xrx.viewbox.ViewboxTransform);xrx.viewbox.Viewbox.prototype.getDrawing=function(){return this.drawing_};xrx.viewbox.Viewbox.prototype.getGroup=function(){return this.group_};xrx.viewbox.Viewbox.prototype.handleDblClick=function(a,b){this.rotateRight(b.getPointTransformed())};
...
xrx.viewbox.Viewbox.prototype.handleWheel=function(a,b){0>a.deltaY?this.zoomIn(b.getPointTransformed()):this.zoomOut(b.getPointTransformed())};xrx.viewbox.Viewbox.prototype.resetState_=function(){this.state_=xrx.drawing.State.NONE;this.origin_=null};xrx.drawing.LayerBackground=function(a){xrx.drawing.Layer.call(this,a)};goog.inherits(xrx.drawing.LayerBackground,xrx.drawing.Layer);xrx.drawing.LayerBackground.prototype.getImage=function(a){return this.image_};xrx.drawing.LayerBackground.prototype.setImage=function(a){this.image_.setImage(a)};xrx.drawing.LayerBackground.prototype.create_=function(){this.group_=xrx.shape.Group.create(this.drawing_);this.image_=xrx.shape.Image.create(this.drawing_);this.group_.addChildren(this.image_)};xrx.drawing.Hoverable=function(a){xrx.EventTarget.call(this);this.drawing_=a;this.last_=[];this.multiple_=!1};goog.inherits(xrx.drawing.Hoverable,xrx.EventTarget);xrx.drawing.Hoverable.prototype.setMultiple=function(a){this.multiple_=!!a};xrx.drawing.Hoverable.prototype.pop_=function(){var a,b=this.last_.length;if(0<this.last_.length){for(var c=0;c<b;c++)(a=this.last_[c])&&a.getHoverable().hoverOff();this.dispatchExternal(xrx.drawing.EventType.SHAPE_HOVER_OUT,this.drawing_,this.last_)}};
...
xrx.drawing.Hoverable.prototype.handleMove=function(a,b){var c;this.multiple_?c=b.getShapes():c=b.getShape();goog.isArray(c)||(c=[c]);this.hover_(c)};xrx.drawing.Hoverable.prototype.handleOut=function(a){this.pop_()};xrx.drawing.Selectable=function(a){this.drawing_=a;this.last_};xrx.drawing.Selectable.prototype.handleDown=function(a,b){var c=b.getShape();this.last_&&this.last_.getSelectable().selectOff();c?(c.getSelectable().selectOn(),this.last_=c):this.last_=null};xrx.engine.Engine=function(a){this.name_=a;this.available_=!1;this.init_()};xrx.engine.Engine.prototype.createCanvas=function(a){if(this.typeOf(xrx.engine.CANVAS))return xrx.canvas.Canvas.create(a);if(this.typeOf(xrx.engine.SVG))return xrx.svg.Canvas.create(a);if(this.typeOf(xrx.engine.VML))return xrx.vml.Canvas.create(a);throw Error("Unknown engine.");};
xrx.engine.Engine.prototype.createCircle=function(a){if(this.typeOf(xrx.engine.CANVAS))return xrx.canvas.Circle.create(a);if(this.typeOf(xrx.engine.SVG))return xrx.svg.Circle.create(a);if(this.typeOf(xrx.engine.VML))return xrx.vml.Circle.create(a);throw Error("Unknown engine.");};
xrx.engine.Engine.prototype.createEllipse=function(a){if(this.typeOf(xrx.engine.CANVAS))return xrx.canvas.Ellipse.create(a);if(this.typeOf(xrx.engine.SVG))return xrx.svg.Ellipse.create(a);if(this.typeOf(xrx.engine.VML))return xrx.vml.Ellipse.create(a);throw Error("Unknown engine.");};
xrx.engine.Engine.prototype.createGroup=function(a){if(this.typeOf(xrx.engine.CANVAS))return xrx.canvas.Group.create(a);if(this.typeOf(xrx.engine.SVG))return xrx.svg.Group.create(a);if(this.typeOf(xrx.engine.VML))return xrx.vml.Group.create(a);throw Error("Unknown engine.");};
xrx.engine.Engine.prototype.createImage=function(a){if(this.typeOf(xrx.engine.CANVAS))return xrx.canvas.Image.create(a);if(this.typeOf(xrx.engine.SVG))return xrx.svg.Image.create(a);if(this.typeOf(xrx.engine.VML))return xrx.vml.Image.create(a);throw Error("Unknown engine.");};
xrx.engine.Engine.prototype.createLine=function(a){if(this.typeOf(xrx.engine.CANVAS))return xrx.canvas.Line.create(a);if(this.typeOf(xrx.engine.SVG))return xrx.svg.Line.create(a);if(this.typeOf(xrx.engine.VML))return xrx.vml.Line.create(a);throw Error("Unknown engine.");};
xrx.engine.Engine.prototype.createPolygon=function(a){if(this.typeOf(xrx.engine.CANVAS))return xrx.canvas.Polygon.create(a);if(this.typeOf(xrx.engine.SVG))return xrx.svg.Polygon.create(a);if(this.typeOf(xrx.engine.VML))return xrx.vml.Polygon.create(a);throw Error("Unknown engine.");};
xrx.engine.Engine.prototype.createPolyline=function(a){if(this.typeOf(xrx.engine.CANVAS))return xrx.canvas.Polyline.create(a);if(this.typeOf(xrx.engine.SVG))return xrx.svg.Polyline.create(a);if(this.typeOf(xrx.engine.VML))return xrx.vml.Polyline.create(a);throw Error("Unknown engine.");};
xrx.engine.Engine.prototype.createRect=function(a){if(this.typeOf(xrx.engine.CANVAS))return xrx.canvas.Polygon.create(a);if(this.typeOf(xrx.engine.SVG))return xrx.svg.Polygon.create(a);if(this.typeOf(xrx.engine.VML))return xrx.vml.Polygon.create(a);throw Error("Unknown engine.");};xrx.engine.Engine.prototype.getName=function(){return this.name_};xrx.engine.Engine.prototype.typeOf=function(a){return this.name_===a};xrx.engine.Engine.prototype.isAvailable=function(){return this.available_};
xrx.engine.Engine.prototype.findOptimalRenderer_=function(){if(xrx.canvas.isSupported())this.name_=xrx.engine.CANVAS,this.renderer_=xrx.canvas,this.available_=!0;else if(xrx.svg.isSupported())this.name_=xrx.engine.SVG,this.renderer_=xrx.svg,this.available_=!0;else if(xrx.vml.isSupported())this.name_=xrx.engine.VML,this.renderer_=xrx.vml,this.available_=!0;else throw Error("There is no graphics rendering engine available.");};
xrx.engine.Engine.prototype.forceRenderer_=function(){if(this.name_===xrx.engine.CANVAS)this.renderer_=xrx.canvas,this.available_=xrx.canvas.isSupported();else if(this.name_===xrx.engine.SVG)this.renderer_=xrx.svg,this.available_=xrx.svg.isSupported();else if(this.name_===xrx.engine.VML)this.renderer_=xrx.vml,this.available_=xrx.vml.isSupported();else throw this.available_=!1,Error("Unknown graphics rendering engine.");};
xrx.engine.Engine.prototype.init_=function(){this.name_?this.forceRenderer_():this.findOptimalRenderer_()};goog.dom.ViewportSizeMonitor=function(a){goog.events.EventTarget.call(this);this.window_=a||window;this.listenerKey_=goog.events.listen(this.window_,goog.events.EventType.RESIZE,this.handleResize_,!1,this);this.size_=goog.dom.getViewportSize(this.window_)};goog.inherits(goog.dom.ViewportSizeMonitor,goog.events.EventTarget);
...
goog.dom.ViewportSizeMonitor.prototype.disposeInternal=function(){goog.dom.ViewportSizeMonitor.superClass_.disposeInternal.call(this);this.listenerKey_&&(goog.events.unlistenByKey(this.listenerKey_),this.listenerKey_=null);this.size_=this.window_=null};goog.dom.ViewportSizeMonitor.prototype.handleResize_=function(a){a=goog.dom.getViewportSize(this.window_);goog.math.Size.equals(a,this.size_)||(this.size_=a,this.dispatchEvent(goog.events.EventType.RESIZE))};xrx.drawing.Modifiable=function(a){this.drawing_=a;this.mode_=xrx.drawing.Modifiable.Mode.SHAPEHOVER;this.dragger_;this.shape_;this.origin_;this.propageted_=!1};xrx.drawing.Modifiable.Mode={DRAGSHAPE:1,HOVERSHAPE:2,DRAGDRAGGER:3};
xrx.drawing.Modifiable.prototype.handleDown=function(a,b){var c;(c=b.getShape())?(this.origin_=b.getPointTransformed(),c&&c.isModifiable()?(this.state_=xrx.drawing.State.DRAG,c instanceof xrx.shape.Dragger?(this.mode_=xrx.drawing.Modifiable.Mode.DRAGDRAGGER,this.dragger_=c):(this.mode_=xrx.drawing.Modifiable.Mode.DRAGSHAPE,this.shape_=c,c=this.shape_.getModifiable(),this.drawing_.getLayerShapeModify().activate(c))):(this.drawing_.getLayerShapeModify().removeShapes(),this.resetState_())):(this.drawing_.getViewbox().handleDown(a,
b),this.propageted_=!0)};xrx.drawing.Modifiable.prototype.handleHover_=function(a,b){console.log("TODO")};xrx.drawing.Modifiable.prototype.handleDragShape_=function(a,b){var c=b.getPointTransformed(),d=c[0]-this.origin_[0],e=c[1]-this.origin_[1];this.shape_.getModifiable().move(d,e);this.origin_=c};
xrx.drawing.Modifiable.prototype.handleMove=function(a,b){b.getShape();if(this.propageted_)this.drawing_.getViewbox().handleMove(a,b);else{var c=b.getPointTransformed();this.mode_===xrx.drawing.Modifiable.Mode.SHAPEHOVER?this.handleHover_(a,b):this.mode_===xrx.drawing.Modifiable.Mode.DRAGDRAGGER?this.dragger_.setCoord(c):this.mode_===xrx.drawing.Modifiable.Mode.DRAGSHAPE&&this.handleDragShape_(a,b)}};
xrx.drawing.Modifiable.prototype.handleUp=function(a,b){b.getShape()||this.drawing_.getViewbox().handleUp(a,b);this.resetState_();this.propageted_=!1};xrx.drawing.Modifiable.prototype.resetState_=function(){this.mode_=xrx.drawing.Modifiable.Mode.SHAPEHOVER};xrx.drawing.Drawing=function(a,b){xrx.drawing.EventHandler.call(this);this.element_=a;this.layer_=[];this.mode_=xrx.drawing.Mode.NONE;this.modifiable_=new xrx.drawing.Modifiable(this);this.selectable_=new xrx.drawing.Selectable(this);this.hoverable_=new xrx.drawing.Hoverable(this);this.install_(b)};goog.inherits(xrx.drawing.Drawing,xrx.drawing.EventHandler);xrx.drawing.Drawing.prototype.getElement=function(){return this.element_};xrx.drawing.Drawing.prototype.getEngine=function(){return this.engine_};
xrx.drawing.Drawing.prototype.getCanvas=function(){return this.canvas_};xrx.drawing.Drawing.prototype.getLayerBackground=function(){return this.layer_[0]};xrx.drawing.Drawing.prototype.getLayerShape=function(){return this.layer_[1]};xrx.drawing.Drawing.prototype.getLayerShapeModify=function(){return this.layer_[2]};xrx.drawing.Drawing.prototype.getLayerShapeCreate=function(){return this.layer_[3]};xrx.drawing.Drawing.prototype.getLayerTool=function(){return this.layer_[4]};
xrx.drawing.Drawing.prototype.getViewbox=function(){return this.viewbox_};xrx.drawing.Drawing.prototype.getCreate=function(){return this.create_};xrx.drawing.Drawing.prototype.setSize=function(a,b){goog.style.setSize(this.element_,a+"px",b+"px");this.handleResize()};
xrx.drawing.Drawing.prototype.setBackgroundImage=function(a,b){var c=this.layer_[0].getImage();if(!c||c.src!==a){var d=this,c=new goog.net.ImageLoader,e=goog.dom.createElement("img");e.id="_tmp";e.src=a;goog.events.listen(c,goog.events.EventType.LOAD,function(a){d.layer_[0].setImage(a.target);b&&b();d.draw()});c.addImage("_tmp",e);c.start()}};xrx.drawing.Drawing.prototype.addShapes=function(a){this.layer_[1].addShapes(a)};
xrx.drawing.Drawing.prototype.draw=function(){var a=this.getViewbox();this.eventBeforeRendering=function(b){b===a.getGroup()?b.setCTM(a.getCTM()):b instanceof xrx.shape.Stylable&&b.setZoomFactor(a.getZoomValue())};this.canvas_.draw()};xrx.drawing.Drawing.prototype.getMode=function(){return this.mode_};xrx.drawing.Drawing.prototype.setMode_=function(a){a!==this.mode_&&(this.mode_=a,this.registerEvents(a))};
xrx.drawing.Drawing.prototype.setModeDisabled=function(){this.getLayerBackground().setLocked(!0);this.getLayerShape().setLocked(!0);this.getLayerShapeModify().setLocked(!0);this.getLayerShapeCreate().setLocked(!0);this.getLayerShapeModify().removeShapes();this.getLayerShapeCreate().removeShapes();this.setMode_(xrx.drawing.Mode.DISABLED)};
...
xrx.drawing.Drawing.prototype.setModeCreate=function(a){a&&(this.create_=a,this.getLayerBackground().setLocked(!0),this.getLayerShape().setLocked(!0),this.getLayerShapeModify().setLocked(!0),this.getLayerShapeCreate().setLocked(!1),this.getLayerShapeModify().removeShapes(),this.getLayerShapeCreate().removeShapes(),a.setEventHandler(this),this.setMode_(xrx.drawing.Mode.CREATE))};
xrx.drawing.Drawing.prototype.handleResize=function(){var a=this.getSize_();this.canvas_.setHeight(a.height);this.canvas_.setWidth(a.width);this.shield_.setHeight(a.height);this.shield_.setWidth(a.width);this.draw()};xrx.drawing.Drawing.prototype.getSize_=function(){var a=goog.style.getSize(this.element_),b=goog.style.getPaddingBox(this.element_),c=goog.style.getBorderBox(this.element_);return{width:a.width-b.left-b.right-c.left-c.right,height:a.height-b.top-b.bottom-c.top-c.bottom}};
xrx.drawing.Drawing.prototype.installCanvas_=function(){var a=this.getSize_(),b=this,c=new goog.dom.ViewportSizeMonitor;goog.events.listen(c,goog.events.EventType.RESIZE,function(a){b.handleResize()},!1,b);this.canvas_=xrx.shape.Canvas.create(this);this.canvas_.setHeight(a.height);this.canvas_.setWidth(a.width)};xrx.drawing.Drawing.prototype.installViewbox_=function(){this.viewbox_=new xrx.viewbox.Viewbox(this);this.canvas_.addChildren(this.viewbox_.getGroup())};
xrx.drawing.Drawing.prototype.installLayerBackground_=function(){this.layer_[0]=new xrx.drawing.LayerBackground(this);this.viewbox_.getGroup().addChildren(this.layer_[0].getGroup())};xrx.drawing.Drawing.prototype.installLayerShape_=function(){this.layer_[1]=new xrx.drawing.LayerShape(this);this.viewbox_.getGroup().addChildren(this.layer_[1].getGroup())};xrx.drawing.Drawing.prototype.installLayerShapeModify_=function(){this.layer_[2]=new xrx.drawing.LayerShapeModify(this);this.viewbox_.getGroup().addChildren(this.layer_[2].getGroup())};
xrx.drawing.Drawing.prototype.installLayerShapeCreate_=function(){this.layer_[3]=new xrx.drawing.LayerShapeCreate(this);this.viewbox_.getGroup().addChildren(this.layer_[3].getGroup())};xrx.drawing.Drawing.prototype.installShield_=function(){var a=this.getSize_();this.shield_=xrx.shape.Rect.create(this);this.shield_.setX(0);this.shield_.setY(0);this.shield_.setWidth(a.width);this.shield_.setHeight(a.height);this.shield_.setFillOpacity(0);this.shield_.setStrokeWidth(0);this.canvas_.addChildren(this.shield_)};
xrx.drawing.Drawing.prototype.installLayerTool_=function(){this.layer_[4]=new xrx.drawing.LayerTool(this)};xrx.drawing.Drawing.prototype.installFallback_=function(a){var b=goog.dom.createElement("span");goog.dom.setTextContent(b,"Your browser does not support "+a+" rendering.");goog.dom.classes.add(b,"xrx-canvas-error");goog.dom.appendChild(this.element_,b)};xrx.drawing.Drawing.prototype.initEngine_=function(a){this.engine_=new xrx.engine.Engine(a)};
xrx.drawing.Drawing.prototype.install_=function(a){this.initEngine_(a);this.engine_.isAvailable()?(this.installCanvas_(),this.installViewbox_(),this.installLayerBackground_(),this.installLayerShape_(),this.installLayerShapeModify_(),this.installLayerShapeCreate_(),this.installShield_(),this.installLayerTool_()):this.installFallback_(a)};xrx.graphic=function(){};goog.exportSymbol("xrx.graphic",xrx.graphic);
