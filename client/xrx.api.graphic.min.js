...
xrx.drawing.Drawing.prototype.getViewbox=function(){return this.viewbox_};xrx.drawing.Drawing.prototype.getCreate=function(){return this.create_};xrx.drawing.Drawing.prototype.setWidth=function(a){this.canvas_.setWidth(a)};xrx.drawing.Drawing.prototype.setHeight=function(a){this.canvas_.setHeight(a)};
...
xrx.drawing.Drawing.prototype.handleResize=function(){this.canvas_.setHeight(this.element_.clientHeight);this.canvas_.setWidth(this.element_.clientWidth);this.shield_.setHeight(this.element_.clientHeight);this.shield_.setWidth(this.element_.clientWidth);this.draw()};
xrx.drawing.Drawing.prototype.installCanvas_=function(){var a=this,b=new goog.dom.ViewportSizeMonitor;goog.events.listen(b,goog.events.EventType.RESIZE,function(b){a.handleResize()},!1,a);this.canvas_=xrx.shape.Canvas.create(this);this.canvas_.setHeight(this.element_.clientHeight);this.canvas_.setWidth(this.element_.clientWidth)};xrx.drawing.Drawing.prototype.installViewbox_=function(){this.viewbox_=new xrx.viewbox.Viewbox(this);this.canvas_.addChildren(this.viewbox_.getGroup())};
...
xrx.drawing.Drawing.prototype.installLayerShapeCreate_=function(){this.layer_[3]=new xrx.drawing.LayerShapeCreate(this);this.viewbox_.getGroup().addChildren(this.layer_[3].getGroup())};xrx.drawing.Drawing.prototype.installShield_=function(){this.shield_=xrx.shape.Rect.create(this);this.shield_.setX(0);this.shield_.setY(0);this.shield_.setWidth(this.element_.clientWidth);this.shield_.setHeight(this.element_.clientHeight);this.shield_.setFillOpacity(0);this.shield_.setStrokeWidth(0);this.canvas_.addChildren(this.shield_)};
