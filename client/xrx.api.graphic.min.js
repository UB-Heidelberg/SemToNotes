...
e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(a){a.call(goog.global)};COMPILED||(goog.global.COMPILED=COMPILED);var xrx={drawing:function(){}};xrx.drawing.State={DRAG:1,NONE:2};xrx.drawing.Mode={VIEW:1,MODIFY:2,DELETE:3,CREATE:4,DISABLED:5,SELECT:6,HOVER:7,HOVERMULTIPLE:8};xrx.drawing.Orientation={C:"C",NE:"NE",SE:"SE",SW:"SW",NW:"NW"};xrx.drawing.EventType={VIEWBOX_CHANGE:"eventViewboxChange",SHAPE_HOVER_IN:"eventShapeHoverIn",SHAPE_HOVER_MOVE:"eventShapeHoverMove",SHAPE_HOVER_OUT:"eventShapeHoverOut",SHAPE_BEFORE_DRAW:"eventShapeBeforeDraw"};goog.object={};goog.object.forEach=function(a,b,c){for(var d in a)b.call(c,a[d],d,a)};goog.object.filter=function(a,b,c){var d={},e;for(e in a)b.call(c,a[e],e,a)&&(d[e]=a[e]);return d};goog.object.map=function(a,b,c){var d={},e;for(e in a)d[e]=b.call(c,a[e],e,a);return d};goog.object.some=function(a,b,c){for(var d in a)if(b.call(c,a[d],d,a))return!0;return!1};goog.object.every=function(a,b,c){for(var d in a)if(!b.call(c,a[d],d,a))return!1;return!0};
...
goog.object.createImmutableView=function(a){var b=a;Object.isFrozen&&!Object.isFrozen(a)&&(b=Object.create(a),Object.freeze(b));return b};goog.object.isImmutableView=function(a){return!!Object.isFrozen&&Object.isFrozen(a)};xrx.shape=function(){};xrx.shape.EventType={SHAPE_BEFORE_DRAW:"eventShapeBeforeDraw"};goog.disposable={};goog.disposable.IDisposable=function(){};goog.Disposable=function(){goog.Disposable.MONITORING_MODE!=goog.Disposable.MonitoringMode.OFF&&(goog.Disposable.INCLUDE_STACK_ON_CREATION&&(this.creationStack=Error().stack),goog.Disposable.instances_[goog.getUid(this)]=this)};goog.Disposable.MonitoringMode={OFF:0,PERMANENT:1,INTERACTIVE:2};goog.Disposable.MONITORING_MODE=0;goog.Disposable.INCLUDE_STACK_ON_CREATION=!0;goog.Disposable.instances_={};
...
goog.Disposable.isDisposed=function(a){return a&&"function"==typeof a.isDisposed?a.isDisposed():!1};goog.dispose=function(a){a&&"function"==typeof a.dispose&&a.dispose()};goog.disposeAll=function(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];goog.isArrayLike(d)?goog.disposeAll.apply(null,d):goog.dispose(d)}};xrx.shape.Stylable=function(){goog.Disposable.call(this);this.fill_={color:"",opacity:0};this.stroke_={color:"black",width:1}};goog.inherits(xrx.shape.Stylable,goog.Disposable);xrx.shape.Stylable.prototype.setStyle=function(a){this.stroke_.color=a.getStrokeColor();this.stroke_.width=a.getStrokeWidth();this.fill_.color=a.getFillColor();this.fill_.opacity=a.getFillOpacity()};xrx.shape.Stylable.prototype.getStrokeWidth=function(){return this.stroke_.width};
xrx.shape.Stylable.prototype.setStrokeWidth=function(a){void 0!==a&&(this.stroke_.width=a)};xrx.shape.Stylable.prototype.getStrokeColor=function(){return this.stroke_.color};xrx.shape.Stylable.prototype.setStrokeColor=function(a){void 0!==a&&(this.stroke_.color=a)};xrx.shape.Stylable.prototype.getFillColor=function(){return this.fill_.color};xrx.shape.Stylable.prototype.setFillColor=function(a){0===this.fill_.opacity&&(this.fill_.opacity=1);void 0!==a&&(this.fill_.color=a)};
xrx.shape.Stylable.prototype.getFillOpacity=function(){return this.fill_.opacity};xrx.shape.Stylable.prototype.setFillOpacity=function(a){void 0!==a&&(this.fill_.opacity=a)};xrx.shape.Stylable.prototype.disposeInternal=function(){this.stroke_=this.fill_=null;xrx.shape.Stylable.superClass_.disposeInternal.call(this)};xrx.shape.RenderStylable=function(a){xrx.shape.Stylable.call(this);this.engineElement_=a;this.zoomFactor_=1};goog.inherits(xrx.shape.RenderStylable,xrx.shape.Stylable);xrx.shape.RenderStylable.prototype.getEngineElement=function(){return this.engineElement_};xrx.shape.RenderStylable.prototype.setZoomFactor=function(a){this.zoomFactor_=a};xrx.shape.RenderStylable.prototype.getRenderingStrokeWidth=function(){return this.stroke_.width/this.zoomFactor_};
xrx.shape.RenderStylable.prototype.startDrawing_=function(){this.drawing_.eventBeforeRendering(this);this.engineElement_.applyTransform(this.ctm_);this.engineElement_.startDrawing()};xrx.shape.RenderStylable.prototype.finishDrawing_=function(){this.engineElement_.finishDrawing()};xrx.shape.RenderStylable.prototype.disposeInternal=function(){this.engineElement_.dispose();xrx.shape.RenderStylable.superClass_.disposeInternal.call(this)};goog.dom={};goog.dom.NodeType={ELEMENT:1,ATTRIBUTE:2,TEXT:3,CDATA_SECTION:4,ENTITY_REFERENCE:5,ENTITY:6,PROCESSING_INSTRUCTION:7,COMMENT:8,DOCUMENT:9,DOCUMENT_TYPE:10,DOCUMENT_FRAGMENT:11,NOTATION:12};goog.debug={};goog.debug.Error=function(a){if(Error.captureStackTrace)Error.captureStackTrace(this,goog.debug.Error);else{var b=Error().stack;b&&(this.stack=b)}a&&(this.message=String(a))};goog.inherits(goog.debug.Error,Error);goog.debug.Error.prototype.name="CustomError";goog.string={};goog.string.DETECT_DOUBLE_ESCAPING=!1;goog.string.Unicode={NBSP:"\u00a0"};goog.string.startsWith=function(a,b){return 0==a.lastIndexOf(b,0)};goog.string.endsWith=function(a,b){var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c};goog.string.caseInsensitiveStartsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(0,b.length))};goog.string.caseInsensitiveEndsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(a.length-b.length,b.length))};
...
xrx.geometry.Line.prototype.containsPoint=function(a){this.arr_[0][0]=this.x1;this.arr_[0][1]=this.y1;this.arr_[1][0]=this.x2;this.arr_[1][1]=this.y2;return xrx.geometry.Line.containsPoint(this.arr_,a)};xrx.geometry.Line.prototype.disposeInternal=function(){delete this.x1;delete this.y1;delete this.x2;delete this.y2;delete this.arr_[0];delete this.arr_[1];delete this.arr_};xrx.geometry.Polyline=function(a){xrx.geometry.Geometry.call(this);this.coords=void 0===a?[]:Array(a);if(void 0!==a)for(var b=0;b<a;b++)this.coords[b]=Array(2)};goog.inherits(xrx.geometry.Polyline,xrx.geometry.Geometry);xrx.geometry.Polyline.prototype.containsPoint=function(a){for(var b=!1,c=0,d=this.coords.length-1;c<d&&(b=xrx.geometry.Line.containsPoint([this.coords[c],this.coords[c+1]],a),!0!==b);c++);return b};
xrx.geometry.Polyline.prototype.disposeInternal=function(){for(var a=0,b=this.coords.length;a<b;a++)delete this.coords[a];delete this.coords;xrx.geometry.Polyline.superClass_.disposeInternal.call(this)};xrx.shape.PathLike=function(a,b,c){xrx.shape.Geometry.call(this,a,b,c)};goog.inherits(xrx.shape.PathLike,xrx.shape.Geometry);xrx.shape.PathLike.prototype.setCoords=function(a){this.geometry_.coords=a};xrx.shape.PathLike.prototype.getCoords=function(a){return this.geometry_.coords};xrx.shape.PathLike.prototype.setCoordAt=function(a,b){this.geometry_.coords[a][0]=b[0];this.geometry_.coords[a][1]=b[1]};xrx.shape.PathLike.prototype.setCoordXAt=function(a,b){this.geometry_.coords[a][0]=b};
...
xrx.geometry.Path.prototype.disposeInternal=function(){for(var a=0,b=this.coords.length;a<b;a++)delete this.coords[a];delete this.coords;xrx.geometry.Path.superClass_.disposeInternal.call(this)};xrx.geometry.Circle=function(){xrx.geometry.Geometry.call(this);this.r=this.cy=this.cx=0};goog.inherits(xrx.geometry.Circle,xrx.geometry.Geometry);xrx.geometry.Circle.prototype.containsPoint=function(a){return(this.cx-a[0])*(this.cx-a[0])+(this.cy-a[1])*(this.cy-a[1])<=this.r*this.r};xrx.shape.Circle=function(a,b){xrx.shape.Geometry.call(this,a,b,new xrx.geometry.Circle)};goog.inherits(xrx.shape.Circle,xrx.shape.Geometry);xrx.shape.Circle.prototype.getCenter=function(){return[this.geometry_.cx,this.geometry_.cy]};xrx.shape.Circle.prototype.setCenter=function(a,b){this.geometry_.cx=a;this.geometry_.cy=b};xrx.shape.Circle.prototype.getRadius=function(){return this.geometry_.r};xrx.shape.Circle.prototype.setRadius=function(a){this.geometry_.r=a};
...
xrx.shape.Canvas.prototype.setWidth=function(a){this.engineElement_.setWidth(a)};xrx.shape.Canvas.prototype.draw=function(){this.startDrawing_();for(var a=0,b=this.childs_.length;a<b;a++)this.childs_[a].draw();this.finishDrawing_()};xrx.shape.Canvas.create=function(a){var b=a.getElement(),b=a.getEngine().createCanvas(b);return new xrx.shape.Canvas(a,b)};xrx.shape.Canvas.prototype.disposeInternal=function(){xrx.shape.Canvas.superClass_.disposeInternal.call(this)};xrx.shape.Shapes=function(){};xrx.event.HandlerTarget=function(){goog.Disposable.call(this);this.handler_=new goog.events.EventHandler(this);this.cursor_=new xrx.drawing.Cursor(this)};goog.inherits(xrx.event.HandlerTarget,goog.Disposable);xrx.event.HandlerTarget.prototype.getHandler=function(){return this.handler_};
xrx.event.HandlerTarget.prototype.registerEvent_=function(a,b,c){this.cursor_.calculate(a);a.preventDefault();a.stopPropagation();a.getBrowserEvent().changedTouches&&a.init(a.getBrowserEvent().changedTouches[0],a.currentTarget);b[c](a,this.cursor_);this.draw()};xrx.event.HandlerTarget.prototype.registerClick=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.CLICK,function(c){b.registerEvent_(c,a,xrx.event.Handler.CLICK)},!1)};
xrx.event.HandlerTarget.prototype.registerDblClick=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.DBLCLICK,function(c){b.registerEvent_(c,a,xrx.event.Handler.DBLCLICK)},!1)};xrx.event.HandlerTarget.prototype.registerDown=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.DOWN,function(c){b.registerEvent_(c,a,xrx.event.Handler.DOWN)},!1)};
xrx.event.HandlerTarget.prototype.registerDrag=function(a){this.registerDown(a);this.registerMove(a);this.registerUp(a)};xrx.event.HandlerTarget.prototype.registerMove=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.MOVE,function(c){b.registerEvent_(c,a,xrx.event.Handler.MOVE)},!1)};
xrx.event.HandlerTarget.prototype.registerHover=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.MOVE,function(c){b.registerEvent_(c,a,xrx.event.Handler.MOVE)},!1)};xrx.event.HandlerTarget.prototype.registerOut=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.OUT,function(c){b.registerEvent_(c,a,xrx.event.Handler.OUT)},!1)};
xrx.event.HandlerTarget.prototype.registerUp=function(a){var b=this;this.handler_.listen(b.canvas_.getEngineElement().getEventTarget(),xrx.event.Type.UP,function(c){b.registerEvent_(c,a,xrx.event.Handler.UP)},!1)};xrx.event.HandlerTarget.prototype.registerWheel=function(a){if(!goog.userAgent.MOBILE){var b=this,c=new goog.events.MouseWheelHandler(b.canvas_.getEngineElement().getEventTarget());this.handler_.listen(c,xrx.event.Type.WHEEL,function(c){b.registerEvent_(c,a,xrx.event.Handler.WHEEL)},!1)}};
xrx.event.HandlerTarget.prototype.disposeInternal=function(){this.handler_&&(this.handler_.dispose(),this.handler_=null)};
...
break;default:throw Error("Unknown mode.");}};xrx.event.HandlerTarget.prototype.disposeInternal=function(){this.handler_.removeAll();this.handler_.dispose();this.cursor_.dispose();xrx.event.HandlerTarget.superClass_.disposeInternal.call(this)};xrx.drawing.EventHandler=function(){xrx.event.HandlerTarget.call(this)};goog.inherits(xrx.drawing.EventHandler,xrx.event.HandlerTarget);xrx.drawing.EventHandler.prototype.eventShapeCreate=function(a){this.getLayerShapeCreate().addShapes(a);this.draw()};xrx.drawing.EventHandler.prototype.eventShapeCreated=function(a){this.getLayerShape().addShapes(a);this.getLayerShapeCreate().removeShapes();this.draw()};
...
goog.net.ImageLoader.prototype.disposeInternal=function(){delete this.imageIdToRequestMap_;delete this.imageIdToImageMap_;goog.dispose(this.handler_);goog.net.ImageLoader.superClass_.disposeInternal.call(this)};xrx.EventTarget=function(){goog.Disposable.call(this)};goog.inherits(xrx.EventTarget,goog.Disposable);xrx.EventTarget.prototype.dispatchExternal=function(a,b){if(!goog.string.startsWith(a,"event"))throw Error('Invalid event-type "". Prefix "event*" expected.');var c;void 0!==b?c=b:c=this;c[a]&&(2>=arguments.length?c[a].apply(c):c[a].apply(c,this.argsArray_(arguments)))};xrx.EventTarget.prototype.argsArray_=function(a){for(var b=a.length-2,c=Array(b),d=0;d<b;d++)c[d]=a[d+2];return c};
xrx.EventTarget.prototype.disposeInternal=function(){xrx.EventTarget.superClass_.disposeInternal.call(this)};xrx.geometry.Box=function(){xrx.geometry.Geometry.call(this)};goog.inherits(xrx.geometry.Box,xrx.geometry.Geometry);xrx.geometry.Box.containsPoint=function(a,b){return b[0]>=a[3]&&b[0]<=a[1]&&b[1]>=a[0]&&b[1]<=a[2]};xrx.geometry.Point=function(){xrx.geometry.Geometry.call(this)};goog.inherits(xrx.geometry.Point,xrx.geometry.Geometry);xrx.geometry.Point.distancePoint=function(a,b){var c=a[0]-b[0],d=a[1]-b[1];return Math.sqrt(c*c+d*d)};xrx.geometry.Point.prototype.disposeInternal=function(){xrx.geometry.Point.superClass_.disposeInternal.call(this)};xrx.viewbox={};xrx.viewbox.ViewboxGeometry=function(){xrx.EventTarget.call(this);this.testPoint_=Array(2)};goog.inherits(xrx.viewbox.ViewboxGeometry,xrx.EventTarget);xrx.viewbox.ViewboxGeometry.prototype.getWidth=function(a,b){if(!0===b&&this.isHorizontal())return this.getHeight(a);var c=this.getDrawing().getLayerBackground().getImage().getWidth();return a?c*this.ctm_.getScale():c};
...
xrx.viewbox.ViewboxGeometry.prototype.disposeInternal=function(){delete this.testPoint_;xrx.viewbox.ViewboxGeometry.superClass_.disposeInternal.call(this)};xrx.viewbox.ViewboxRotate=function(){xrx.viewbox.ViewboxGeometry.call(this)};goog.inherits(xrx.viewbox.ViewboxRotate,xrx.viewbox.ViewboxGeometry);xrx.viewbox.ViewboxRotate.prototype.getRotation=function(){return this.ctm_.getRotation()};xrx.viewbox.ViewboxRotate.prototype.isValidRotation=function(a){a=Math.abs(a);return 0===a||90===a||180===a||270===a};xrx.viewbox.ViewboxRotate.prototype.isVertical=function(){var a=this.ctm_.getRotation();return 0===a||180===a};
...
xrx.engine.Engine.prototype.findOptimalRenderer_=function(){if(xrx.engine.isSupported(xrx.engine.CANVAS))this.name_=xrx.engine.CANVAS,this.renderer_=xrx.canvas,this.available_=!0;else if(xrx.engine.isSupported(xrx.engine.SVG))this.name_=xrx.engine.SVG,this.renderer_=xrx.svg,this.available_=!0;else if(xrx.engine.isSupported(xrx.engine.VML))this.name_=xrx.engine.VML,this.renderer_=xrx.vml,this.available_=!0;else throw Error("There is no graphics rendering engine available.");};
xrx.engine.Engine.prototype.forceRenderer_=function(){if(this.name_===xrx.engine.CANVAS)this.renderer_=xrx.canvas,this.available_=xrx.engine.isSupported(xrx.engine.CANVAS);else if(this.name_===xrx.engine.SVG)this.renderer_=xrx.svg,this.available_=xrx.engine.isSupported(xrx.engine.SVG);else if(this.name_===xrx.engine.VML)this.renderer_=xrx.vml,this.available_=xrx.engine.isSupported(xrx.engine.VML);else throw this.available_=!1,Error("Unknown graphics rendering engine.");};
xrx.engine.Engine.prototype.init_=function(){this.name_?this.forceRenderer_():this.findOptimalRenderer_()};xrx.engine.Engine.prototype.disposeInternal=function(){delete this.name_;delete this.available_};goog.dom.ViewportSizeMonitor=function(a){goog.events.EventTarget.call(this);this.window_=a||window;this.listenerKey_=goog.events.listen(this.window_,goog.events.EventType.RESIZE,this.handleResize_,!1,this);this.size_=goog.dom.getViewportSize(this.window_)};goog.inherits(goog.dom.ViewportSizeMonitor,goog.events.EventTarget);
...
goog.dom.ViewportSizeMonitor.prototype.disposeInternal=function(){goog.dom.ViewportSizeMonitor.superClass_.disposeInternal.call(this);this.listenerKey_&&(goog.events.unlistenByKey(this.listenerKey_),this.listenerKey_=null);this.size_=this.window_=null};goog.dom.ViewportSizeMonitor.prototype.handleResize_=function(a){a=goog.dom.getViewportSize(this.window_);goog.math.Size.equals(a,this.size_)||(this.size_=a,this.dispatchEvent(goog.events.EventType.RESIZE))};xrx.drawing.Modifiable=function(a){goog.Disposable.call(this);this.drawing_=a;this.mode_=xrx.drawing.Modifiable.Mode.SHAPEHOVER;this.dragger_;this.shape_;this.origin_;this.propageted_=!1};goog.inherits(xrx.drawing.Modifiable,goog.Disposable);xrx.drawing.Modifiable.Mode={DRAGSHAPE:1,HOVERSHAPE:2,DRAGDRAGGER:3};
...
b),this.propageted_=!0)};xrx.drawing.Modifiable.prototype.handleHover_=function(a,b){};xrx.drawing.Modifiable.prototype.handleDragShape_=function(a,b){var c=b.getPointTransformed(),d=c[0]-this.origin_[0],e=c[1]-this.origin_[1];this.shape_.getModifiable().move(d,e);this.origin_=c};
...
xrx.drawing.Drawing.prototype.getViewbox=function(){return this.viewbox_};xrx.drawing.Drawing.prototype.setSize=function(a,b){goog.style.setSize(this.element_,a+"px",b+"px");this.handleResize()};xrx.drawing.Drawing.prototype.setWidth=function(a){this.setSize(a,this.height_)};xrx.drawing.Drawing.prototype.setHeight=function(a){this.setSize(this.width_,a)};xrx.drawing.Drawing.prototype.setStyle=function(a,b){goog.style.setStyle(this.element_,a,b);this.handleResize()};
...
xrx.drawing.Drawing.prototype.getShapes=function(){return this.layer_[1].getShapes()||[]};xrx.drawing.Drawing.prototype.removeShape=function(a){this.layer_[1].removeShape(a);this.draw()};xrx.drawing.Drawing.prototype.getSelectedShape=function(){return this.selectable_.getShape()};xrx.drawing.Drawing.prototype.draw=function(){var a=this.getViewbox();this.eventBeforeRendering=function(b){b===a.getGroup()?b.setCTM(a.getCTM()):b instanceof xrx.shape.Stylable&&b.setZoomFactor(a.getZoomValue())};this.canvas_.draw()};
xrx.drawing.Drawing.prototype.getMode=function(){return this.mode_};xrx.drawing.Drawing.prototype.setMode_=function(a){a!==this.mode_&&(this.mode_=a,this.registerEvents(a))};xrx.drawing.Drawing.prototype.setModeDisabled=function(){this.getLayerBackground().setLocked(!0);this.getLayerShape().setLocked(!0);this.getLayerShapeModify().setLocked(!0);this.getLayerShapeCreate().setLocked(!0);this.getLayerShapeModify().removeShapes();this.getLayerShapeCreate().removeShapes();this.setMode_(xrx.drawing.Mode.DISABLED)};
...
xrx.drawing.Drawing.prototype.setModeCreate=function(a){a&&(this.creatable_=a,this.getLayerBackground().setLocked(!0),this.getLayerShape().setLocked(!0),this.getLayerShapeModify().setLocked(!0),this.getLayerShapeCreate().setLocked(!1),this.getLayerShapeModify().removeShapes(),this.getLayerShapeCreate().removeShapes(),a.setEventHandler(this),this.setMode_(xrx.drawing.Mode.CREATE))};
xrx.drawing.Drawing.prototype.handleResize=function(){this.calculateSize_();this.canvas_.setHeight(this.height_);this.canvas_.setWidth(this.width_);this.shield_.setHeight(this.height_);this.shield_.setWidth(this.width_);this.draw()};
...
xrx.drawing.Drawing.prototype.installCanvas_=function(){var a=this,b=new goog.dom.ViewportSizeMonitor;goog.events.listen(b,goog.events.EventType.RESIZE,function(b){a.handleResize()},!1,a);this.canvas_=xrx.shape.Canvas.create(this);this.canvas_.setHeight(this.height_);this.canvas_.setWidth(this.width_)};xrx.drawing.Drawing.prototype.installViewbox_=function(){this.viewbox_=new xrx.viewbox.Viewbox(this);this.canvas_.addChildren(this.viewbox_.getGroup())};
...
xrx.drawing.Drawing.prototype.installLayerTool_=function(){this.layer_[4]=new xrx.drawing.LayerTool(this)};xrx.drawing.Drawing.prototype.initEngine_=function(a){this.engine_=new xrx.engine.Engine(a)};
xrx.drawing.Drawing.prototype.install_=function(a){this.initEngine_(a);this.engine_.isAvailable()&&(goog.dom.removeChildren(this.element_),this.calculateSize_(),this.installCanvas_(),this.installViewbox_(),this.installLayerBackground_(),this.installLayerShape_(),this.installLayerShapeModify_(),this.installLayerShapecreatable_(),this.installShield_(),this.installLayerTool_())};
xrx.drawing.Drawing.prototype.disposeInternal=function(){this.element_=null;this.engine_.dispose();this.canvas_.dispose();for(var a=0,b=this.layer_.length;a<b;a++)this.layer_[a].dispose();this.shield_.dispose();this.modifiable_.dispose();this.selectable_.dispose();this.hoverable_.dispose();goog.dispose(this.creatable_);this.viewbox_.dispose();xrx.drawing.Drawing.superClass_.disposeInternal.call(this)};xrx.graphic=function(){};
